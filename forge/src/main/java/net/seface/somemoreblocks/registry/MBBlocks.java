...
public class MBBlocks {
  ...
  public static final RegistryObject<Block> SNOW_FERN = registerBlock("snow_fern", () -> new GenericBonemealableBushBlock(MBBlocks.LARGE_SNOW_FERN.get(), BlockBehaviour.Properties.ofFullCopy(Blocks.FERN)));
  ...
  public static final RegistryObject<Block> SHORT_SNOW_GRASS = registerBlock("short_snow_grass", () -> new GenericBonemealableBushBlock(MBBlocks.TALL_SNOW_GRASS.get(), BlockBehaviour.Properties.ofFullCopy(Blocks.SHORT_GRASS)));
  ...
  public static final RegistryObject<Block> CHISELED_TUFF_BRICKS = registerBlock("chiseled_tuff_bricks", () -> new Block(BlockBehaviour.Properties.ofFullCopy(MBBlocks.TUFF_BRICKS.get())));
  ...
  public static final RegistryObject<Block> MOSSY_BRICK_SLAB = registerBlock("mossy_brick_slab", () -> new SlabBlock(BlockBehaviour.Properties.ofFullCopy(MBBlocks.MOSSY_BRICKS.get())));
  public static final RegistryObject<Block> MOSSY_BRICK_STAIRS = registerBlock("mossy_brick_stairs", () -> new StairBlock(MOSSY_BRICKS.get().defaultBlockState(), BlockBehaviour.Properties.ofFullCopy(MBBlocks.MOSSY_BRICKS.get())));
  public static final RegistryObject<Block> MOSSY_BRICK_WALL = registerBlock("mossy_brick_wall", () -> new WallBlock(BlockBehaviour.Properties.ofFullCopy(MBBlocks.MOSSY_BRICKS.get()).forceSolidOn()));
  ...
  public static final RegistryObject<Block> BONE_BRICK_SLAB = registerBlock("bone_brick_slab", () -> new SlabBlock(BlockBehaviour.Properties.ofFullCopy(MBBlocks.BONE_BRICKS.get())));
  public static final RegistryObject<Block> BONE_BRICK_STAIRS = registerBlock("bone_brick_stairs", () -> new StairBlock(BONE_BRICKS.get().defaultBlockState(), BlockBehaviour.Properties.ofFullCopy(MBBlocks.BONE_BRICKS.get())));
  public static final RegistryObject<Block> BONE_BRICK_WALL = registerBlock("bone_brick_wall", () -> new WallBlock(BlockBehaviour.Properties.ofFullCopy(MBBlocks.BONE_BRICKS.get()).forceSolidOn()));
  ...
  public static final RegistryObject<Block> BONE_TILE_SLAB = registerBlock("bone_tile_slab", () -> new SlabBlock(BlockBehaviour.Properties.ofFullCopy(MBBlocks.BONE_TILES.get())));
  public static final RegistryObject<Block> BONE_TILE_STAIRS = registerBlock("bone_tile_stairs", () -> new StairBlock(BONE_TILES.get().defaultBlockState(), BlockBehaviour.Properties.ofFullCopy(MBBlocks.BONE_TILES.get())));
  public static final RegistryObject<Block> BONE_TILE_WALL = registerBlock("bone_tile_wall", () -> new WallBlock(BlockBehaviour.Properties.ofFullCopy(MBBlocks.BONE_TILES.get()).forceSolidOn()));
  ...
  public static final RegistryObject<Block> WAXED_COPPER_BRICKS = registerBlock("waxed_copper_bricks", () -> new Block(BlockBehaviour.Properties.ofFullCopy(MBBlocks.COPPER_BRICKS.get())));
  public static final RegistryObject<Block> WAXED_EXPOSED_COPPER_BRICKS = registerBlock("waxed_exposed_copper_bricks", () -> new Block(BlockBehaviour.Properties.ofFullCopy(MBBlocks.EXPOSED_COPPER_BRICKS.get())));
  public static final RegistryObject<Block> WAXED_WEATHERED_COPPER_BRICKS = registerBlock("waxed_weathered_copper_bricks", () -> new Block(BlockBehaviour.Properties.ofFullCopy(MBBlocks.WEATHERED_COPPER_BRICKS.get())));
  public static final RegistryObject<Block> WAXED_OXIDIZED_COPPER_BRICKS = registerBlock("waxed_oxidized_copper_bricks", () -> new Block(BlockBehaviour.Properties.ofFullCopy(MBBlocks.OXIDIZED_COPPER_BRICKS.get())));
  public static final RegistryObject<Block> CRACKED_COPPER_BRICKS = registerBlock("cracked_copper_bricks", () -> new WeatheringCopperFullBlock(WeatheringCopper.WeatherState.UNAFFECTED, BlockBehaviour.Properties.ofFullCopy(MBBlocks.COPPER_BRICKS.get())));
  public static final RegistryObject<Block> EXPOSED_CRACKED_COPPER_BRICKS = registerBlock("exposed_cracked_copper_bricks", () -> new WeatheringCopperFullBlock(WeatheringCopper.WeatherState.EXPOSED, BlockBehaviour.Properties.ofFullCopy(MBBlocks.EXPOSED_COPPER_BRICKS.get())));
  public static final RegistryObject<Block> WEATHERED_CRACKED_COPPER_BRICKS = registerBlock("weathered_cracked_copper_bricks", () -> new WeatheringCopperFullBlock(WeatheringCopper.WeatherState.WEATHERED, BlockBehaviour.Properties.ofFullCopy(MBBlocks.WEATHERED_COPPER_BRICKS.get())));
  public static final RegistryObject<Block> OXIDIZED_CRACKED_COPPER_BRICKS = registerBlock("oxidized_cracked_copper_bricks", () -> new WeatheringCopperFullBlock(WeatheringCopper.WeatherState.OXIDIZED, BlockBehaviour.Properties.ofFullCopy(MBBlocks.OXIDIZED_COPPER_BRICKS.get())));
  public static final RegistryObject<Block> WAXED_CRACKED_COPPER_BRICKS = registerBlock("waxed_cracked_copper_bricks", () -> new Block(BlockBehaviour.Properties.ofFullCopy(MBBlocks.CRACKED_COPPER_BRICKS.get())));
  public static final RegistryObject<Block> WAXED_EXPOSED_CRACKED_COPPER_BRICKS = registerBlock("waxed_exposed_cracked_copper_bricks", () -> new Block(BlockBehaviour.Properties.ofFullCopy(MBBlocks.EXPOSED_CRACKED_COPPER_BRICKS.get())));
  public static final RegistryObject<Block> WAXED_WEATHERED_CRACKED_COPPER_BRICKS = registerBlock("waxed_weathered_cracked_copper_bricks", () -> new Block(BlockBehaviour.Properties.ofFullCopy(MBBlocks.WEATHERED_CRACKED_COPPER_BRICKS.get())));
  public static final RegistryObject<Block> WAXED_OXIDIZED_CRACKED_COPPER_BRICKS = registerBlock("waxed_oxidized_cracked_copper_bricks", () -> new Block(BlockBehaviour.Properties.ofFullCopy(MBBlocks.OXIDIZED_CRACKED_COPPER_BRICKS.get())));
  ...
  public static final RegistryObject<Block> WAXED_CRACKED_CUT_COPPER = registerBlock("waxed_cracked_cut_copper", () -> new Block(BlockBehaviour.Properties.ofFullCopy(MBBlocks.CRACKED_CUT_COPPER.get())));
  public static final RegistryObject<Block> WAXED_EXPOSED_CRACKED_CUT_COPPER = registerBlock("waxed_exposed_cracked_cut_copper", () -> new Block(BlockBehaviour.Properties.ofFullCopy(MBBlocks.EXPOSED_CRACKED_CUT_COPPER.get())));
  public static final RegistryObject<Block> WAXED_WEATHERED_CRACKED_CUT_COPPER = registerBlock("waxed_weathered_cracked_cut_copper", () -> new Block(BlockBehaviour.Properties.ofFullCopy(MBBlocks.WEATHERED_CRACKED_CUT_COPPER.get())));
  public static final RegistryObject<Block> WAXED_OXIDIZED_CRACKED_CUT_COPPER = registerBlock("waxed_oxidized_cracked_cut_copper", () -> new Block(BlockBehaviour.Properties.ofFullCopy(MBBlocks.OXIDIZED_CRACKED_CUT_COPPER.get())));
  ...
  public static final RegistryObject<Block> WAXED_COPPER_PILLAR = registerBlock("waxed_copper_pillar", () -> new RotatedPillarBlock(BlockBehaviour.Properties.ofFullCopy(MBBlocks.COPPER_PILLAR.get())));
  public static final RegistryObject<Block> WAXED_EXPOSED_COPPER_PILLAR = registerBlock("waxed_exposed_copper_pillar", () -> new RotatedPillarBlock(BlockBehaviour.Properties.ofFullCopy(MBBlocks.EXPOSED_COPPER_PILLAR.get())));
  public static final RegistryObject<Block> WAXED_WEATHERED_COPPER_PILLAR = registerBlock("waxed_weathered_copper_pillar", () -> new RotatedPillarBlock(BlockBehaviour.Properties.ofFullCopy(MBBlocks.WEATHERED_COPPER_PILLAR.get())));
  public static final RegistryObject<Block> WAXED_OXIDIZED_COPPER_PILLAR = registerBlock("waxed_oxidized_copper_pillar", () -> new RotatedPillarBlock(BlockBehaviour.Properties.ofFullCopy(MBBlocks.OXIDIZED_COPPER_PILLAR.get())));
  ...
  private static <T extends Block> RegistryObject<Item> registerBlockItemWithFuel(String name, RegistryObject<T> block, int fuel) {
    return MBItems.registerItem(name, () -> new FuelItem(block.get(), new Item.Properties(), fuel));
  }
