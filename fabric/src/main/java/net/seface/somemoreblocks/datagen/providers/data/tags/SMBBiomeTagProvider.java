...
public class SMBBiomeTagProvider extends FabricTagProvider<Biome> {
  ...
  protected void addTags(HolderLookup.Provider provider) {
    ...
    this.builder(SMBBiomeTags.GENERATES_LARGE_SNOW_FERN).add(Biomes.SNOWY_TAIGA);
    ...
    this.builder(SMBBiomeTags.GENERATES_PALE_MUSHROOM_COLONY).add(Biomes.PALE_GARDEN);

    this.builder(SMBBiomeTags.GENERATES_SNOW_BUSH).add(Biomes.FROZEN_RIVER);
  }
}
