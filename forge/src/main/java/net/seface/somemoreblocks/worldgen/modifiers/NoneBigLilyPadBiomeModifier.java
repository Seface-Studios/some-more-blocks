...
public record NoneBigLilyPadBiomeModifier(HolderSet<Biome> biomes, Holder<PlacedFeature> feature) implements BiomeModifier {
  ...
  public MapCodec<? extends BiomeModifier> codec() {
    return SMBBiomeModifiers.NONE_BIG_LILY_PAD.get();
  }
}
