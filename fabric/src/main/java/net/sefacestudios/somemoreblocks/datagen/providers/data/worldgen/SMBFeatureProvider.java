package net.sefacestudios.somemoreblocks.datagen.providers.data.worldgen;
...
import net.sefacestudios.somemoreblocks.datagen.providers.data.worldgen.providers.*;
...
public class SMBFeatureProvider extends FabricDynamicRegistryProvider {
  ...
  public static void bootstrapF(BootstrapContext<@NotNull PlacedFeature> context) {
    ...
    PatchCattailWaterFeatureProvider.create().registerPlaceFeature(context);
    PatchCattailWaterSwampFeatureProvider.create().registerPlaceFeature(context);
    PatchCloverFeatureProvider.create().registerPlaceFeature(context);
    PatchDuckweedFeatureProvider.create().registerPlaceFeature(context);
    PatchDuckweedLushCavesFeatureProvider.create().registerPlaceFeature(context);
    PatchDuckweedSwampFeatureProvider.create().registerPlaceFeature(context);
    ...
    PatchLarkspurFeatureProvider.create().registerPlaceFeature(context);
    PatchLarkspurFlowerForestFeatureProvider.create().registerPlaceFeature(context);
    PatchLavenderFeatureProvider.create().registerPlaceFeature(context);
  ...
  public static void bootstrapCF(BootstrapContext<@NotNull ConfiguredFeature<?, ?>> context) {
    ...
    PatchCattailWaterFeatureProvider.create().registerConfiguredFeature(context);
    PatchCattailWaterSwampFeatureProvider.create().registerConfiguredFeature(context);
    PatchCloverFeatureProvider.create().registerConfiguredFeature(context);
    PatchDuckweedFeatureProvider.create().registerConfiguredFeature(context);
    PatchDuckweedLushCavesFeatureProvider.create().registerConfiguredFeature(context);
    PatchDuckweedSwampFeatureProvider.create().registerConfiguredFeature(context);
    ...
    PatchLarkspurFeatureProvider.create().registerConfiguredFeature(context);
    PatchLarkspurFlowerForestFeatureProvider.create().registerConfiguredFeature(context);
    PatchLavenderFeatureProvider.create().registerConfiguredFeature(context);
