...
public record PatchSnowPlantsBiomeModifier(HolderSet<Biome> biomes, Holder<PlacedFeature> feature) implements BiomeModifier {
  ...
  public MapCodec<? extends BiomeModifier> codec() {
    return SMBBiomeModifiers.PATCH_SNOW_GRASS.get();
  }
}
