...
public class DunePlantsFeatureProvider extends AbstractFeatureProvider<RandomPatchConfiguration> {
  public DunePlantsFeatureProvider() {
  ...
  public static <T extends AbstractFeatureProvider<?>> T create() {
    return new DunePlantsFeatureProvider()
