...
public class SMBRegistries {
  ...
  public static BidirectionalRegistryObject<DyeColor, Block> CHECKERED_TILES = BidirectionalRegistryObject.create(SomeMoreBlocks.id("checkered_tiles"));
  ...
  private static void snowyPlantBlocks() {
    SNOWY_PLANT_BLOCKS.register(Blocks.GRASS, SMBBlocks.SHORT_SNOW_GRASS.get());
