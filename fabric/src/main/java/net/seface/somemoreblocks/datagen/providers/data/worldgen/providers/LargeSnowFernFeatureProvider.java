...
public class LargeSnowFernFeatureProvider extends AbstractFeatureProvider<RandomPatchConfiguration> {
  public LargeSnowFernFeatureProvider() {
  ...
  public static <T extends AbstractFeatureProvider<?>> T create() {
    return new LargeSnowFernFeatureProvider()
