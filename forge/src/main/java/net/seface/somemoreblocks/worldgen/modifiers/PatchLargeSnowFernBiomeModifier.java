...
public record PatchLargeSnowFernBiomeModifier(HolderSet<Biome> biomes, Holder<PlacedFeature> feature) implements BiomeModifier {
  ...
  public MapCodec<? extends BiomeModifier> codec() {
    return SMBBiomeModifiers.PATCH_LARGE_SNOW_FERN.get();
  }
}
