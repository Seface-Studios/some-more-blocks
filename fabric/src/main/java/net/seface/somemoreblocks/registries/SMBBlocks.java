...
public class SMBBlocks {
  ...
  public static void register() {
    ...
    Registry.register(BuiltInRegistries.BLOCK, ResourceLocation.fromNamespaceAndPath(SomeMoreBlocks.ID, "mossy_soul_sandstone_bricks"), MOSSY_SOUL_SANDSTONE_BRICKS);
