  ...
  protected void addTags(HolderLookup.Provider provider) {
    ...
    getOrCreateTagBuilder(ItemTags.SLABS).setReplace(false)
      .add(
        ...
        SMBBlocks.TUFF_BRICK_SLAB.get().asItem(), SMBBlocks.POLISHED_TUFF_SLAB.get().asItem(),
    ...
    getOrCreateTagBuilder(ItemTags.STAIRS).setReplace(false)
      .add(
        ...
        SMBBlocks.TUFF_BRICKS.get().asItem(), SMBBlocks.POLISHED_TUFF_STAIRS.get().asItem(),
    ...
    getOrCreateTagBuilder(ItemTags.WALLS).setReplace(false)
      .add(
        ...
        SMBBlocks.TUFF_BRICK_WALL.get().asItem(),
