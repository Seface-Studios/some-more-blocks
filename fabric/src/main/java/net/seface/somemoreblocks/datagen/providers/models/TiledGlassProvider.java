...
public class TiledGlassProvider {
  ...
  public TiledGlassProvider(Block block, BiConsumer<ResourceLocation, ModelInstance> modelOutput, ItemModelOutput itemModelOutput, Consumer<BlockStateGenerator> blockStateOutput) {
    this.block = block;
  ...
  public TiledGlassProvider fullBlock() {
  ...
  public TiledGlassProvider pane(Block tiledGlassPane, Block topBottomBlockPane) {
