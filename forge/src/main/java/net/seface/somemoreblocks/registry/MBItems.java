...
public class MBItems {
  ...
  public static final RegistryObject<Item> TALL_BROWN_MUSHROOM_COLONY = registerItem("tall_brown_mushroom_colony", () -> new BlockItem(MBBlocks.TALL_BROWN_MUSHROOM_COLONY.get(), new Item.Properties().rarity(Rarity.EPIC)));
  ...
  public static final RegistryObject<Item> TALL_CRIMSON_FUNGUS_COLONY = registerItem("tall_crimson_fungus_colony", () -> new BlockItem(MBBlocks.TALL_CRIMSON_FUNGUS_COLONY.get(), new Item.Properties().rarity(Rarity.EPIC)));
  ...
  public static final RegistryObject<Item> TALL_RED_MUSHROOM_COLONY = registerItem("tall_red_mushroom_colony", () -> new BlockItem(MBBlocks.TALL_RED_MUSHROOM_COLONY.get(), new Item.Properties().rarity(Rarity.EPIC)));
  ...
  public static final RegistryObject<Item> TALL_WARPED_FUNGUS_COLONY = registerItem("tall_warped_fungus_colony", () -> new BlockItem(MBBlocks.TALL_WARPED_FUNGUS_COLONY.get(), new Item.Properties().rarity(Rarity.EPIC)));
