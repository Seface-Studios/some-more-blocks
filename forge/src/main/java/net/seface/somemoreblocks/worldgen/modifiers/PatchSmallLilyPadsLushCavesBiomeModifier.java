...
public record PatchSmallLilyPadsLushCavesBiomeModifier(HolderSet<Biome> biomes, Holder<PlacedFeature> feature) implements BiomeModifier {
  ...
  public MapCodec<? extends BiomeModifier> codec() {
    return SMBBiomeModifiers.PATCH_SMALL_LILY_PADS_LUSH_CAVES.get();
  }
}
