...
public final class SMBBlockTags {
  public static final TagKey<Block> AZALEA_LEAF_LITTER_PARENT_LEAVES = SomeMoreBlocks.tagKey(Registries.BLOCK, "azalea_leaf_litter_parent_leaves");
  ...
  public static final TagKey<Block> FLOWERING_AZALEA_LEAF_LITTER_PARENT_LEAVES = SomeMoreBlocks.tagKey(Registries.BLOCK, "flowering_azalea_leaf_litter_parent_leaves");
  ...
  public static final TagKey<Block> LEAF_LITTER_PARENT_LEAVES = SomeMoreBlocks.tagKey(Registries.BLOCK, "leaf_litter_parent_leaves");
  ...
  public static final TagKey<Block> PALE_OAK_LEAF_LITTER_PARENT_LEAVES = SomeMoreBlocks.tagKey(Registries.BLOCK, "pale_oak_leaf_litter_parent_leaves");
  public static final TagKey<Block> SHINGLES = SomeMoreBlocks.tagKey(Registries.BLOCK, "shingles");
  public static final TagKey<Block> SPRUCE_LEAF_LITTER_PARENT_LEAVES = SomeMoreBlocks.tagKey(Registries.BLOCK, "spruce_leaf_litter_parent_leaves");
