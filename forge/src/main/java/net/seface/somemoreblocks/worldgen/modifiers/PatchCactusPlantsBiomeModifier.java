...
public record PatchCactusPlantsBiomeModifier(HolderSet<Biome> biomes, Holder<PlacedFeature> feature) implements BiomeModifier {
  ...
  public MapCodec<? extends BiomeModifier> codec() {
    return SMBBiomeModifiers.PATCH_CACTUS_PLANTS.get();
  }
}
