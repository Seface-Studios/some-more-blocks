...
public class SMBItemTagProvider extends FabricTagsProvider.ItemTagsProvider {
  ...
  protected void addTags(@NotNull HolderLookup.Provider provider) {
    ...
    this.valueLookupBuilder(ItemTags.PLANKS)
      .add(
        SMBBlocks.OAK_BOARDS.get().asItem(),
        SMBBlocks.OAK_SLATS.get().asItem(),
        SMBBlocks.OAK_MOSAIC.get().asItem(),
        SMBBlocks.SPRUCE_BOARDS.get().asItem(),
        SMBBlocks.SPRUCE_SLATS.get().asItem(),
        SMBBlocks.SPRUCE_MOSAIC.get().asItem(),
        SMBBlocks.BIRCH_BOARDS.get().asItem(),
        SMBBlocks.BIRCH_SLATS.get().asItem(),
        SMBBlocks.BIRCH_MOSAIC.get().asItem(),
        SMBBlocks.JUNGLE_BOARDS.get().asItem(),
        SMBBlocks.JUNGLE_SLATS.get().asItem(),
        SMBBlocks.JUNGLE_MOSAIC.get().asItem(),
        SMBBlocks.ACACIA_BOARDS.get().asItem(),
        SMBBlocks.ACACIA_SLATS.get().asItem(),
        SMBBlocks.ACACIA_MOSAIC.get().asItem(),
        SMBBlocks.DARK_OAK_BOARDS.get().asItem(),
        SMBBlocks.DARK_OAK_SLATS.get().asItem(),
        SMBBlocks.DARK_OAK_MOSAIC.get().asItem(),
        SMBBlocks.MANGROVE_BOARDS.get().asItem(),
        SMBBlocks.MANGROVE_SLATS.get().asItem(),
        SMBBlocks.MANGROVE_MOSAIC.get().asItem(),
        SMBBlocks.CRIMSON_BOARDS.get().asItem(),
        SMBBlocks.CRIMSON_SLATS.get().asItem(),
        SMBBlocks.CRIMSON_MOSAIC.get().asItem(),
        SMBBlocks.WARPED_BOARDS.get().asItem(),
        SMBBlocks.WARPED_SLATS.get().asItem(),
        SMBBlocks.WARPED_MOSAIC.get().asItem(),
        SMBBlocks.CHERRY_BOARDS.get().asItem(),
        SMBBlocks.CHERRY_SLATS.get().asItem(),
    ...
    this.valueLookupBuilder(ItemTags.SMALL_FLOWERS)
      .add(
        ...
        SMBBlocks.SHORT_PURPLE_LARKSPUR.get().asItem(),
        SMBBlocks.SHORT_RED_LARK_LARKSPUR.get().asItem()
      )
      .setReplace(false);
