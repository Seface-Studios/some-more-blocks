...
public class SMBBlockFamilies {
  ...
  public static final BlockFamily TUFF_BRICKS = register(SMBBlocks.TUFF_BRICKS.get()).cracked(SMBBlocks.CRACKED_TUFF_BRICKS.get()).chiseled(SMBBlocks.CHISELED_TUFF_BRICKS.get()).stairs(SMBBlocks.TUFF_BRICK_STAIRS.get()).slab(SMBBlocks.TUFF_BRICK_SLAB.get()).wall(SMBBlocks.TUFF_BRICK_WALL.get()).getFamily();
  public static final BlockFamily POLISHED_TUFF = register(SMBBlocks.POLISHED_TUFF.get()).stairs(SMBBlocks.POLISHED_TUFF_STAIRS.get()).slab(SMBBlocks.POLISHED_TUFF_SLAB.get()).getFamily();
