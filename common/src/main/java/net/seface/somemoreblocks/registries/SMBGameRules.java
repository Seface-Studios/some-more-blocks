...
public class SMBGameRules {
  ...
  public static final GameRules.Key<GameRules.BooleanValue> RULE_DRY_LEAF_LITTER = PlatformServices.REGISTRY.registerBooleanGameRule("doLeafLitterDry", GameRules.Category.UPDATES, true);
