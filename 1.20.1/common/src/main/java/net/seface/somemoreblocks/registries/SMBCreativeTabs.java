  ...
  public static final PlatformRegistryObject<CreativeModeTab> MORE_BUILDING_BLOCKS = PlatformServices.REGISTRY.registerCreativeModeTab("more_building_blocks", CreativeModeTab.Row.TOP, 0,
    (builder) -> builder
      ...
      .displayItems((ctx, entry) -> {
        ...
        entry.accept(SMBBlocks.TUFF_BRICKS.get());
        entry.accept(SMBBlocks.CRACKED_TUFF_BRICKS.get());
        entry.accept(SMBBlocks.TUFF_BRICK_STAIRS.get());
        entry.accept(SMBBlocks.TUFF_BRICK_SLAB.get());
        entry.accept(SMBBlocks.TUFF_BRICK_WALL.get());
        entry.accept(SMBBlocks.CHISELED_TUFF_BRICKS.get());
        entry.accept(SMBBlocks.POLISHED_TUFF.get());
        entry.accept(SMBBlocks.POLISHED_TUFF_STAIRS.get());
        entry.accept(SMBBlocks.POLISHED_TUFF_SLAB.get());
