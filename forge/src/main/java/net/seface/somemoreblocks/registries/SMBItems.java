...
public class SMBItems {
  ...
  public static final RegistryObject<Item> AZALEA_LEAVES_BUCKET = registerItem("azalea_leaves_bucket", () -> new LeavesBucketItem(SMBBlocks.AZALEA_LEAF_LITTER.get(), SoundEvents.AZALEA_LEAVES_PLACE, new Item.Properties().stacksTo(1).component(SMBForgedDataComponentTypes.BUCKET_VOLUME.get(), 16).setId(ITEMS.key("azalea_leaves_bucket"))));
  ...
  public static final RegistryObject<Item> FLOWERING_AZALEA_LEAVES_BUCKET = registerItem("flowering_azalea_leaves_bucket", () -> new LeavesBucketItem(SMBBlocks.FLOWERING_AZALEA_LEAF_LITTER.get(), SoundEvents.AZALEA_LEAVES_PLACE, new Item.Properties().stacksTo(1).component(SMBForgedDataComponentTypes.BUCKET_VOLUME.get(), 16).setId(ITEMS.key("flowering_azalea_leaves_bucket"))));
  public static final RegistryObject<Item> SPRUCE_LEAVES_BUCKET = registerItem("spruce_leaves_bucket", () -> new LeavesBucketItem(SMBBlocks.SPRUCE_LEAF_LITTER.get(), SoundEvents.GRASS_PLACE, new Item.Properties().stacksTo(1).component(SMBForgedDataComponentTypes.BUCKET_VOLUME.get(), 16).setId(ITEMS.key("spruce_leaves_bucket"))));
  public static final RegistryObject<Item> BIRCH_LEAVES_BUCKET = registerItem("birch_leaves_bucket", () -> new LeavesBucketItem(SMBBlocks.BIRCH_LEAF_LITTER.get(), SoundEvents.GRASS_PLACE, new Item.Properties().stacksTo(1).component(SMBForgedDataComponentTypes.BUCKET_VOLUME.get(), 16).setId(ITEMS.key("birch_leaves_bucket"))));
  public static final RegistryObject<Item> LEAVES_BUCKET = registerItem("leaves_bucket", () -> new LeavesBucketItem(SMBBlocks.LEAF_LITTER.get(), SoundEvents.GRASS_PLACE, new Item.Properties().stacksTo(1).component(SMBForgedDataComponentTypes.BUCKET_VOLUME.get(), 16).setId(ITEMS.key("leaves_bucket"))));
  ...
  /* 1.21.4 */
  public static final RegistryObject<Item> PALE_OAK_LEAVES_BUCKET = registerItem("pale_oak_leaves_bucket", () -> new LeavesBucketItem(SMBBlocks.PALE_OAK_LEAF_LITTER.get(), SoundEvents.GRASS_PLACE, new Item.Properties().stacksTo(1).component(SMBForgedDataComponentTypes.BUCKET_VOLUME.get(), 16).setId(ITEMS.key("pale_oak_leaves_bucket"))));
  public static final RegistryObject<Item> CARVED_PALE_OAK_LOG = registerItem("carved_pale_oak_log", () -> new CarvedPaleOakBlockItem(SMBBlocks.CARVED_PALE_OAK_LOG.get(), new Item.Properties().useBlockDescriptionPrefix().component(SMBForgedDataComponentTypes.MOON_PHASE.get(), RotatedCarvedPaleOakBlock.MIN_MOON_PHASE).setId(ITEMS.key("carved_pale_oak_log"))));
  public static final RegistryObject<Item> CARVED_PALE_OAK_WOOD = registerItem("carved_pale_oak_wood", () -> new CarvedPaleOakBlockItem(SMBBlocks.CARVED_PALE_OAK_WOOD.get(), new Item.Properties().useBlockDescriptionPrefix().component(SMBForgedDataComponentTypes.MOON_PHASE.get(), RotatedCarvedPaleOakBlock.MIN_MOON_PHASE).setId(ITEMS.key("carved_pale_oak_wood"))));
