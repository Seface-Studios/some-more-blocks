...
public class SMBBlockStateTemplates {
  ...
  public static void createGlassBlocks(Block glassBlock, Block paneTopBlock) {
    ...
    Block glassPane = BuiltInRegistries.BLOCK.getValue(BuiltInRegistries.BLOCK.getKey(glassBlock).withSuffix("_pane"));
  ...
  public static void createCarvedPaleOakBlock(Block logBlock, Block strippedLogBlock) {
