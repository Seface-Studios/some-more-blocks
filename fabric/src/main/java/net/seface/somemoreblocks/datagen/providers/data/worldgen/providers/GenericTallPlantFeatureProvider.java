...
public class GenericTallPlantFeatureProvider extends AbstractFeatureProvider<RandomPatchConfiguration> {
  private final Block placeableBlock;

  public GenericTallPlantFeatureProvider(Block placeableBlock) {
  ...
  protected RandomPatchConfiguration configuration() {
    return new RandomPatchConfiguration(16, 1, 3,
