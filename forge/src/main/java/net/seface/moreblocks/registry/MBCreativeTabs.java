...
public class MBCreativeTabs {
    ...
    private static final RegistryObject<CreativeModeTab> MORE_BUILDING_BLOCKS = CREATIVE_MODE_TABS.register("more_building_blocks", () -> CreativeModeTab.builder()
            ...
            .displayItems((ctx, entry) -> {
                ...
                //entryWithoutFeatureFlag(ctx, entry, FeatureFlags.UPDATE_1_21, MBBlocks.TUFF_BRICKS.get());
                entry.accept(MBBlocks.CRACKED_TUFF_BRICKS.get());
                //entryWithoutFeatureFlag(ctx, entry, FeatureFlags.UPDATE_1_21, MBBlocks.TUFF_BRICKS_SLAB.get());
                //entryWithoutFeatureFlag(ctx, entry, FeatureFlags.UPDATE_1_21, MBBlocks.TUFF_BRICKS_STAIRS.get());
                //entryWithoutFeatureFlag(ctx, entry, FeatureFlags.UPDATE_1_21, MBBlocks.TUFF_BRICKS_WALL.get());
                //entryWithoutFeatureFlag(ctx, entry, FeatureFlags.UPDATE_1_21, MBBlocks.CHISELED_TUFF.get());
                //entryWithoutFeatureFlag(ctx, entry, FeatureFlags.UPDATE_1_21, MBBlocks.POLISHED_TUFF.get());
                //entryWithoutFeatureFlag(ctx, entry, FeatureFlags.UPDATE_1_21, MBBlocks.POLISHED_TUFF_SLAB.get());
                //entryWithoutFeatureFlag(ctx, entry, FeatureFlags.UPDATE_1_21, MBBlocks.POLISHED_TUFF_STAIRS.get());
    ...
    @SubscribeEvent
    public static void registerOnVanillaTab(BuildCreativeModeTabContentsEvent event) {
        if (event.getTabKey() == CreativeModeTabs.TOOLS_AND_UTILITIES) {
            event.accept(MBItems.CRACKING_TOOL);
        }
    }
}
