...
public class MBBlocks {
    ...
    public static final RegistryObject<Block> AZALEA_LEAF_LITTER = registerBlock("azalea_leaf_litter", () -> new LeafLitterBlock(BlockBehaviour.Properties.ofFullCopy(Blocks.AZALEA_LEAVES).noCollission().instabreak(), 30.0F), false);
    public static final RegistryObject<Block> BIRCH_LEAF_LITTER = registerBlock("birch_leaf_litter", () -> new LeafLitterBlock(BlockBehaviour.Properties.ofFullCopy(Blocks.BIRCH_LEAVES).noCollission().instabreak(), 25.0F), false);
    ...
    public static final RegistryObject<Block> TALL_BROWN_MUSHROOM_COLONY = registerBlock("tall_brown_mushroom_colony", () -> new DoubleMushroomColonyBlock(MBBlocks.BROWN_MUSHROOM_COLONY.get(), BlockBehaviour.Properties.ofFullCopy(Blocks.BROWN_MUSHROOM)));
    ...
    public static final RegistryObject<Block> TALL_CRIMSON_FUNGUS_COLONY = registerBlock("tall_crimson_fungus_colony", () -> new DoubleMushroomColonyBlock(MBBlocks.CRIMSON_FUNGUS_COLONY.get(), BlockBehaviour.Properties.ofFullCopy(Blocks.CRIMSON_FUNGUS)));
    ...
    public static final RegistryObject<Block> FLOWERING_AZALEA_LEAF_LITTER = registerBlock("flowering_azalea_leaf_litter", () -> new LeafLitterBlock(BlockBehaviour.Properties.ofFullCopy(Blocks.FLOWERING_AZALEA_LEAVES).noCollission().instabreak(), 20.0F), false);
    public static final RegistryObject<Block> SPRUCE_LEAF_LITTER = registerBlock("spruce_leaf_litter", () -> new LeafLitterBlock(BlockBehaviour.Properties.ofFullCopy(Blocks.SPRUCE_LEAVES).noCollission().instabreak(), 25.0F), false);
    public static final RegistryObject<Block> LEAF_LITTER = registerBlock("leaf_litter", () -> new LeafLitterBlock(BlockBehaviour.Properties.ofFullCopy(Blocks.OAK_LEAVES).noCollission().instabreak(), 25.0F), false);
    ...
    public static final RegistryObject<Block> TALL_RED_MUSHROOM_COLONY = registerBlock("tall_red_mushroom_colony", () -> new DoubleMushroomColonyBlock(MBBlocks.RED_MUSHROOM_COLONY.get(), BlockBehaviour.Properties.ofFullCopy(Blocks.RED_MUSHROOM)));
    ...
    public static final RegistryObject<Block> DUNE_GRASS = registerBlock("dune_grass", () -> new GenericBonemealableBushBlock(MBBlocks.TALL_DUNE_GRASS.get(), MBBlockTags.DUNE_GRASS_PLACEABLE, BlockBehaviour.Properties.ofFullCopy(Blocks.SHORT_GRASS)));
    ...
    public static final RegistryObject<Block> SNOW_FERN = registerBlock("snow_fern", () -> new GenericBonemealableBushBlock(MBBlocks.TALL_SNOW_FERN.get(), BlockBehaviour.Properties.ofFullCopy(Blocks.FERN)));
    ...
    public static final RegistryObject<Block> SNOW_GRASS = registerBlock("snow_grass", () -> new GenericBonemealableBushBlock(MBBlocks.TALL_SNOW_GRASS.get(), BlockBehaviour.Properties.ofFullCopy(Blocks.SHORT_GRASS)));
    ...
    public static final RegistryObject<Block> TALL_WARPED_FUNGUS_COLONY = registerBlock("tall_warped_fungus_colony", () -> new DoubleMushroomColonyBlock(MBBlocks.WARPED_FUNGUS_COLONY.get(), BlockBehaviour.Properties.ofFullCopy(Blocks.WARPED_FUNGUS)));
    ...
    public static final RegistryObject<Block> POLISHED_SNOW_SLAB = registerBlock("polished_snow_slab", () -> new SlabBlock(BlockBehaviour.Properties.ofFullCopy(MBBlocks.POLISHED_SNOW.get())));
    public static final RegistryObject<Block> POLISHED_SNOW_STAIRS = registerBlock("polished_snow_stairs", () -> new StairBlock(POLISHED_SNOW.get().defaultBlockState(), BlockBehaviour.Properties.ofFullCopy(MBBlocks.POLISHED_SNOW.get())));
    ...
    public static final RegistryObject<Block> SNOW_BRICK_SLAB = registerBlock("snow_brick_slab", () -> new SlabBlock(BlockBehaviour.Properties.ofFullCopy(MBBlocks.SNOW_BRICKS.get())));
    public static final RegistryObject<Block> SNOW_BRICK_STAIRS = registerBlock("snow_brick_stairs", () -> new StairBlock(SNOW_BRICKS.get().defaultBlockState(), BlockBehaviour.Properties.ofFullCopy(MBBlocks.SNOW_BRICKS.get())));
    public static final RegistryObject<Block> SNOW_BRICK_WALL = registerBlock("snow_brick_wall", () -> new WallBlock(BlockBehaviour.Properties.ofFullCopy(MBBlocks.SNOW_BRICKS.get()).forceSolidOn()));
    ...
    public static final RegistryObject<Block> SNOW_TILE_SLAB = registerBlock("snow_tile_slab", () -> new SlabBlock(BlockBehaviour.Properties.ofFullCopy(MBBlocks.SNOW_TILES.get())));
    public static final RegistryObject<Block> SNOW_TILE_STAIRS = registerBlock("snow_tile_stairs", () -> new StairBlock(SNOW_TILES.get().defaultBlockState(), BlockBehaviour.Properties.ofFullCopy(MBBlocks.SNOW_TILES.get())));
    public static final RegistryObject<Block> SNOW_TILE_WALL = registerBlock("snow_tile_wall", () -> new WallBlock(BlockBehaviour.Properties.ofFullCopy(MBBlocks.SNOW_TILES.get()).forceSolidOn()));
    ...
    public static final RegistryObject<Block> SMOOTH_DEEPSLATE_SLAB = registerBlock("smooth_deepslate_slab", () -> new SlabBlock(BlockBehaviour.Properties.ofFullCopy(MBBlocks.SMOOTH_DEEPSLATE.get())));
    ...
    public static final RegistryObject<Block> MOSSY_DEEPSLATE_BRICK_SLAB = registerBlock("mossy_deepslate_brick_slab", () -> new SlabBlock(BlockBehaviour.Properties.ofFullCopy(MBBlocks.MOSSY_DEEPSLATE_BRICKS.get())));
    public static final RegistryObject<Block> MOSSY_DEEPSLATE_BRICK_STAIRS = registerBlock("mossy_deepslate_brick_stairs", () -> new StairBlock(MOSSY_DEEPSLATE_BRICKS.get().defaultBlockState(), BlockBehaviour.Properties.ofFullCopy(MBBlocks.MOSSY_DEEPSLATE_BRICKS.get())));
    public static final RegistryObject<Block> MOSSY_DEEPSLATE_BRICK_WALL = registerBlock("mossy_deepslate_brick_wall", () -> new WallBlock(BlockBehaviour.Properties.ofFullCopy(MBBlocks.MOSSY_DEEPSLATE_BRICKS.get()).forceSolidOn()));
    ...
    public static final RegistryObject<Block> POLISHED_STONE_STAIRS = registerBlock("polished_stone_stairs", () -> new StairBlock(POLISHED_STONE.get().defaultBlockState(), BlockBehaviour.Properties.ofFullCopy(MBBlocks.POLISHED_STONE.get())));
    ...
    public static final RegistryObject<Block> STONE_TILE_SLAB = registerBlock("stone_tile_slab", () -> new SlabBlock(BlockBehaviour.Properties.ofFullCopy(MBBlocks.STONE_TILES.get())));
    public static final RegistryObject<Block> STONE_TILE_STAIRS = registerBlock("stone_tile_stairs", () -> new StairBlock(STONE_TILES.get().defaultBlockState(), BlockBehaviour.Properties.ofFullCopy(MBBlocks.STONE_TILES.get())));
    public static final RegistryObject<Block> STONE_TILE_WALL = registerBlock("stone_tile_wall", () -> new WallBlock(BlockBehaviour.Properties.ofFullCopy(MBBlocks.STONE_TILES.get()).forceSolidOn()));
    ...
    public static final RegistryObject<Block> SMOOTH_GRANITE_SLAB = registerBlock("smooth_granite_slab", () -> new SlabBlock(BlockBehaviour.Properties.ofFullCopy(MBBlocks.SMOOTH_GRANITE.get())));
    ...
    public static final RegistryObject<Block> GRANITE_BRICK_SLAB = registerBlock("granite_brick_slab", () -> new SlabBlock(BlockBehaviour.Properties.ofFullCopy(MBBlocks.GRANITE_BRICKS.get())));
    public static final RegistryObject<Block> GRANITE_BRICK_STAIRS = registerBlock("granite_brick_stairs", () -> new StairBlock(GRANITE_BRICKS.get().defaultBlockState(), BlockBehaviour.Properties.ofFullCopy(MBBlocks.GRANITE_BRICKS.get())));
    public static final RegistryObject<Block> GRANITE_BRICK_WALL = registerBlock("granite_brick_wall", () -> new WallBlock(BlockBehaviour.Properties.ofFullCopy(MBBlocks.GRANITE_BRICKS.get()).forceSolidOn()));
    ...
    public static final RegistryObject<Block> MOSSY_GRANITE_BRICK_SLAB = registerBlock("mossy_granite_brick_slab", () -> new SlabBlock(BlockBehaviour.Properties.ofFullCopy(MBBlocks.MOSSY_GRANITE_BRICKS.get())));
    public static final RegistryObject<Block> MOSSY_GRANITE_BRICK_STAIRS = registerBlock("mossy_granite_brick_stairs", () -> new StairBlock(MOSSY_GRANITE_BRICKS.get().defaultBlockState(), BlockBehaviour.Properties.ofFullCopy(MBBlocks.MOSSY_GRANITE_BRICKS.get())));
    public static final RegistryObject<Block> MOSSY_GRANITE_BRICK_WALL = registerBlock("mossy_granite_brick_wall", () -> new WallBlock(BlockBehaviour.Properties.ofFullCopy(MBBlocks.MOSSY_GRANITE_BRICKS.get()).forceSolidOn()));
    ...
    public static final RegistryObject<Block> GRANITE_TILE_SLAB = registerBlock("granite_tile_slab", () -> new SlabBlock(BlockBehaviour.Properties.ofFullCopy(MBBlocks.GRANITE_TILES.get())));
    public static final RegistryObject<Block> GRANITE_TILE_STAIRS = registerBlock("granite_tile_stairs", () -> new StairBlock(GRANITE_TILES.get().defaultBlockState(), BlockBehaviour.Properties.ofFullCopy(MBBlocks.GRANITE_TILES.get())));
    public static final RegistryObject<Block> GRANITE_TILE_WALL = registerBlock("granite_tile_wall", () -> new WallBlock(BlockBehaviour.Properties.ofFullCopy(MBBlocks.GRANITE_TILES.get()).forceSolidOn()));
    ...
    public static final RegistryObject<Block> SMOOTH_DIORITE_SLAB = registerBlock("smooth_diorite_slab", () -> new SlabBlock(BlockBehaviour.Properties.ofFullCopy(MBBlocks.SMOOTH_DIORITE.get())));
    ...
    public static final RegistryObject<Block> DIORITE_BRICK_SLAB = registerBlock("diorite_brick_slab", () -> new SlabBlock(BlockBehaviour.Properties.ofFullCopy(MBBlocks.DIORITE_BRICKS.get())));
    public static final RegistryObject<Block> DIORITE_BRICK_STAIRS = registerBlock("diorite_brick_stairs", () -> new StairBlock(DIORITE_BRICKS.get().defaultBlockState(), BlockBehaviour.Properties.ofFullCopy(MBBlocks.DIORITE_BRICKS.get())));
    public static final RegistryObject<Block> DIORITE_BRICK_WALL = registerBlock("diorite_brick_wall", () -> new WallBlock(BlockBehaviour.Properties.ofFullCopy(MBBlocks.DIORITE_BRICKS.get()).forceSolidOn()));
    ...
    public static final RegistryObject<Block> MOSSY_DIORITE_BRICK_SLAB = registerBlock("mossy_diorite_brick_slab", () -> new SlabBlock(BlockBehaviour.Properties.ofFullCopy(MBBlocks.MOSSY_DIORITE_BRICKS.get())));
    public static final RegistryObject<Block> MOSSY_DIORITE_BRICK_STAIRS = registerBlock("mossy_diorite_brick_stairs", () -> new StairBlock(MOSSY_DIORITE_BRICKS.get().defaultBlockState(), BlockBehaviour.Properties.ofFullCopy(MBBlocks.MOSSY_DIORITE_BRICKS.get())));
    public static final RegistryObject<Block> MOSSY_DIORITE_BRICK_WALL = registerBlock("mossy_diorite_brick_wall", () -> new WallBlock(BlockBehaviour.Properties.ofFullCopy(MBBlocks.MOSSY_DIORITE_BRICKS.get()).forceSolidOn()));
    ...
    public static final RegistryObject<Block> DIORITE_TILE_SLAB = registerBlock("diorite_tile_slab", () -> new SlabBlock(BlockBehaviour.Properties.ofFullCopy(MBBlocks.DIORITE_TILES.get())));
    public static final RegistryObject<Block> DIORITE_TILE_STAIRS = registerBlock("diorite_tile_stairs", () -> new StairBlock(DIORITE_TILES.get().defaultBlockState(), BlockBehaviour.Properties.ofFullCopy(MBBlocks.DIORITE_TILES.get())));
    public static final RegistryObject<Block> DIORITE_TILE_WALL = registerBlock("diorite_tile_wall", () -> new WallBlock(BlockBehaviour.Properties.ofFullCopy(MBBlocks.DIORITE_TILES.get()).forceSolidOn()));
    ...
    public static final RegistryObject<Block> SMOOTH_ANDESITE_SLAB = registerBlock("smooth_andesite_slab", () -> new SlabBlock(BlockBehaviour.Properties.ofFullCopy(MBBlocks.SMOOTH_ANDESITE.get())));
    ...
    public static final RegistryObject<Block> ANDESITE_BRICK_SLAB = registerBlock("andesite_brick_slab", () -> new SlabBlock(BlockBehaviour.Properties.ofFullCopy(MBBlocks.ANDESITE_BRICKS.get())));
    public static final RegistryObject<Block> ANDESITE_BRICK_STAIRS = registerBlock("andesite_brick_stairs", () -> new StairBlock(ANDESITE_BRICKS.get().defaultBlockState(), BlockBehaviour.Properties.ofFullCopy(MBBlocks.ANDESITE_BRICKS.get())));
    public static final RegistryObject<Block> ANDESITE_BRICK_WALL = registerBlock("andesite_brick_wall", () -> new WallBlock(BlockBehaviour.Properties.ofFullCopy(MBBlocks.ANDESITE_BRICKS.get()).forceSolidOn()));
    ...
    public static final RegistryObject<Block> MOSSY_ANDESITE_BRICK_SLAB = registerBlock("mossy_andesite_brick_slab", () -> new SlabBlock(BlockBehaviour.Properties.ofFullCopy(MBBlocks.MOSSY_ANDESITE_BRICKS.get())));
    public static final RegistryObject<Block> MOSSY_ANDESITE_BRICK_STAIRS = registerBlock("mossy_andesite_brick_stairs", () -> new StairBlock(MOSSY_ANDESITE_BRICKS.get().defaultBlockState(), BlockBehaviour.Properties.ofFullCopy(MBBlocks.MOSSY_ANDESITE_BRICKS.get())));
    public static final RegistryObject<Block> MOSSY_ANDESITE_BRICK_WALL = registerBlock("mossy_andesite_brick_wall", () -> new WallBlock(BlockBehaviour.Properties.ofFullCopy(MBBlocks.MOSSY_ANDESITE_BRICKS.get()).forceSolidOn()));
    ...
    public static final RegistryObject<Block> ANDESITE_TILE_SLAB = registerBlock("andesite_tile_slab", () -> new SlabBlock(BlockBehaviour.Properties.ofFullCopy(MBBlocks.ANDESITE_TILES.get())));
    public static final RegistryObject<Block> ANDESITE_TILE_STAIRS = registerBlock("andesite_tile_stairs", () -> new StairBlock(ANDESITE_TILES.get().defaultBlockState(), BlockBehaviour.Properties.ofFullCopy(MBBlocks.ANDESITE_TILES.get())));
    public static final RegistryObject<Block> ANDESITE_TILE_WALL = registerBlock("andesite_tile_wall", () -> new WallBlock(BlockBehaviour.Properties.ofFullCopy(MBBlocks.ANDESITE_TILES.get()).forceSolidOn()));
    ...
    public static final RegistryObject<Block> POLISHED_END_STONE_SLAB = registerBlock("polished_end_stone_slab", () -> new SlabBlock(BlockBehaviour.Properties.ofFullCopy(MBBlocks.POLISHED_END_STONE.get())));
    public static final RegistryObject<Block> POLISHED_END_STONE_STAIRS = registerBlock("polished_end_stone_stairs", () -> new StairBlock(POLISHED_END_STONE.get().defaultBlockState(), BlockBehaviour.Properties.ofFullCopy(MBBlocks.POLISHED_END_STONE.get())));
    ...
    public static final RegistryObject<Block> SMOOTH_END_STONE_SLAB = registerBlock("smooth_end_stone_slab", () -> new SlabBlock(BlockBehaviour.Properties.ofFullCopy(MBBlocks.SMOOTH_END_STONE.get())));
    public static final RegistryObject<Block> CHISELED_END_STONE = registerBlock("chiseled_end_stone", () -> new Block(BlockBehaviour.Properties.ofFullCopy(Blocks.END_STONE)));
    ...
    public static final RegistryObject<Block> MOSSY_END_STONE_BRICK_SLAB = registerBlock("mossy_end_stone_brick_slab", () -> new SlabBlock(BlockBehaviour.Properties.ofFullCopy(MBBlocks.MOSSY_END_STONE_BRICKS.get())));
    public static final RegistryObject<Block> MOSSY_END_STONE_BRICK_STAIRS = registerBlock("mossy_end_stone_brick_stairs", () -> new StairBlock(MOSSY_END_STONE_BRICKS.get().defaultBlockState(), BlockBehaviour.Properties.ofFullCopy(MBBlocks.MOSSY_END_STONE_BRICKS.get())));
    public static final RegistryObject<Block> MOSSY_END_STONE_BRICK_WALL = registerBlock("mossy_end_stone_brick_wall", () -> new WallBlock(BlockBehaviour.Properties.ofFullCopy(MBBlocks.MOSSY_END_STONE_BRICKS.get()).forceSolidOn()));
    ...
    public static final RegistryObject<Block> END_STONE_TILE_SLAB = registerBlock("end_stone_tile_slab", () -> new SlabBlock(BlockBehaviour.Properties.ofFullCopy(MBBlocks.END_STONE_TILES.get())));
    public static final RegistryObject<Block> END_STONE_TILE_STAIRS = registerBlock("end_stone_tile_stairs", () -> new StairBlock(END_STONE_TILES.get().defaultBlockState(), BlockBehaviour.Properties.ofFullCopy(MBBlocks.END_STONE_TILES.get())));
    public static final RegistryObject<Block> END_STONE_TILE_WALL = registerBlock("end_stone_tile_wall", () -> new WallBlock(BlockBehaviour.Properties.ofFullCopy(MBBlocks.END_STONE_TILES.get()).forceSolidOn()));
    ...
    public static final RegistryObject<Block> TUFF_BRICK_SLAB = registerBlock("tuff_brick_slab", () -> new SlabBlock(BlockBehaviour.Properties.ofFullCopy(MBBlocks.TUFF_BRICKS.get())));
    public static final RegistryObject<Block> TUFF_BRICK_STAIRS = registerBlock("tuff_brick_stairs", () -> new StairBlock(TUFF_BRICKS.get().defaultBlockState(), BlockBehaviour.Properties.ofFullCopy(MBBlocks.TUFF_BRICKS.get())));
    public static final RegistryObject<Block> TUFF_BRICK_WALL = registerBlock("tuff_brick_wall", () -> new WallBlock(BlockBehaviour.Properties.ofFullCopy(MBBlocks.TUFF_BRICKS.get())));
    ...
    public static final RegistryObject<Block> MOSSY_TUFF_BRICK_SLAB = registerBlock("mossy_tuff_brick_slab", () -> new SlabBlock(BlockBehaviour.Properties.ofFullCopy(MBBlocks.MOSSY_TUFF_BRICKS.get())));
    public static final RegistryObject<Block> MOSSY_TUFF_BRICK_STAIRS = registerBlock("mossy_tuff_brick_stairs", () -> new StairBlock(MOSSY_TUFF_BRICKS.get().defaultBlockState(), BlockBehaviour.Properties.ofFullCopy(MBBlocks.MOSSY_TUFF_BRICKS.get())));
    public static final RegistryObject<Block> MOSSY_TUFF_BRICK_WALL = registerBlock("mossy_tuff_brick_wall", () -> new WallBlock(BlockBehaviour.Properties.ofFullCopy(MBBlocks.MOSSY_TUFF_BRICKS.get())));
    ...
    public static final RegistryObject<Block> TUFF_TILE_SLAB = registerBlock("tuff_tile_slab", () -> new SlabBlock(BlockBehaviour.Properties.ofFullCopy(MBBlocks.TUFF_TILES.get()).sound(SoundType.TUFF_BRICKS)));
    public static final RegistryObject<Block> TUFF_TILE_STAIRS = registerBlock("tuff_tile_stairs", () -> new StairBlock(TUFF_TILES.get().defaultBlockState(), BlockBehaviour.Properties.ofFullCopy(MBBlocks.TUFF_TILES.get()).sound(SoundType.TUFF_BRICKS)));
    public static final RegistryObject<Block> TUFF_TILE_WALL = registerBlock("tuff_tile_wall", () -> new WallBlock(BlockBehaviour.Properties.ofFullCopy(MBBlocks.TUFF_TILES.get()).forceSolidOn().sound(SoundType.TUFF_BRICKS)));
    ...
    public static final RegistryObject<Block> RED_SANDSTONE_BRICK_SLAB = registerBlock("red_sandstone_brick_slab", () -> new SlabBlock(BlockBehaviour.Properties.ofFullCopy(MBBlocks.RED_SANDSTONE_BRICKS.get())));
    public static final RegistryObject<Block> RED_SANDSTONE_BRICK_STAIRS = registerBlock("red_sandstone_brick_stairs", () -> new StairBlock(RED_SANDSTONE_BRICKS.get().defaultBlockState(), BlockBehaviour.Properties.ofFullCopy(MBBlocks.RED_SANDSTONE_BRICKS.get())));
    public static final RegistryObject<Block> RED_SANDSTONE_BRICK_WALL = registerBlock("red_sandstone_brick_wall", () -> new WallBlock(BlockBehaviour.Properties.ofFullCopy(MBBlocks.RED_SANDSTONE_BRICKS.get()).forceSolidOn()));
    ...
    public static final RegistryObject<Block> MOSSY_RED_SANDSTONE_BRICK_SLAB = registerBlock("mossy_red_sandstone_brick_slab", () -> new SlabBlock(BlockBehaviour.Properties.ofFullCopy(MBBlocks.MOSSY_RED_SANDSTONE_BRICKS.get())));
    public static final RegistryObject<Block> MOSSY_RED_SANDSTONE_BRICK_STAIRS = registerBlock("mossy_red_sandstone_brick_stairs", () -> new StairBlock(MOSSY_RED_SANDSTONE_BRICKS.get().defaultBlockState(), BlockBehaviour.Properties.ofFullCopy(MBBlocks.MOSSY_RED_SANDSTONE_BRICKS.get())));
    public static final RegistryObject<Block> MOSSY_RED_SANDSTONE_BRICK_WALL = registerBlock("mossy_red_sandstone_brick_wall", () -> new WallBlock(BlockBehaviour.Properties.ofFullCopy(MBBlocks.MOSSY_RED_SANDSTONE_BRICKS.get()).forceSolidOn()));
    ...
    public static final RegistryObject<Block> RED_SANDSTONE_TILE_SLAB = registerBlock("red_sandstone_tile_slab", () -> new SlabBlock(BlockBehaviour.Properties.ofFullCopy(MBBlocks.RED_SANDSTONE_TILES.get())));
    public static final RegistryObject<Block> RED_SANDSTONE_TILE_STAIRS = registerBlock("red_sandstone_tile_stairs", () -> new StairBlock(RED_SANDSTONE_TILES.get().defaultBlockState(), BlockBehaviour.Properties.ofFullCopy(MBBlocks.RED_SANDSTONE_TILES.get())));
    public static final RegistryObject<Block> RED_SANDSTONE_TILE_WALL = registerBlock("red_sandstone_tile_wall", () -> new WallBlock(BlockBehaviour.Properties.ofFullCopy(MBBlocks.RED_SANDSTONE_TILES.get()).forceSolidOn()));
    ...
    public static final RegistryObject<Block> POLISHED_CALCITE_SLAB = registerBlock("polished_calcite_slab", () -> new SlabBlock(BlockBehaviour.Properties.ofFullCopy(MBBlocks.POLISHED_CALCITE.get())));
    public static final RegistryObject<Block> POLISHED_CALCITE_STAIRS = registerBlock("polished_calcite_stairs", () -> new StairBlock(POLISHED_CALCITE.get().defaultBlockState(), BlockBehaviour.Properties.ofFullCopy(MBBlocks.POLISHED_CALCITE.get())));
    ...
    public static final RegistryObject<Block> SMOOTH_CALCITE_SLAB = registerBlock("smooth_calcite_slab", () -> new SlabBlock(BlockBehaviour.Properties.ofFullCopy(MBBlocks.SMOOTH_CALCITE.get())));
    public static final RegistryObject<Block> CHISELED_CALCITE = registerBlock("chiseled_calcite", () -> new Block(BlockBehaviour.Properties.ofFullCopy(Blocks.CALCITE)));
    ...
    public static final RegistryObject<Block> CALCITE_BRICK_SLAB = registerBlock("calcite_brick_slab", () -> new SlabBlock(BlockBehaviour.Properties.ofFullCopy(MBBlocks.CALCITE_BRICKS.get())));
    public static final RegistryObject<Block> CALCITE_BRICK_STAIRS = registerBlock("calcite_brick_stairs", () -> new StairBlock(CALCITE_BRICKS.get().defaultBlockState(), BlockBehaviour.Properties.ofFullCopy(MBBlocks.CALCITE_BRICKS.get())));
    public static final RegistryObject<Block> CALCITE_BRICK_WALL = registerBlock("calcite_brick_wall", () -> new WallBlock(BlockBehaviour.Properties.ofFullCopy(MBBlocks.CALCITE_BRICKS.get()).forceSolidOn()));
    ...
    public static final RegistryObject<Block> MOSSY_CALCITE_BRICK_SLAB = registerBlock("mossy_calcite_brick_slab", () -> new SlabBlock(BlockBehaviour.Properties.ofFullCopy(MBBlocks.MOSSY_CALCITE_BRICKS.get())));
    public static final RegistryObject<Block> MOSSY_CALCITE_BRICK_STAIRS = registerBlock("mossy_calcite_brick_stairs", () -> new StairBlock(MOSSY_CALCITE_BRICKS.get().defaultBlockState(), BlockBehaviour.Properties.ofFullCopy(MBBlocks.MOSSY_CALCITE_BRICKS.get())));
    public static final RegistryObject<Block> MOSSY_CALCITE_BRICK_WALL = registerBlock("mossy_calcite_brick_wall", () -> new WallBlock(BlockBehaviour.Properties.ofFullCopy(MBBlocks.MOSSY_CALCITE_BRICKS.get()).forceSolidOn()));
    ...
    public static final RegistryObject<Block> CALCITE_TILE_SLAB = registerBlock("calcite_tile_slab", () -> new SlabBlock(BlockBehaviour.Properties.ofFullCopy(MBBlocks.CALCITE_TILES.get())));
    public static final RegistryObject<Block> CALCITE_TILE_STAIRS = registerBlock("calcite_tile_stairs", () -> new StairBlock(CALCITE_TILES.get().defaultBlockState(), BlockBehaviour.Properties.ofFullCopy(MBBlocks.CALCITE_TILES.get())));
    public static final RegistryObject<Block> CALCITE_TILE_WALL = registerBlock("calcite_tile_wall", () -> new WallBlock(BlockBehaviour.Properties.ofFullCopy(MBBlocks.CALCITE_TILES.get()).forceSolidOn()));
    ...
    public static final RegistryObject<Block> POLISHED_DRIPSTONE_SLAB = registerBlock("polished_dripstone_slab", () -> new SlabBlock(BlockBehaviour.Properties.ofFullCopy(MBBlocks.POLISHED_DRIPSTONE.get())));
    public static final RegistryObject<Block> POLISHED_DRIPSTONE_STAIRS = registerBlock("polished_dripstone_stairs", () -> new StairBlock(POLISHED_DRIPSTONE.get().defaultBlockState(), BlockBehaviour.Properties.ofFullCopy(MBBlocks.POLISHED_DRIPSTONE.get())));
    ...
    public static final RegistryObject<Block> SMOOTH_DRIPSTONE_SLAB = registerBlock("smooth_dripstone_slab", () -> new SlabBlock(BlockBehaviour.Properties.ofFullCopy(MBBlocks.SMOOTH_DRIPSTONE.get())));
    public static final RegistryObject<Block> CHISELED_DRIPSTONE = registerBlock("chiseled_dripstone", () -> new Block(BlockBehaviour.Properties.ofFullCopy(Blocks.DRIPSTONE_BLOCK)));
    ...
    public static final RegistryObject<Block> DRIPSTONE_BRICK_SLAB = registerBlock("dripstone_brick_slab", () -> new SlabBlock(BlockBehaviour.Properties.ofFullCopy(MBBlocks.DRIPSTONE_BRICKS.get())));
    public static final RegistryObject<Block> DRIPSTONE_BRICK_STAIRS = registerBlock("dripstone_brick_stairs", () -> new StairBlock(DRIPSTONE_BRICKS.get().defaultBlockState(), BlockBehaviour.Properties.ofFullCopy(MBBlocks.DRIPSTONE_BRICKS.get())));
    public static final RegistryObject<Block> DRIPSTONE_BRICK_WALL = registerBlock("dripstone_brick_wall", () -> new WallBlock(BlockBehaviour.Properties.ofFullCopy(MBBlocks.DRIPSTONE_BRICKS.get()).forceSolidOn()));
    ...
    public static final RegistryObject<Block> MOSSY_DRIPSTONE_BRICK_SLAB = registerBlock("mossy_dripstone_brick_slab", () -> new SlabBlock(BlockBehaviour.Properties.ofFullCopy(MBBlocks.MOSSY_DRIPSTONE_BRICKS.get())));
    public static final RegistryObject<Block> MOSSY_DRIPSTONE_BRICK_STAIRS = registerBlock("mossy_dripstone_brick_stairs", () -> new StairBlock(MOSSY_DRIPSTONE_BRICKS.get().defaultBlockState(), BlockBehaviour.Properties.ofFullCopy(MBBlocks.MOSSY_DRIPSTONE_BRICKS.get())));
    public static final RegistryObject<Block> MOSSY_DRIPSTONE_BRICK_WALL = registerBlock("mossy_dripstone_brick_wall", () -> new WallBlock(BlockBehaviour.Properties.ofFullCopy(MBBlocks.MOSSY_DRIPSTONE_BRICKS.get()).forceSolidOn()));
    ...
    public static final RegistryObject<Block> DRIPSTONE_TILE_SLAB = registerBlock("dripstone_tile_slab", () -> new SlabBlock(BlockBehaviour.Properties.ofFullCopy(MBBlocks.DRIPSTONE_TILES.get())));
    public static final RegistryObject<Block> DRIPSTONE_TILE_STAIRS = registerBlock("dripstone_tile_stairs", () -> new StairBlock(DRIPSTONE_TILES.get().defaultBlockState(), BlockBehaviour.Properties.ofFullCopy(MBBlocks.DRIPSTONE_TILES.get())));
    public static final RegistryObject<Block> DRIPSTONE_TILE_WALL = registerBlock("dripstone_tile_wall", () -> new WallBlock(BlockBehaviour.Properties.ofFullCopy(MBBlocks.DRIPSTONE_TILES.get()).forceSolidOn()));
    ...
    public static final RegistryObject<Block> POLISHED_PRISMARINE_SLAB = registerBlock("polished_prismarine_slab", () -> new SlabBlock(BlockBehaviour.Properties.ofFullCopy(MBBlocks.POLISHED_PRISMARINE.get())));
    public static final RegistryObject<Block> POLISHED_PRISMARINE_STAIRS = registerBlock("polished_prismarine_stairs", () -> new StairBlock(POLISHED_PRISMARINE.get().defaultBlockState(), BlockBehaviour.Properties.ofFullCopy(MBBlocks.POLISHED_PRISMARINE.get())));
    ...
    public static final RegistryObject<Block> SMOOTH_PRISMARINE_SLAB = registerBlock("smooth_prismarine_slab", () -> new SlabBlock(BlockBehaviour.Properties.ofFullCopy(MBBlocks.SMOOTH_PRISMARINE.get())));
    public static final RegistryObject<Block> CHISELED_PRISMARINE = registerBlock("chiseled_prismarine", () -> new Block(BlockBehaviour.Properties.ofFullCopy(Blocks.PRISMARINE)));
    ...
    public static final RegistryObject<Block> MOSSY_PRISMARINE_BRICK_SLAB = registerBlock("mossy_prismarine_brick_slab", () -> new SlabBlock(BlockBehaviour.Properties.ofFullCopy(MBBlocks.MOSSY_PRISMARINE_BRICKS.get())));
    public static final RegistryObject<Block> MOSSY_PRISMARINE_BRICK_STAIRS = registerBlock("mossy_prismarine_brick_stairs", () -> new StairBlock(MOSSY_PRISMARINE_BRICKS.get().defaultBlockState(), BlockBehaviour.Properties.ofFullCopy(MBBlocks.MOSSY_PRISMARINE_BRICKS.get())));
    public static final RegistryObject<Block> MOSSY_PRISMARINE_BRICK_WALL = registerBlock("mossy_prismarine_brick_wall", () -> new WallBlock(BlockBehaviour.Properties.ofFullCopy(MBBlocks.MOSSY_PRISMARINE_BRICKS.get()).forceSolidOn()));
    ...
    public static final RegistryObject<Block> PRISMARINE_TILE_SLAB = registerBlock("prismarine_tile_slab", () -> new SlabBlock(BlockBehaviour.Properties.ofFullCopy(MBBlocks.PRISMARINE_TILES.get())));
    public static final RegistryObject<Block> PRISMARINE_TILE_STAIRS = registerBlock("prismarine_tile_stairs", () -> new StairBlock(PRISMARINE_TILES.get().defaultBlockState(), BlockBehaviour.Properties.ofFullCopy(MBBlocks.PRISMARINE_TILES.get())));
    public static final RegistryObject<Block> PRISMARINE_TILE_WALL = registerBlock("prismarine_tile_wall", () -> new WallBlock(BlockBehaviour.Properties.ofFullCopy(MBBlocks.PRISMARINE_TILES.get()).forceSolidOn()));
    ...
    public static final RegistryObject<Block> SMOOTH_BLACKSTONE_SLAB = registerBlock("smooth_blackstone_slab", () -> new SlabBlock(BlockBehaviour.Properties.ofFullCopy(MBBlocks.SMOOTH_BLACKSTONE.get())));
    ...
    public static final RegistryObject<Block> CORRUPTED_POLISHED_BLACKSTONE_BRICK_SLAB = registerBlock("corrupted_polished_blackstone_brick_slab", () -> new SlabBlock(BlockBehaviour.Properties.ofFullCopy(MBBlocks.CORRUPTED_POLISHED_BLACKSTONE_BRICKS.get())));
    ...
    public static final RegistryObject<Block> CORRUPTED_POLISHED_BLACKSTONE_BRICK_WALL = registerBlock("corrupted_polished_blackstone_brick_wall", () -> new WallBlock(BlockBehaviour.Properties.ofFullCopy(MBBlocks.CORRUPTED_POLISHED_BLACKSTONE_BRICKS.get()).forceSolidOn()));
    ...
    public static final RegistryObject<Block> POLISHED_BLACKSTONE_TILE_SLAB = registerBlock("polished_blackstone_tile_slab", () -> new SlabBlock(BlockBehaviour.Properties.ofFullCopy(MBBlocks.POLISHED_BLACKSTONE_TILES.get())));
    public static final RegistryObject<Block> POLISHED_BLACKSTONE_TILE_STAIRS = registerBlock("polished_blackstone_tile_stairs", () -> new StairBlock(POLISHED_BLACKSTONE_TILES.get().defaultBlockState(), BlockBehaviour.Properties.ofFullCopy(MBBlocks.POLISHED_BLACKSTONE_TILES.get())));
    public static final RegistryObject<Block> POLISHED_BLACKSTONE_TILE_WALL = registerBlock("polished_blackstone_tile_wall", () -> new WallBlock(BlockBehaviour.Properties.ofFullCopy(MBBlocks.POLISHED_BLACKSTONE_TILES.get()).forceSolidOn()));
    ...
    //public static final RegistryObject<Block> MOSSY_QUARTZ_BRICK_SLAB = registerBlock("mossy_quartz_brick_slab", () -> new SlabBlock(BlockBehaviour.Properties.ofFullCopy(MBBlocks.MOSSY_QUARTZ_BRICKS.get())));
    //public static final RegistryObject<Block> MOSSY_QUARTZ_BRICK_STAIRS = registerBlock("mossy_quartz_brick_stairs", () -> new StairBlock(MOSSY_QUARTZ_BRICKS.get().defaultBlockState(), BlockBehaviour.Properties.ofFullCopy(MBBlocks.MOSSY_QUARTZ_BRICKS.get())));
    //public static final RegistryObject<Block> MOSSY_QUARTZ_BRICK_WALL = registerBlock("mossy_quartz_brick_wall", () -> new WallBlock(BlockBehaviour.Properties.ofFullCopy(MBBlocks.MOSSY_QUARTZ_BRICKS.get()).forceSolidOn()));
    ...
    public static final RegistryObject<Block> MOSSY_MUD_BRICK_SLAB = registerBlock("mossy_mud_brick_slab", () -> new SlabBlock(BlockBehaviour.Properties.ofFullCopy(MBBlocks.MOSSY_MUD_BRICKS.get())));
    public static final RegistryObject<Block> MOSSY_MUD_BRICK_STAIRS = registerBlock("mossy_mud_brick_stairs", () -> new StairBlock(MOSSY_MUD_BRICKS.get().defaultBlockState(), BlockBehaviour.Properties.ofFullCopy(MBBlocks.MOSSY_MUD_BRICKS.get())));
    public static final RegistryObject<Block> MOSSY_MUD_BRICK_WALL = registerBlock("mossy_mud_brick_wall", () -> new WallBlock(BlockBehaviour.Properties.ofFullCopy(MBBlocks.MOSSY_MUD_BRICKS.get()).forceSolidOn()));
    ...
    public static final RegistryObject<Block> MUD_TILE_SLAB = registerBlock("mud_tile_slab", () -> new SlabBlock(BlockBehaviour.Properties.ofFullCopy(MBBlocks.MUD_TILES.get())));
    public static final RegistryObject<Block> MUD_TILE_STAIRS = registerBlock("mud_tile_stairs", () -> new StairBlock(MUD_TILES.get().defaultBlockState(), BlockBehaviour.Properties.ofFullCopy(MBBlocks.MUD_TILES.get())));
    public static final RegistryObject<Block> MUD_TILE_WALL = registerBlock("mud_tile_wall", () -> new WallBlock(BlockBehaviour.Properties.ofFullCopy(MBBlocks.MUD_TILES.get()).forceSolidOn()));
    ...
    public static final RegistryObject<Block> SANDSTONE_BRICK_SLAB = registerBlock("sandstone_brick_slab", () -> new SlabBlock(BlockBehaviour.Properties.ofFullCopy(MBBlocks.SANDSTONE_BRICKS.get())));
    public static final RegistryObject<Block> SANDSTONE_BRICK_STAIRS = registerBlock("sandstone_brick_stairs", () -> new StairBlock(SANDSTONE_BRICKS.get().defaultBlockState(), BlockBehaviour.Properties.ofFullCopy(MBBlocks.SANDSTONE_BRICKS.get())));
    public static final RegistryObject<Block> SANDSTONE_BRICK_WALL = registerBlock("sandstone_brick_wall", () -> new WallBlock(BlockBehaviour.Properties.ofFullCopy(MBBlocks.SANDSTONE_BRICKS.get()).forceSolidOn()));
    ...
    public static final RegistryObject<Block> MOSSY_SANDSTONE_BRICK_SLAB = registerBlock("mossy_sandstone_brick_slab", () -> new SlabBlock(BlockBehaviour.Properties.ofFullCopy(MBBlocks.MOSSY_SANDSTONE_BRICKS.get())));
    public static final RegistryObject<Block> MOSSY_SANDSTONE_BRICK_STAIRS = registerBlock("mossy_sandstone_brick_stairs", () -> new StairBlock(MOSSY_SANDSTONE_BRICKS.get().defaultBlockState(), BlockBehaviour.Properties.ofFullCopy(MBBlocks.MOSSY_SANDSTONE_BRICKS.get())));
    public static final RegistryObject<Block> MOSSY_SANDSTONE_BRICK_WALL = registerBlock("mossy_sandstone_brick_wall", () -> new WallBlock(BlockBehaviour.Properties.ofFullCopy(MBBlocks.MOSSY_SANDSTONE_BRICKS.get()).forceSolidOn()));
    ...
    public static final RegistryObject<Block> SANDSTONE_TILE_SLAB = registerBlock("sandstone_tile_slab", () -> new SlabBlock(BlockBehaviour.Properties.ofFullCopy(MBBlocks.SANDSTONE_TILES.get())));
    public static final RegistryObject<Block> SANDSTONE_TILE_STAIRS = registerBlock("sandstone_tile_stairs", () -> new StairBlock(SANDSTONE_TILES.get().defaultBlockState(), BlockBehaviour.Properties.ofFullCopy(MBBlocks.SANDSTONE_TILES.get())));
    public static final RegistryObject<Block> SANDSTONE_TILE_WALL = registerBlock("sandstone_tile_wall", () -> new WallBlock(BlockBehaviour.Properties.ofFullCopy(MBBlocks.SANDSTONE_TILES.get()).forceSolidOn()));
    ...
    public static final RegistryObject<Block> POLISHED_ICE_SLAB = registerBlock("polished_ice_slab", () -> new SlabBlock(BlockBehaviour.Properties.ofFullCopy(MBBlocks.POLISHED_ICE.get())));
    public static final RegistryObject<Block> POLISHED_ICE_STAIRS = registerBlock("polished_ice_stairs", () -> new StairBlock(POLISHED_ICE.get().defaultBlockState(), BlockBehaviour.Properties.ofFullCopy(MBBlocks.POLISHED_ICE.get())));
    ...
    public static final RegistryObject<Block> ICE_BRICK_SLAB = registerBlock("ice_brick_slab", () -> new SlabBlock(BlockBehaviour.Properties.ofFullCopy(MBBlocks.ICE_BRICKS.get())));
    public static final RegistryObject<Block> ICE_BRICK_STAIRS = registerBlock("ice_brick_stairs", () -> new StairBlock(ICE_BRICKS.get().defaultBlockState(), BlockBehaviour.Properties.ofFullCopy(MBBlocks.ICE_BRICKS.get())));
    public static final RegistryObject<Block> ICE_BRICK_WALL = registerBlock("ice_brick_wall", () -> new WallBlock(BlockBehaviour.Properties.ofFullCopy(MBBlocks.ICE_BRICKS.get()).forceSolidOn()));
    ...
    public static final RegistryObject<Block> ICE_TILE_SLAB = registerBlock("ice_tile_slab", () -> new SlabBlock(BlockBehaviour.Properties.ofFullCopy(MBBlocks.ICE_TILES.get())));
    public static final RegistryObject<Block> ICE_TILE_STAIRS = registerBlock("ice_tile_stairs", () -> new StairBlock(ICE_TILES.get().defaultBlockState(), BlockBehaviour.Properties.ofFullCopy(MBBlocks.ICE_TILES.get())));
    public static final RegistryObject<Block> ICE_TILE_WALL = registerBlock("ice_tile_wall", () -> new WallBlock(BlockBehaviour.Properties.ofFullCopy(MBBlocks.ICE_TILES.get()).forceSolidOn()));
    ...
    public static final RegistryObject<Block> POLISHED_PURPUR_SLAB = registerBlock("polished_purpur_slab", () -> new SlabBlock(BlockBehaviour.Properties.ofFullCopy(MBBlocks.POLISHED_PURPUR.get())));
    public static final RegistryObject<Block> POLISHED_PURPUR_STAIRS = registerBlock("polished_purpur_stairs", () -> new StairBlock(POLISHED_PURPUR.get().defaultBlockState(), BlockBehaviour.Properties.ofFullCopy(MBBlocks.POLISHED_PURPUR.get())));
    ...
    public static final RegistryObject<Block> PURPUR_TILE_SLAB = registerBlock("purpur_tile_slab", () -> new SlabBlock(BlockBehaviour.Properties.ofFullCopy(MBBlocks.PURPUR_TILES.get())));
    public static final RegistryObject<Block> PURPUR_TILE_STAIRS = registerBlock("purpur_tile_stairs", () -> new StairBlock(PURPUR_TILES.get().defaultBlockState(), BlockBehaviour.Properties.ofFullCopy(MBBlocks.PURPUR_TILES.get())));
    public static final RegistryObject<Block> PURPUR_TILE_WALL = registerBlock("purpur_tile_wall", () -> new WallBlock(BlockBehaviour.Properties.ofFullCopy(MBBlocks.PURPUR_TILES.get()).forceSolidOn()));
    ...
    public static final RegistryObject<Block> SMOOTH_SOUL_SANDSTONE_SLAB = registerBlock("smooth_soul_sandstone_slab", () -> new SlabBlock(BlockBehaviour.Properties.ofFullCopy(MBBlocks.SMOOTH_SOUL_SANDSTONE.get())));
    public static final RegistryObject<Block> SMOOTH_SOUL_SANDSTONE_STAIRS = registerBlock("smooth_soul_sandstone_stairs", () -> new StairBlock(SMOOTH_SOUL_SANDSTONE.get().defaultBlockState(), BlockBehaviour.Properties.ofFullCopy(MBBlocks.SMOOTH_SOUL_SANDSTONE.get())));
    ...
    public static final RegistryObject<Block> SOUL_SANDSTONE_BRICK_SLAB = registerBlock("soul_sandstone_brick_slab", () -> new SlabBlock(BlockBehaviour.Properties.ofFullCopy(MBBlocks.SOUL_SANDSTONE_BRICKS.get())));
    public static final RegistryObject<Block> SOUL_SANDSTONE_BRICK_STAIRS = registerBlock("soul_sandstone_brick_stairs", () -> new StairBlock(SOUL_SANDSTONE_BRICKS.get().defaultBlockState(), BlockBehaviour.Properties.ofFullCopy(MBBlocks.SOUL_SANDSTONE_BRICKS.get())));
    public static final RegistryObject<Block> SOUL_SANDSTONE_BRICK_WALL = registerBlock("soul_sandstone_brick_wall", () -> new WallBlock(BlockBehaviour.Properties.ofFullCopy(MBBlocks.SOUL_SANDSTONE_BRICKS.get()).forceSolidOn()));
    ...
    public static final RegistryObject<Block> SOUL_SANDSTONE_TILE_SLAB = registerBlock("soul_sandstone_tile_slab", () -> new SlabBlock(BlockBehaviour.Properties.ofFullCopy(MBBlocks.SOUL_SANDSTONE_TILES.get())));
    public static final RegistryObject<Block> SOUL_SANDSTONE_TILE_STAIRS = registerBlock("soul_sandstone_tile_stairs", () -> new StairBlock(SOUL_SANDSTONE_TILES.get().defaultBlockState(), BlockBehaviour.Properties.ofFullCopy(MBBlocks.SOUL_SANDSTONE_TILES.get())));
    ...
    public static final RegistryObject<Block> RUBY_BRICKS = registerBlock("ruby_bricks", () -> new Block(BlockBehaviour.Properties.ofFullCopy(Blocks.EMERALD_BLOCK)));
    public static final RegistryObject<Block> CRACKED_RUBY_BRICKS = registerBlock("cracked_ruby_bricks", () -> new Block(BlockBehaviour.Properties.ofFullCopy(Blocks.EMERALD_BLOCK)));
    public static final RegistryObject<Block> CUT_RUBY = registerBlock("cut_ruby", () -> new Block(BlockBehaviour.Properties.ofFullCopy(Blocks.EMERALD_BLOCK)));
    public static final RegistryObject<Block> CRACKED_CUT_RUBY = registerBlock("cracked_cut_ruby", () -> new Block(BlockBehaviour.Properties.ofFullCopy(Blocks.EMERALD_BLOCK)));
    public static final RegistryObject<Block> RUBY_PILLAR = registerBlock("ruby_pillar", () -> new RotatedPillarBlock(BlockBehaviour.Properties.ofFullCopy(Blocks.EMERALD_BLOCK)));
    public static final RegistryObject<Block> LAPIS_LAZULI_BRICKS = registerBlock("lapis_lazuli_bricks", () -> new Block(BlockBehaviour.Properties.ofFullCopy(Blocks.LAPIS_BLOCK)));
    public static final RegistryObject<Block> CRACKED_LAPIS_LAZULI_BRICKS = registerBlock("cracked_lapis_lazuli_bricks", () -> new Block(BlockBehaviour.Properties.ofFullCopy(Blocks.LAPIS_BLOCK)));
    public static final RegistryObject<Block> CUT_LAPIS_LAZULI = registerBlock("cut_lapis_lazuli", () -> new Block(BlockBehaviour.Properties.ofFullCopy(Blocks.LAPIS_BLOCK)));
    public static final RegistryObject<Block> CRACKED_CUT_LAPIS_LAZULI = registerBlock("cracked_cut_lapis_lazuli", () -> new Block(BlockBehaviour.Properties.ofFullCopy(Blocks.LAPIS_BLOCK)));
    public static final RegistryObject<Block> LAPIS_LAZULI_PILLAR = registerBlock("lapis_lazuli_pillar", () -> new RotatedPillarBlock(BlockBehaviour.Properties.ofFullCopy(Blocks.LAPIS_BLOCK)));
    ...
    public static final RegistryObject<Block> SPRUCE_MOSAIC_SLAB = registerBlock("spruce_mosaic_slab", () -> new SlabBlock(BlockBehaviour.Properties.ofFullCopy(MBBlocks.SPRUCE_MOSAIC.get())));
    public static final RegistryObject<Block> SPRUCE_MOSAIC_STAIRS = registerBlock("spruce_mosaic_stairs", () -> new StairBlock(SPRUCE_MOSAIC.get().defaultBlockState(), BlockBehaviour.Properties.ofFullCopy(MBBlocks.SPRUCE_MOSAIC.get())));
    ...
    public static final RegistryObject<Block> BIRCH_MOSAIC_SLAB = registerBlock("birch_mosaic_slab", () -> new SlabBlock(BlockBehaviour.Properties.ofFullCopy(MBBlocks.BIRCH_MOSAIC.get())));
    public static final RegistryObject<Block> BIRCH_MOSAIC_STAIRS = registerBlock("birch_mosaic_stairs", () -> new StairBlock(BIRCH_MOSAIC.get().defaultBlockState(), BlockBehaviour.Properties.ofFullCopy(MBBlocks.BIRCH_MOSAIC.get())));
    ...
    public static final RegistryObject<Block> JUNGLE_MOSAIC_SLAB = registerBlock("jungle_mosaic_slab", () -> new SlabBlock(BlockBehaviour.Properties.ofFullCopy(MBBlocks.JUNGLE_MOSAIC.get())));
    public static final RegistryObject<Block> JUNGLE_MOSAIC_STAIRS = registerBlock("jungle_mosaic_stairs", () -> new StairBlock(JUNGLE_MOSAIC.get().defaultBlockState(), BlockBehaviour.Properties.ofFullCopy(MBBlocks.JUNGLE_MOSAIC.get())));
    ...
    public static final RegistryObject<Block> ACACIA_MOSAIC_SLAB = registerBlock("acacia_mosaic_slab", () -> new SlabBlock(BlockBehaviour.Properties.ofFullCopy(MBBlocks.ACACIA_MOSAIC.get())));
    public static final RegistryObject<Block> ACACIA_MOSAIC_STAIRS = registerBlock("acacia_mosaic_stairs", () -> new StairBlock(ACACIA_MOSAIC.get().defaultBlockState(), BlockBehaviour.Properties.ofFullCopy(MBBlocks.ACACIA_MOSAIC.get())));
    ...
    public static final RegistryObject<Block> DARK_OAK_MOSAIC_SLAB = registerBlock("dark_oak_mosaic_slab", () -> new SlabBlock(BlockBehaviour.Properties.ofFullCopy(MBBlocks.DARK_OAK_MOSAIC.get())));
    public static final RegistryObject<Block> DARK_OAK_MOSAIC_STAIRS = registerBlock("dark_oak_mosaic_stairs", () -> new StairBlock(DARK_OAK_MOSAIC.get().defaultBlockState(), BlockBehaviour.Properties.ofFullCopy(MBBlocks.DARK_OAK_MOSAIC.get())));
    ...
    public static final RegistryObject<Block> MANGROVE_MOSAIC_SLAB = registerBlock("mangrove_mosaic_slab", () -> new SlabBlock(BlockBehaviour.Properties.ofFullCopy(MBBlocks.MANGROVE_MOSAIC.get())));
    public static final RegistryObject<Block> MANGROVE_MOSAIC_STAIRS = registerBlock("mangrove_mosaic_stairs", () -> new StairBlock(MANGROVE_MOSAIC.get().defaultBlockState(), BlockBehaviour.Properties.ofFullCopy(MBBlocks.MANGROVE_MOSAIC.get())));
    ...
    public static final RegistryObject<Block> CRIMSON_MOSAIC_SLAB = registerBlock("crimson_mosaic_slab", () -> new SlabBlock(BlockBehaviour.Properties.ofFullCopy(MBBlocks.CRIMSON_MOSAIC.get())));
    public static final RegistryObject<Block> CRIMSON_MOSAIC_STAIRS = registerBlock("crimson_mosaic_stairs", () -> new StairBlock(CRIMSON_MOSAIC.get().defaultBlockState(), BlockBehaviour.Properties.ofFullCopy(MBBlocks.CRIMSON_MOSAIC.get())));
    ...
    public static final RegistryObject<Block> WARPED_MOSAIC_SLAB = registerBlock("warped_mosaic_slab", () -> new SlabBlock(BlockBehaviour.Properties.ofFullCopy(MBBlocks.WARPED_MOSAIC.get())));
    public static final RegistryObject<Block> WARPED_MOSAIC_STAIRS = registerBlock("warped_mosaic_stairs", () -> new StairBlock(WARPED_MOSAIC.get().defaultBlockState(), BlockBehaviour.Properties.ofFullCopy(MBBlocks.WARPED_MOSAIC.get())));
    ...
    public static final RegistryObject<Block> CHERRY_MOSAIC_SLAB = registerBlock("cherry_mosaic_slab", () -> new SlabBlock(BlockBehaviour.Properties.ofFullCopy(MBBlocks.CHERRY_MOSAIC.get())));
    ...
    public static final RegistryObject<Block> BONE_BLOCK_BRICK_SLAB = registerBlock("bone_block_brick_slab", () -> new SlabBlock(BlockBehaviour.Properties.ofFullCopy(MBBlocks.BONE_BLOCK_BRICKS.get())));
    public static final RegistryObject<Block> BONE_BLOCK_BRICK_STAIRS = registerBlock("bone_block_brick_stairs", () -> new StairBlock(BONE_BLOCK_BRICKS.get().defaultBlockState(), BlockBehaviour.Properties.ofFullCopy(MBBlocks.BONE_BLOCK_BRICKS.get())));
    public static final RegistryObject<Block> BONE_BLOCK_BRICK_WALL = registerBlock("bone_block_brick_wall", () -> new WallBlock(BlockBehaviour.Properties.ofFullCopy(MBBlocks.BONE_BLOCK_BRICKS.get()).forceSolidOn()));
    ...
    public static final RegistryObject<Block> BONE_BLOCK_TILE_SLAB = registerBlock("bone_block_tile_slab", () -> new SlabBlock(BlockBehaviour.Properties.ofFullCopy(MBBlocks.BONE_BLOCK_TILES.get())));
    public static final RegistryObject<Block> BONE_BLOCK_TILE_STAIRS = registerBlock("bone_block_tile_stairs", () -> new StairBlock(BONE_BLOCK_TILES.get().defaultBlockState(), BlockBehaviour.Properties.ofFullCopy(MBBlocks.BONE_BLOCK_TILES.get())));
    public static final RegistryObject<Block> BONE_BLOCK_TILE_WALL = registerBlock("bone_block_tile_wall", () -> new WallBlock(BlockBehaviour.Properties.ofFullCopy(MBBlocks.BONE_BLOCK_TILES.get()).forceSolidOn()));
