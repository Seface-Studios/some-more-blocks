...
public record PatchPaleRoseBushBiomeModifier(HolderSet<Biome> biomes, Holder<PlacedFeature> feature) implements BiomeModifier {
  ...
  public MapCodec<? extends BiomeModifier> codec() {
    return SMBBiomeModifiers.PATCH_PALE_ROSE_BUSH.get();
  }
}
