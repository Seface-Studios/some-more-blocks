...
public class LianaVineBlock extends GrowingPlantHeadBlock {
  public static final MapCodec<LianaVineBlock> CODEC = simpleCodec(LianaVineBlock::new);
  private static final VoxelShape SHAPE = Block.column(14.0F, 0.0F, 16.0F);

  public MapCodec<LianaVineBlock> codec() {
    return CODEC;
  }

  public LianaVineBlock(Properties properties) {
  ...
  protected Block getBodyBlock() {
    return SMBBlocks.LIANA_VINE_PLANT.get();
  }
