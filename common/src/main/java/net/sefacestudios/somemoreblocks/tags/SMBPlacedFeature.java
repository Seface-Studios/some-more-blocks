...
public class SMBPlacedFeature {
  ...
  public static final ResourceKey<@NotNull PlacedFeature> PATCH_CATTAIL_WATER = register("patch_cattail_water");
  public static final ResourceKey<@NotNull PlacedFeature> PATCH_CATTAIL_WATER_SWAMP = register("patch_cattail_water_swamp");
  ...
  public static final ResourceKey<@NotNull PlacedFeature> PATCH_DUCKWEED = register("patch_duckweed");
  public static final ResourceKey<@NotNull PlacedFeature> PATCH_DUCKWEED_LUSH_CAVES = register("patch_duckweed_lush_caves");
  public static final ResourceKey<@NotNull PlacedFeature> PATCH_DUCKWEED_SWAMP = register("patch_duckweed_swamp");
