...
public class SMBBlocks {
  public static final Block AZALEA_LEAF_LITTER = new LeafLitterBlock(FabricBlockSettings.copyOf(Blocks.AZALEA_LEAVES).replaceable().noCollision().instabreak(), Constants.AZALEA_LEAF_LITTER_CHANCE);
  public static final Block BIRCH_LEAF_LITTER = new LeafLitterBlock(FabricBlockSettings.copyOf(Blocks.BIRCH_LEAVES).replaceable().noCollision().instabreak(), Constants.BIRCH_LEAF_LITTER_CHANCE);
  ...
  public static final Block FLOWERING_AZALEA_LEAF_LITTER = new LeafLitterBlock(FabricBlockSettings.copyOf(Blocks.FLOWERING_AZALEA_LEAVES).replaceable().noCollision().instabreak(), Constants.FLOWERING_AZALEA_LEAF_LITTER_CHANCE);
  public static final Block SPRUCE_LEAF_LITTER = new LeafLitterBlock(FabricBlockSettings.copyOf(Blocks.SPRUCE_LEAVES).replaceable().noCollision().instabreak(), Constants.SPRUCE_LEAF_LITTER_CHANCE);
  public static final Block LEAF_LITTER = new LeafLitterBlock(FabricBlockSettings.copyOf(Blocks.OAK_LEAVES).replaceable().noCollision().instabreak(), Constants.LEAF_LITTER_CHANCE);
  ...
  public static final Block DUNE_GRASS = new GenericBonemealableBushBlock(SMBBlocks.TALL_DUNE_GRASS, SMBBlockTags.DUNE_GRASS_PLACEABLE, FabricBlockSettings.copyOf(Blocks.GRASS));
  ...
  public static final Block TUFF_BRICK_SLAB = new SlabBlock(FabricBlockSettings.copyOf(SMBBlocks.TUFF_BRICKS));
  public static final Block TUFF_BRICK_STAIRS = new StairBlock(TUFF_BRICKS.defaultBlockState(), FabricBlockSettings.copyOf(SMBBlocks.TUFF_BRICKS));
  public static final Block TUFF_BRICK_WALL = new WallBlock(FabricBlockSettings.copyOf(SMBBlocks.TUFF_BRICKS));
  public static final Block CHISELED_TUFF_BRICKS = new Block(FabricBlockSettings.copyOf(SMBBlocks.TUFF_BRICKS));
  public static final Block POLISHED_TUFF = new Block(FabricBlockSettings.copyOf(SMBBlocks.TUFF_BRICKS));
  public static final Block POLISHED_TUFF_SLAB = new SlabBlock(FabricBlockSettings.copyOf(SMBBlocks.TUFF_BRICKS));
  public static final Block POLISHED_TUFF_STAIRS = new StairBlock(POLISHED_TUFF.defaultBlockState(), FabricBlockSettings.copyOf(SMBBlocks.TUFF_BRICKS));
  ...
  public static final Block CRACKED_TUFF_BRICKS = new Block(FabricBlockSettings.copyOf(Blocks.TUFF).sound(SoundType.TUFF));
  public static final Block MOSSY_TUFF_BRICKS = new Block(FabricBlockSettings.copyOf(Blocks.TUFF).sound(SoundType.TUFF));
  ...
  public static final Block TUFF_TILES = new Block(FabricBlockSettings.copyOf(Blocks.TUFF).sound(SoundType.TUFF));
  public static final Block TUFF_TILE_SLAB = new SlabBlock(FabricBlockSettings.copyOf(SMBBlocks.TUFF_TILES).sound(SoundType.TUFF));
  public static final Block TUFF_TILE_STAIRS = new StairBlock(TUFF_TILES.defaultBlockState(), FabricBlockSettings.copyOf(SMBBlocks.TUFF_TILES).sound(SoundType.TUFF));
  public static final Block TUFF_TILE_WALL = new WallBlock(FabricBlockSettings.copyOf(SMBBlocks.TUFF_TILES).solid().sound(SoundType.TUFF));
  public static final Block CRACKED_TUFF_TILES = new Block(FabricBlockSettings.copyOf(Blocks.TUFF).sound(SoundType.TUFF));
  public static final Block TUFF_PILLAR = new RotatedPillarBlock(FabricBlockSettings.copyOf(Blocks.TUFF).sound(SoundType.TUFF));
  ...
  public static final Block TILED_GLASS = new HalfTransparentBlock(FabricBlockSettings.copyOf(Blocks.GLASS));
  ...
  public static void register() {
    Registry.register(BuiltInRegistries.BLOCK, new ResourceLocation(SomeMoreBlocks.ID, "copper_bricks"), COPPER_BRICKS);
    Registry.register(BuiltInRegistries.BLOCK, new ResourceLocation(SomeMoreBlocks.ID, "exposed_copper_bricks"), EXPOSED_COPPER_BRICKS);
    Registry.register(BuiltInRegistries.BLOCK, new ResourceLocation(SomeMoreBlocks.ID, "weathered_copper_bricks"), WEATHERED_COPPER_BRICKS);
    Registry.register(BuiltInRegistries.BLOCK, new ResourceLocation(SomeMoreBlocks.ID, "oxidized_copper_bricks"), OXIDIZED_COPPER_BRICKS);
    Registry.register(BuiltInRegistries.BLOCK, new ResourceLocation(SomeMoreBlocks.ID, "waxed_copper_bricks"), WAXED_COPPER_BRICKS);
    Registry.register(BuiltInRegistries.BLOCK, new ResourceLocation(SomeMoreBlocks.ID, "waxed_exposed_copper_bricks"), WAXED_EXPOSED_COPPER_BRICKS);
    Registry.register(BuiltInRegistries.BLOCK, new ResourceLocation(SomeMoreBlocks.ID, "waxed_weathered_copper_bricks"), WAXED_WEATHERED_COPPER_BRICKS);
    Registry.register(BuiltInRegistries.BLOCK, new ResourceLocation(SomeMoreBlocks.ID, "waxed_oxidized_copper_bricks"), WAXED_OXIDIZED_COPPER_BRICKS);
    Registry.register(BuiltInRegistries.BLOCK, new ResourceLocation(SomeMoreBlocks.ID, "cracked_copper_bricks"), CRACKED_COPPER_BRICKS);
    Registry.register(BuiltInRegistries.BLOCK, new ResourceLocation(SomeMoreBlocks.ID, "exposed_cracked_copper_bricks"), EXPOSED_CRACKED_COPPER_BRICKS);
    Registry.register(BuiltInRegistries.BLOCK, new ResourceLocation(SomeMoreBlocks.ID, "weathered_cracked_copper_bricks"), WEATHERED_CRACKED_COPPER_BRICKS);
    Registry.register(BuiltInRegistries.BLOCK, new ResourceLocation(SomeMoreBlocks.ID, "oxidized_cracked_copper_bricks"), OXIDIZED_CRACKED_COPPER_BRICKS);
    Registry.register(BuiltInRegistries.BLOCK, new ResourceLocation(SomeMoreBlocks.ID, "waxed_cracked_copper_bricks"), WAXED_CRACKED_COPPER_BRICKS);
    Registry.register(BuiltInRegistries.BLOCK, new ResourceLocation(SomeMoreBlocks.ID, "waxed_exposed_cracked_copper_bricks"), WAXED_EXPOSED_CRACKED_COPPER_BRICKS);
    Registry.register(BuiltInRegistries.BLOCK, new ResourceLocation(SomeMoreBlocks.ID, "waxed_weathered_cracked_copper_bricks"), WAXED_WEATHERED_CRACKED_COPPER_BRICKS);
    Registry.register(BuiltInRegistries.BLOCK, new ResourceLocation(SomeMoreBlocks.ID, "waxed_oxidized_cracked_copper_bricks"), WAXED_OXIDIZED_CRACKED_COPPER_BRICKS);
    Registry.register(BuiltInRegistries.BLOCK, new ResourceLocation(SomeMoreBlocks.ID, "cracked_cut_copper"), CRACKED_CUT_COPPER);
    Registry.register(BuiltInRegistries.BLOCK, new ResourceLocation(SomeMoreBlocks.ID, "exposed_cracked_cut_copper"), EXPOSED_CRACKED_CUT_COPPER);
    Registry.register(BuiltInRegistries.BLOCK, new ResourceLocation(SomeMoreBlocks.ID, "weathered_cracked_cut_copper"), WEATHERED_CRACKED_CUT_COPPER);
    Registry.register(BuiltInRegistries.BLOCK, new ResourceLocation(SomeMoreBlocks.ID, "oxidized_cracked_cut_copper"), OXIDIZED_CRACKED_CUT_COPPER);
    Registry.register(BuiltInRegistries.BLOCK, new ResourceLocation(SomeMoreBlocks.ID, "waxed_cracked_cut_copper"), WAXED_CRACKED_CUT_COPPER);
    Registry.register(BuiltInRegistries.BLOCK, new ResourceLocation(SomeMoreBlocks.ID, "waxed_exposed_cracked_cut_copper"), WAXED_EXPOSED_CRACKED_CUT_COPPER);
    Registry.register(BuiltInRegistries.BLOCK, new ResourceLocation(SomeMoreBlocks.ID, "waxed_weathered_cracked_cut_copper"), WAXED_WEATHERED_CRACKED_CUT_COPPER);
    Registry.register(BuiltInRegistries.BLOCK, new ResourceLocation(SomeMoreBlocks.ID, "waxed_oxidized_cracked_cut_copper"), WAXED_OXIDIZED_CRACKED_CUT_COPPER);
    Registry.register(BuiltInRegistries.BLOCK, new ResourceLocation(SomeMoreBlocks.ID, "copper_pillar"), COPPER_PILLAR);
    Registry.register(BuiltInRegistries.BLOCK, new ResourceLocation(SomeMoreBlocks.ID, "exposed_copper_pillar"), EXPOSED_COPPER_PILLAR);
    Registry.register(BuiltInRegistries.BLOCK, new ResourceLocation(SomeMoreBlocks.ID, "weathered_copper_pillar"), WEATHERED_COPPER_PILLAR);
    Registry.register(BuiltInRegistries.BLOCK, new ResourceLocation(SomeMoreBlocks.ID, "oxidized_copper_pillar"), OXIDIZED_COPPER_PILLAR);
    Registry.register(BuiltInRegistries.BLOCK, new ResourceLocation(SomeMoreBlocks.ID, "waxed_copper_pillar"), WAXED_COPPER_PILLAR);
    ...
    Registry.register(BuiltInRegistries.BLOCK, new ResourceLocation(SomeMoreBlocks.ID, "tall_dune_grass"), TALL_DUNE_GRASS);
    Registry.register(BuiltInRegistries.BLOCK, new ResourceLocation(SomeMoreBlocks.ID, "short_snow_grass"), SHORT_SNOW_GRASS);
    Registry.register(BuiltInRegistries.BLOCK, new ResourceLocation(SomeMoreBlocks.ID, "tall_snow_grass"), TALL_SNOW_GRASS);
    Registry.register(BuiltInRegistries.BLOCK, new ResourceLocation(SomeMoreBlocks.ID, "snow_fern"), SNOW_FERN);
    Registry.register(BuiltInRegistries.BLOCK, new ResourceLocation(SomeMoreBlocks.ID, "potted_snow_fern"), POTTED_SNOW_FERN);
    Registry.register(BuiltInRegistries.BLOCK, new ResourceLocation(SomeMoreBlocks.ID, "large_snow_fern"), LARGE_SNOW_FERN);
    Registry.register(BuiltInRegistries.BLOCK, new ResourceLocation(SomeMoreBlocks.ID, "cattail"), CATTAIL);
    Registry.register(BuiltInRegistries.BLOCK, new ResourceLocation(SomeMoreBlocks.ID, "small_lily_pads"), SMALL_LILY_PADS);
    Registry.register(BuiltInRegistries.BLOCK, new ResourceLocation(SomeMoreBlocks.ID, "luminous_flower"), LUMINOUS_FLOWER);
    Registry.register(BuiltInRegistries.BLOCK, new ResourceLocation(SomeMoreBlocks.ID, "potted_luminous_flower"), POTTED_LUMINOUS_FLOWER);
    Registry.register(BuiltInRegistries.BLOCK, new ResourceLocation(SomeMoreBlocks.ID, "big_lily_pad"), BIG_LILY_PAD);
    Registry.register(BuiltInRegistries.BLOCK, new ResourceLocation(SomeMoreBlocks.ID, "azalea_leaf_litter"), AZALEA_LEAF_LITTER);
    Registry.register(BuiltInRegistries.BLOCK, new ResourceLocation(SomeMoreBlocks.ID, "birch_leaf_litter"), BIRCH_LEAF_LITTER);
    Registry.register(BuiltInRegistries.BLOCK, new ResourceLocation(SomeMoreBlocks.ID, "flowering_azalea_leaf_litter"), FLOWERING_AZALEA_LEAF_LITTER);
    Registry.register(BuiltInRegistries.BLOCK, new ResourceLocation(SomeMoreBlocks.ID, "spruce_leaf_litter"), SPRUCE_LEAF_LITTER);
    Registry.register(BuiltInRegistries.BLOCK, new ResourceLocation(SomeMoreBlocks.ID, "leaf_litter"), LEAF_LITTER);
    Registry.register(BuiltInRegistries.BLOCK, new ResourceLocation(SomeMoreBlocks.ID, "brown_mushroom_colony"), BROWN_MUSHROOM_COLONY);
    Registry.register(BuiltInRegistries.BLOCK, new ResourceLocation(SomeMoreBlocks.ID, "tall_brown_mushroom_colony"), TALL_BROWN_MUSHROOM_COLONY);
    Registry.register(BuiltInRegistries.BLOCK, new ResourceLocation(SomeMoreBlocks.ID, "brown_mushroom_colony_wall"), BROWN_MUSHROOM_COLONY_WALL);
    Registry.register(BuiltInRegistries.BLOCK, new ResourceLocation(SomeMoreBlocks.ID, "red_mushroom_colony"), RED_MUSHROOM_COLONY);
    Registry.register(BuiltInRegistries.BLOCK, new ResourceLocation(SomeMoreBlocks.ID, "tall_red_mushroom_colony"), TALL_RED_MUSHROOM_COLONY);
    Registry.register(BuiltInRegistries.BLOCK, new ResourceLocation(SomeMoreBlocks.ID, "red_mushroom_colony_wall"), RED_MUSHROOM_COLONY_WALL);
    Registry.register(BuiltInRegistries.BLOCK, new ResourceLocation(SomeMoreBlocks.ID, "warped_fungus_colony"), WARPED_FUNGUS_COLONY);
    Registry.register(BuiltInRegistries.BLOCK, new ResourceLocation(SomeMoreBlocks.ID, "tall_warped_fungus_colony"), TALL_WARPED_FUNGUS_COLONY);
    Registry.register(BuiltInRegistries.BLOCK, new ResourceLocation(SomeMoreBlocks.ID, "warped_fungus_colony_wall"), WARPED_FUNGUS_COLONY_WALL);
    Registry.register(BuiltInRegistries.BLOCK, new ResourceLocation(SomeMoreBlocks.ID, "crimson_fungus_colony"), CRIMSON_FUNGUS_COLONY);
    Registry.register(BuiltInRegistries.BLOCK, new ResourceLocation(SomeMoreBlocks.ID, "tall_crimson_fungus_colony"), TALL_CRIMSON_FUNGUS_COLONY);
    Registry.register(BuiltInRegistries.BLOCK, new ResourceLocation(SomeMoreBlocks.ID, "crimson_fungus_colony_wall"), CRIMSON_FUNGUS_COLONY_WALL);
    ...
    Registry.register(BuiltInRegistries.BLOCK, new ResourceLocation(SomeMoreBlocks.ID, "polished_snow"), POLISHED_SNOW);
    Registry.register(BuiltInRegistries.BLOCK, new ResourceLocation(SomeMoreBlocks.ID, "polished_snow_slab"), POLISHED_SNOW_SLAB);
    Registry.register(BuiltInRegistries.BLOCK, new ResourceLocation(SomeMoreBlocks.ID, "polished_snow_stairs"), POLISHED_SNOW_STAIRS);
    Registry.register(BuiltInRegistries.BLOCK, new ResourceLocation(SomeMoreBlocks.ID, "snow_bricks"), SNOW_BRICKS);
    Registry.register(BuiltInRegistries.BLOCK, new ResourceLocation(SomeMoreBlocks.ID, "snow_brick_slab"), SNOW_BRICK_SLAB);
    Registry.register(BuiltInRegistries.BLOCK, new ResourceLocation(SomeMoreBlocks.ID, "snow_brick_stairs"), SNOW_BRICK_STAIRS);
    Registry.register(BuiltInRegistries.BLOCK, new ResourceLocation(SomeMoreBlocks.ID, "snow_brick_wall"), SNOW_BRICK_WALL);
    Registry.register(BuiltInRegistries.BLOCK, new ResourceLocation(SomeMoreBlocks.ID, "cracked_snow_bricks"), CRACKED_SNOW_BRICKS);
    Registry.register(BuiltInRegistries.BLOCK, new ResourceLocation(SomeMoreBlocks.ID, "snow_tiles"), SNOW_TILES);
    Registry.register(BuiltInRegistries.BLOCK, new ResourceLocation(SomeMoreBlocks.ID, "snow_tile_slab"), SNOW_TILE_SLAB);
    Registry.register(BuiltInRegistries.BLOCK, new ResourceLocation(SomeMoreBlocks.ID, "snow_tile_stairs"), SNOW_TILE_STAIRS);
    Registry.register(BuiltInRegistries.BLOCK, new ResourceLocation(SomeMoreBlocks.ID, "snow_tile_wall"), SNOW_TILE_WALL);
    Registry.register(BuiltInRegistries.BLOCK, new ResourceLocation(SomeMoreBlocks.ID, "cracked_snow_tiles"), CRACKED_SNOW_TILES);
    Registry.register(BuiltInRegistries.BLOCK, new ResourceLocation(SomeMoreBlocks.ID, "snow_pillar"), SNOW_PILLAR);
    Registry.register(BuiltInRegistries.BLOCK, new ResourceLocation(SomeMoreBlocks.ID, "smooth_deepslate"), SMOOTH_DEEPSLATE);
    Registry.register(BuiltInRegistries.BLOCK, new ResourceLocation(SomeMoreBlocks.ID, "smooth_deepslate_slab"), SMOOTH_DEEPSLATE_SLAB);
    Registry.register(BuiltInRegistries.BLOCK, new ResourceLocation(SomeMoreBlocks.ID, "mossy_deepslate_bricks"), MOSSY_DEEPSLATE_BRICKS);
    Registry.register(BuiltInRegistries.BLOCK, new ResourceLocation(SomeMoreBlocks.ID, "mossy_deepslate_brick_slab"), MOSSY_DEEPSLATE_BRICK_SLAB);
    Registry.register(BuiltInRegistries.BLOCK, new ResourceLocation(SomeMoreBlocks.ID, "mossy_deepslate_brick_stairs"), MOSSY_DEEPSLATE_BRICK_STAIRS);
    Registry.register(BuiltInRegistries.BLOCK, new ResourceLocation(SomeMoreBlocks.ID, "mossy_deepslate_brick_wall"), MOSSY_DEEPSLATE_BRICK_WALL);
    Registry.register(BuiltInRegistries.BLOCK, new ResourceLocation(SomeMoreBlocks.ID, "deepslate_pillar"), DEEPSLATE_PILLAR);
    Registry.register(BuiltInRegistries.BLOCK, new ResourceLocation(SomeMoreBlocks.ID, "polished_stone"), POLISHED_STONE);
    Registry.register(BuiltInRegistries.BLOCK, new ResourceLocation(SomeMoreBlocks.ID, "polished_stone_slab"), POLISHED_STONE_SLAB);
    Registry.register(BuiltInRegistries.BLOCK, new ResourceLocation(SomeMoreBlocks.ID, "polished_stone_stairs"), POLISHED_STONE_STAIRS);
    Registry.register(BuiltInRegistries.BLOCK, new ResourceLocation(SomeMoreBlocks.ID, "stone_tiles"), STONE_TILES);
    Registry.register(BuiltInRegistries.BLOCK, new ResourceLocation(SomeMoreBlocks.ID, "stone_tile_slab"), STONE_TILE_SLAB);
    Registry.register(BuiltInRegistries.BLOCK, new ResourceLocation(SomeMoreBlocks.ID, "stone_tile_stairs"), STONE_TILE_STAIRS);
    Registry.register(BuiltInRegistries.BLOCK, new ResourceLocation(SomeMoreBlocks.ID, "stone_tile_wall"), STONE_TILE_WALL);
    Registry.register(BuiltInRegistries.BLOCK, new ResourceLocation(SomeMoreBlocks.ID, "cracked_stone_tiles"), CRACKED_STONE_TILES);
    Registry.register(BuiltInRegistries.BLOCK, new ResourceLocation(SomeMoreBlocks.ID, "stone_pillar"), STONE_PILLAR);
    Registry.register(BuiltInRegistries.BLOCK, new ResourceLocation(SomeMoreBlocks.ID, "smooth_granite"), SMOOTH_GRANITE);
    Registry.register(BuiltInRegistries.BLOCK, new ResourceLocation(SomeMoreBlocks.ID, "smooth_granite_slab"), SMOOTH_GRANITE_SLAB);
    Registry.register(BuiltInRegistries.BLOCK, new ResourceLocation(SomeMoreBlocks.ID, "chiseled_granite_bricks"), CHISELED_GRANITE_BRICKS);
    Registry.register(BuiltInRegistries.BLOCK, new ResourceLocation(SomeMoreBlocks.ID, "granite_bricks"), GRANITE_BRICKS);
    Registry.register(BuiltInRegistries.BLOCK, new ResourceLocation(SomeMoreBlocks.ID, "granite_brick_slab"), GRANITE_BRICK_SLAB);
    Registry.register(BuiltInRegistries.BLOCK, new ResourceLocation(SomeMoreBlocks.ID, "granite_brick_stairs"), GRANITE_BRICK_STAIRS);
    Registry.register(BuiltInRegistries.BLOCK, new ResourceLocation(SomeMoreBlocks.ID, "granite_brick_wall"), GRANITE_BRICK_WALL);
    Registry.register(BuiltInRegistries.BLOCK, new ResourceLocation(SomeMoreBlocks.ID, "cracked_granite_bricks"), CRACKED_GRANITE_BRICKS);
    Registry.register(BuiltInRegistries.BLOCK, new ResourceLocation(SomeMoreBlocks.ID, "mossy_granite_bricks"), MOSSY_GRANITE_BRICKS);
    Registry.register(BuiltInRegistries.BLOCK, new ResourceLocation(SomeMoreBlocks.ID, "mossy_granite_brick_slab"), MOSSY_GRANITE_BRICK_SLAB);
    Registry.register(BuiltInRegistries.BLOCK, new ResourceLocation(SomeMoreBlocks.ID, "mossy_granite_brick_stairs"), MOSSY_GRANITE_BRICK_STAIRS);
    Registry.register(BuiltInRegistries.BLOCK, new ResourceLocation(SomeMoreBlocks.ID, "mossy_granite_brick_wall"), MOSSY_GRANITE_BRICK_WALL);
    Registry.register(BuiltInRegistries.BLOCK, new ResourceLocation(SomeMoreBlocks.ID, "granite_tiles"), GRANITE_TILES);
    Registry.register(BuiltInRegistries.BLOCK, new ResourceLocation(SomeMoreBlocks.ID, "granite_tile_slab"), GRANITE_TILE_SLAB);
    Registry.register(BuiltInRegistries.BLOCK, new ResourceLocation(SomeMoreBlocks.ID, "granite_tile_stairs"), GRANITE_TILE_STAIRS);
    Registry.register(BuiltInRegistries.BLOCK, new ResourceLocation(SomeMoreBlocks.ID, "granite_tile_wall"), GRANITE_TILE_WALL);
    Registry.register(BuiltInRegistries.BLOCK, new ResourceLocation(SomeMoreBlocks.ID, "cracked_granite_tiles"), CRACKED_GRANITE_TILES);
    Registry.register(BuiltInRegistries.BLOCK, new ResourceLocation(SomeMoreBlocks.ID, "granite_pillar"), GRANITE_PILLAR);
    Registry.register(BuiltInRegistries.BLOCK, new ResourceLocation(SomeMoreBlocks.ID, "smooth_diorite"), SMOOTH_DIORITE);
    Registry.register(BuiltInRegistries.BLOCK, new ResourceLocation(SomeMoreBlocks.ID, "smooth_diorite_slab"), SMOOTH_DIORITE_SLAB);
    Registry.register(BuiltInRegistries.BLOCK, new ResourceLocation(SomeMoreBlocks.ID, "chiseled_diorite_bricks"), CHISELED_DIORITE_BRICKS);
    Registry.register(BuiltInRegistries.BLOCK, new ResourceLocation(SomeMoreBlocks.ID, "diorite_bricks"), DIORITE_BRICKS);
    Registry.register(BuiltInRegistries.BLOCK, new ResourceLocation(SomeMoreBlocks.ID, "diorite_brick_slab"), DIORITE_BRICK_SLAB);
    Registry.register(BuiltInRegistries.BLOCK, new ResourceLocation(SomeMoreBlocks.ID, "diorite_brick_stairs"), DIORITE_BRICK_STAIRS);
    Registry.register(BuiltInRegistries.BLOCK, new ResourceLocation(SomeMoreBlocks.ID, "diorite_brick_wall"), DIORITE_BRICK_WALL);
    Registry.register(BuiltInRegistries.BLOCK, new ResourceLocation(SomeMoreBlocks.ID, "cracked_diorite_bricks"), CRACKED_DIORITE_BRICKS);
    Registry.register(BuiltInRegistries.BLOCK, new ResourceLocation(SomeMoreBlocks.ID, "mossy_diorite_bricks"), MOSSY_DIORITE_BRICKS);
    Registry.register(BuiltInRegistries.BLOCK, new ResourceLocation(SomeMoreBlocks.ID, "mossy_diorite_brick_slab"), MOSSY_DIORITE_BRICK_SLAB);
    Registry.register(BuiltInRegistries.BLOCK, new ResourceLocation(SomeMoreBlocks.ID, "mossy_diorite_brick_stairs"), MOSSY_DIORITE_BRICK_STAIRS);
    Registry.register(BuiltInRegistries.BLOCK, new ResourceLocation(SomeMoreBlocks.ID, "mossy_diorite_brick_wall"), MOSSY_DIORITE_BRICK_WALL);
    Registry.register(BuiltInRegistries.BLOCK, new ResourceLocation(SomeMoreBlocks.ID, "diorite_tiles"), DIORITE_TILES);
    Registry.register(BuiltInRegistries.BLOCK, new ResourceLocation(SomeMoreBlocks.ID, "diorite_tile_slab"), DIORITE_TILE_SLAB);
    Registry.register(BuiltInRegistries.BLOCK, new ResourceLocation(SomeMoreBlocks.ID, "diorite_tile_stairs"), DIORITE_TILE_STAIRS);
    Registry.register(BuiltInRegistries.BLOCK, new ResourceLocation(SomeMoreBlocks.ID, "diorite_tile_wall"), DIORITE_TILE_WALL);
    Registry.register(BuiltInRegistries.BLOCK, new ResourceLocation(SomeMoreBlocks.ID, "cracked_diorite_tiles"), CRACKED_DIORITE_TILES);
    Registry.register(BuiltInRegistries.BLOCK, new ResourceLocation(SomeMoreBlocks.ID, "diorite_pillar"), DIORITE_PILLAR);
    Registry.register(BuiltInRegistries.BLOCK, new ResourceLocation(SomeMoreBlocks.ID, "smooth_andesite"), SMOOTH_ANDESITE);
    Registry.register(BuiltInRegistries.BLOCK, new ResourceLocation(SomeMoreBlocks.ID, "smooth_andesite_slab"), SMOOTH_ANDESITE_SLAB);
    Registry.register(BuiltInRegistries.BLOCK, new ResourceLocation(SomeMoreBlocks.ID, "chiseled_andesite_bricks"), CHISELED_ANDESITE_BRICKS);
    Registry.register(BuiltInRegistries.BLOCK, new ResourceLocation(SomeMoreBlocks.ID, "andesite_bricks"), ANDESITE_BRICKS);
    Registry.register(BuiltInRegistries.BLOCK, new ResourceLocation(SomeMoreBlocks.ID, "andesite_brick_slab"), ANDESITE_BRICK_SLAB);
    Registry.register(BuiltInRegistries.BLOCK, new ResourceLocation(SomeMoreBlocks.ID, "andesite_brick_stairs"), ANDESITE_BRICK_STAIRS);
    Registry.register(BuiltInRegistries.BLOCK, new ResourceLocation(SomeMoreBlocks.ID, "andesite_brick_wall"), ANDESITE_BRICK_WALL);
    Registry.register(BuiltInRegistries.BLOCK, new ResourceLocation(SomeMoreBlocks.ID, "cracked_andesite_bricks"), CRACKED_ANDESITE_BRICKS);
    Registry.register(BuiltInRegistries.BLOCK, new ResourceLocation(SomeMoreBlocks.ID, "mossy_andesite_bricks"), MOSSY_ANDESITE_BRICKS);
    Registry.register(BuiltInRegistries.BLOCK, new ResourceLocation(SomeMoreBlocks.ID, "mossy_andesite_brick_slab"), MOSSY_ANDESITE_BRICK_SLAB);
    Registry.register(BuiltInRegistries.BLOCK, new ResourceLocation(SomeMoreBlocks.ID, "mossy_andesite_brick_stairs"), MOSSY_ANDESITE_BRICK_STAIRS);
    Registry.register(BuiltInRegistries.BLOCK, new ResourceLocation(SomeMoreBlocks.ID, "mossy_andesite_brick_wall"), MOSSY_ANDESITE_BRICK_WALL);
    Registry.register(BuiltInRegistries.BLOCK, new ResourceLocation(SomeMoreBlocks.ID, "andesite_tiles"), ANDESITE_TILES);
    Registry.register(BuiltInRegistries.BLOCK, new ResourceLocation(SomeMoreBlocks.ID, "andesite_tile_slab"), ANDESITE_TILE_SLAB);
    Registry.register(BuiltInRegistries.BLOCK, new ResourceLocation(SomeMoreBlocks.ID, "andesite_tile_stairs"), ANDESITE_TILE_STAIRS);
    Registry.register(BuiltInRegistries.BLOCK, new ResourceLocation(SomeMoreBlocks.ID, "andesite_tile_wall"), ANDESITE_TILE_WALL);
    Registry.register(BuiltInRegistries.BLOCK, new ResourceLocation(SomeMoreBlocks.ID, "cracked_andesite_tiles"), CRACKED_ANDESITE_TILES);
    Registry.register(BuiltInRegistries.BLOCK, new ResourceLocation(SomeMoreBlocks.ID, "andesite_pillar"), ANDESITE_PILLAR);
    Registry.register(BuiltInRegistries.BLOCK, new ResourceLocation(SomeMoreBlocks.ID, "polished_end_stone"), POLISHED_END_STONE);
    Registry.register(BuiltInRegistries.BLOCK, new ResourceLocation(SomeMoreBlocks.ID, "polished_end_stone_slab"), POLISHED_END_STONE_SLAB);
    Registry.register(BuiltInRegistries.BLOCK, new ResourceLocation(SomeMoreBlocks.ID, "polished_end_stone_stairs"), POLISHED_END_STONE_STAIRS);
    Registry.register(BuiltInRegistries.BLOCK, new ResourceLocation(SomeMoreBlocks.ID, "smooth_end_stone"), SMOOTH_END_STONE);
    Registry.register(BuiltInRegistries.BLOCK, new ResourceLocation(SomeMoreBlocks.ID, "smooth_end_stone_slab"), SMOOTH_END_STONE_SLAB);
    Registry.register(BuiltInRegistries.BLOCK, new ResourceLocation(SomeMoreBlocks.ID, "chiseled_end_stone_bricks"), CHISELED_END_STONE_BRICKS);
    Registry.register(BuiltInRegistries.BLOCK, new ResourceLocation(SomeMoreBlocks.ID, "cracked_end_stone_bricks"), CRACKED_END_STONE_BRICKS);
    Registry.register(BuiltInRegistries.BLOCK, new ResourceLocation(SomeMoreBlocks.ID, "mossy_end_stone_bricks"), MOSSY_END_STONE_BRICKS);
    Registry.register(BuiltInRegistries.BLOCK, new ResourceLocation(SomeMoreBlocks.ID, "mossy_end_stone_brick_slab"), MOSSY_END_STONE_BRICK_SLAB);
    Registry.register(BuiltInRegistries.BLOCK, new ResourceLocation(SomeMoreBlocks.ID, "mossy_end_stone_brick_stairs"), MOSSY_END_STONE_BRICK_STAIRS);
    Registry.register(BuiltInRegistries.BLOCK, new ResourceLocation(SomeMoreBlocks.ID, "mossy_end_stone_brick_wall"), MOSSY_END_STONE_BRICK_WALL);
    Registry.register(BuiltInRegistries.BLOCK, new ResourceLocation(SomeMoreBlocks.ID, "end_stone_tiles"), END_STONE_TILES);
    Registry.register(BuiltInRegistries.BLOCK, new ResourceLocation(SomeMoreBlocks.ID, "end_stone_tile_slab"), END_STONE_TILE_SLAB);
    Registry.register(BuiltInRegistries.BLOCK, new ResourceLocation(SomeMoreBlocks.ID, "end_stone_tile_stairs"), END_STONE_TILE_STAIRS);
    Registry.register(BuiltInRegistries.BLOCK, new ResourceLocation(SomeMoreBlocks.ID, "end_stone_tile_wall"), END_STONE_TILE_WALL);
    Registry.register(BuiltInRegistries.BLOCK, new ResourceLocation(SomeMoreBlocks.ID, "cracked_end_stone_tiles"), CRACKED_END_STONE_TILES);
    Registry.register(BuiltInRegistries.BLOCK, new ResourceLocation(SomeMoreBlocks.ID, "end_stone_pillar"), END_STONE_PILLAR);
    Registry.register(BuiltInRegistries.BLOCK, new ResourceLocation(SomeMoreBlocks.ID, "tuff_bricks"), TUFF_BRICKS);
    Registry.register(BuiltInRegistries.BLOCK, new ResourceLocation(SomeMoreBlocks.ID, "tuff_brick_slab"), TUFF_BRICK_SLAB);
    Registry.register(BuiltInRegistries.BLOCK, new ResourceLocation(SomeMoreBlocks.ID, "tuff_brick_stairs"), TUFF_BRICK_STAIRS);
    Registry.register(BuiltInRegistries.BLOCK, new ResourceLocation(SomeMoreBlocks.ID, "tuff_brick_wall"), TUFF_BRICK_WALL);
    Registry.register(BuiltInRegistries.BLOCK, new ResourceLocation(SomeMoreBlocks.ID, "chiseled_tuff_bricks"), CHISELED_TUFF_BRICKS);
    Registry.register(BuiltInRegistries.BLOCK, new ResourceLocation(SomeMoreBlocks.ID, "polished_tuff"), POLISHED_TUFF);
    Registry.register(BuiltInRegistries.BLOCK, new ResourceLocation(SomeMoreBlocks.ID, "polished_tuff_slab"), POLISHED_TUFF_SLAB);
    Registry.register(BuiltInRegistries.BLOCK, new ResourceLocation(SomeMoreBlocks.ID, "polished_tuff_stairs"), POLISHED_TUFF_STAIRS);
    Registry.register(BuiltInRegistries.BLOCK, new ResourceLocation(SomeMoreBlocks.ID, "mossy_tuff_bricks"), MOSSY_TUFF_BRICKS);
    Registry.register(BuiltInRegistries.BLOCK, new ResourceLocation(SomeMoreBlocks.ID, "mossy_tuff_brick_slab"), MOSSY_TUFF_BRICK_SLAB);
    Registry.register(BuiltInRegistries.BLOCK, new ResourceLocation(SomeMoreBlocks.ID, "mossy_tuff_brick_stairs"), MOSSY_TUFF_BRICK_STAIRS);
    Registry.register(BuiltInRegistries.BLOCK, new ResourceLocation(SomeMoreBlocks.ID, "mossy_tuff_brick_wall"), MOSSY_TUFF_BRICK_WALL);
    Registry.register(BuiltInRegistries.BLOCK, new ResourceLocation(SomeMoreBlocks.ID, "smooth_tuff"), SMOOTH_TUFF);
    Registry.register(BuiltInRegistries.BLOCK, new ResourceLocation(SomeMoreBlocks.ID, "smooth_tuff_slab"), SMOOTH_TUFF_SLAB);
    Registry.register(BuiltInRegistries.BLOCK, new ResourceLocation(SomeMoreBlocks.ID, "cracked_tuff_bricks"), CRACKED_TUFF_BRICKS);
    Registry.register(BuiltInRegistries.BLOCK, new ResourceLocation(SomeMoreBlocks.ID, "tuff_tiles"), TUFF_TILES);
    Registry.register(BuiltInRegistries.BLOCK, new ResourceLocation(SomeMoreBlocks.ID, "tuff_tile_slab"), TUFF_TILE_SLAB);
    Registry.register(BuiltInRegistries.BLOCK, new ResourceLocation(SomeMoreBlocks.ID, "tuff_tile_stairs"), TUFF_TILE_STAIRS);
    Registry.register(BuiltInRegistries.BLOCK, new ResourceLocation(SomeMoreBlocks.ID, "tuff_tile_wall"), TUFF_TILE_WALL);
    Registry.register(BuiltInRegistries.BLOCK, new ResourceLocation(SomeMoreBlocks.ID, "cracked_tuff_tiles"), CRACKED_TUFF_TILES);
    Registry.register(BuiltInRegistries.BLOCK, new ResourceLocation(SomeMoreBlocks.ID, "tuff_pillar"), TUFF_PILLAR);
    Registry.register(BuiltInRegistries.BLOCK, new ResourceLocation(SomeMoreBlocks.ID, "red_sandstone_bricks"), RED_SANDSTONE_BRICKS);
    Registry.register(BuiltInRegistries.BLOCK, new ResourceLocation(SomeMoreBlocks.ID, "red_sandstone_brick_slab"), RED_SANDSTONE_BRICK_SLAB);
    Registry.register(BuiltInRegistries.BLOCK, new ResourceLocation(SomeMoreBlocks.ID, "red_sandstone_brick_stairs"), RED_SANDSTONE_BRICK_STAIRS);
    Registry.register(BuiltInRegistries.BLOCK, new ResourceLocation(SomeMoreBlocks.ID, "red_sandstone_brick_wall"), RED_SANDSTONE_BRICK_WALL);
    Registry.register(BuiltInRegistries.BLOCK, new ResourceLocation(SomeMoreBlocks.ID, "cracked_red_sandstone_bricks"), CRACKED_RED_SANDSTONE_BRICKS);
    Registry.register(BuiltInRegistries.BLOCK, new ResourceLocation(SomeMoreBlocks.ID, "mossy_red_sandstone_bricks"), MOSSY_RED_SANDSTONE_BRICKS);
    Registry.register(BuiltInRegistries.BLOCK, new ResourceLocation(SomeMoreBlocks.ID, "mossy_red_sandstone_brick_slab"), MOSSY_RED_SANDSTONE_BRICK_SLAB);
    Registry.register(BuiltInRegistries.BLOCK, new ResourceLocation(SomeMoreBlocks.ID, "mossy_red_sandstone_brick_stairs"), MOSSY_RED_SANDSTONE_BRICK_STAIRS);
    Registry.register(BuiltInRegistries.BLOCK, new ResourceLocation(SomeMoreBlocks.ID, "mossy_red_sandstone_brick_wall"), MOSSY_RED_SANDSTONE_BRICK_WALL);
    Registry.register(BuiltInRegistries.BLOCK, new ResourceLocation(SomeMoreBlocks.ID, "red_sandstone_tiles"), RED_SANDSTONE_TILES);
    Registry.register(BuiltInRegistries.BLOCK, new ResourceLocation(SomeMoreBlocks.ID, "red_sandstone_tile_slab"), RED_SANDSTONE_TILE_SLAB);
    Registry.register(BuiltInRegistries.BLOCK, new ResourceLocation(SomeMoreBlocks.ID, "red_sandstone_tile_stairs"), RED_SANDSTONE_TILE_STAIRS);
    Registry.register(BuiltInRegistries.BLOCK, new ResourceLocation(SomeMoreBlocks.ID, "red_sandstone_tile_wall"), RED_SANDSTONE_TILE_WALL);
    Registry.register(BuiltInRegistries.BLOCK, new ResourceLocation(SomeMoreBlocks.ID, "cracked_red_sandstone_tiles"), CRACKED_RED_SANDSTONE_TILES);
    Registry.register(BuiltInRegistries.BLOCK, new ResourceLocation(SomeMoreBlocks.ID, "red_sandstone_pillar"), RED_SANDSTONE_PILLAR);
    Registry.register(BuiltInRegistries.BLOCK, new ResourceLocation(SomeMoreBlocks.ID, "polished_calcite"), POLISHED_CALCITE);
    Registry.register(BuiltInRegistries.BLOCK, new ResourceLocation(SomeMoreBlocks.ID, "polished_calcite_slab"), POLISHED_CALCITE_SLAB);
    Registry.register(BuiltInRegistries.BLOCK, new ResourceLocation(SomeMoreBlocks.ID, "polished_calcite_stairs"), POLISHED_CALCITE_STAIRS);
    Registry.register(BuiltInRegistries.BLOCK, new ResourceLocation(SomeMoreBlocks.ID, "smooth_calcite"), SMOOTH_CALCITE);
    Registry.register(BuiltInRegistries.BLOCK, new ResourceLocation(SomeMoreBlocks.ID, "smooth_calcite_slab"), SMOOTH_CALCITE_SLAB);
    Registry.register(BuiltInRegistries.BLOCK, new ResourceLocation(SomeMoreBlocks.ID, "chiseled_calcite_bricks"), CHISELED_CALCITE_BRICKS);
    Registry.register(BuiltInRegistries.BLOCK, new ResourceLocation(SomeMoreBlocks.ID, "calcite_bricks"), CALCITE_BRICKS);
    Registry.register(BuiltInRegistries.BLOCK, new ResourceLocation(SomeMoreBlocks.ID, "calcite_brick_slab"), CALCITE_BRICK_SLAB);
    Registry.register(BuiltInRegistries.BLOCK, new ResourceLocation(SomeMoreBlocks.ID, "calcite_brick_stairs"), CALCITE_BRICK_STAIRS);
    Registry.register(BuiltInRegistries.BLOCK, new ResourceLocation(SomeMoreBlocks.ID, "calcite_brick_wall"), CALCITE_BRICK_WALL);
    Registry.register(BuiltInRegistries.BLOCK, new ResourceLocation(SomeMoreBlocks.ID, "cracked_calcite_bricks"), CRACKED_CALCITE_BRICKS);
    Registry.register(BuiltInRegistries.BLOCK, new ResourceLocation(SomeMoreBlocks.ID, "mossy_calcite_bricks"), MOSSY_CALCITE_BRICKS);
    Registry.register(BuiltInRegistries.BLOCK, new ResourceLocation(SomeMoreBlocks.ID, "mossy_calcite_brick_slab"), MOSSY_CALCITE_BRICK_SLAB);
    Registry.register(BuiltInRegistries.BLOCK, new ResourceLocation(SomeMoreBlocks.ID, "mossy_calcite_brick_stairs"), MOSSY_CALCITE_BRICK_STAIRS);
    Registry.register(BuiltInRegistries.BLOCK, new ResourceLocation(SomeMoreBlocks.ID, "mossy_calcite_brick_wall"), MOSSY_CALCITE_BRICK_WALL);
    Registry.register(BuiltInRegistries.BLOCK, new ResourceLocation(SomeMoreBlocks.ID, "calcite_tiles"), CALCITE_TILES);
    Registry.register(BuiltInRegistries.BLOCK, new ResourceLocation(SomeMoreBlocks.ID, "calcite_tile_slab"), CALCITE_TILE_SLAB);
    Registry.register(BuiltInRegistries.BLOCK, new ResourceLocation(SomeMoreBlocks.ID, "calcite_tile_stairs"), CALCITE_TILE_STAIRS);
    Registry.register(BuiltInRegistries.BLOCK, new ResourceLocation(SomeMoreBlocks.ID, "calcite_tile_wall"), CALCITE_TILE_WALL);
    Registry.register(BuiltInRegistries.BLOCK, new ResourceLocation(SomeMoreBlocks.ID, "cracked_calcite_tiles"), CRACKED_CALCITE_TILES);
    Registry.register(BuiltInRegistries.BLOCK, new ResourceLocation(SomeMoreBlocks.ID, "calcite_pillar"), CALCITE_PILLAR);
    Registry.register(BuiltInRegistries.BLOCK, new ResourceLocation(SomeMoreBlocks.ID, "polished_dripstone"), POLISHED_DRIPSTONE);
    Registry.register(BuiltInRegistries.BLOCK, new ResourceLocation(SomeMoreBlocks.ID, "polished_dripstone_slab"), POLISHED_DRIPSTONE_SLAB);
    Registry.register(BuiltInRegistries.BLOCK, new ResourceLocation(SomeMoreBlocks.ID, "polished_dripstone_stairs"), POLISHED_DRIPSTONE_STAIRS);
    Registry.register(BuiltInRegistries.BLOCK, new ResourceLocation(SomeMoreBlocks.ID, "smooth_dripstone"), SMOOTH_DRIPSTONE);
    Registry.register(BuiltInRegistries.BLOCK, new ResourceLocation(SomeMoreBlocks.ID, "smooth_dripstone_slab"), SMOOTH_DRIPSTONE_SLAB);
    Registry.register(BuiltInRegistries.BLOCK, new ResourceLocation(SomeMoreBlocks.ID, "chiseled_dripstone_bricks"), CHISELED_DRIPSTONE_BRICKS);
    Registry.register(BuiltInRegistries.BLOCK, new ResourceLocation(SomeMoreBlocks.ID, "dripstone_bricks"), DRIPSTONE_BRICKS);
    Registry.register(BuiltInRegistries.BLOCK, new ResourceLocation(SomeMoreBlocks.ID, "dripstone_brick_slab"), DRIPSTONE_BRICK_SLAB);
    Registry.register(BuiltInRegistries.BLOCK, new ResourceLocation(SomeMoreBlocks.ID, "dripstone_brick_stairs"), DRIPSTONE_BRICK_STAIRS);
    Registry.register(BuiltInRegistries.BLOCK, new ResourceLocation(SomeMoreBlocks.ID, "dripstone_brick_wall"), DRIPSTONE_BRICK_WALL);
    Registry.register(BuiltInRegistries.BLOCK, new ResourceLocation(SomeMoreBlocks.ID, "cracked_dripstone_bricks"), CRACKED_DRIPSTONE_BRICKS);
    Registry.register(BuiltInRegistries.BLOCK, new ResourceLocation(SomeMoreBlocks.ID, "mossy_dripstone_bricks"), MOSSY_DRIPSTONE_BRICKS);
    Registry.register(BuiltInRegistries.BLOCK, new ResourceLocation(SomeMoreBlocks.ID, "mossy_dripstone_brick_slab"), MOSSY_DRIPSTONE_BRICK_SLAB);
    Registry.register(BuiltInRegistries.BLOCK, new ResourceLocation(SomeMoreBlocks.ID, "mossy_dripstone_brick_stairs"), MOSSY_DRIPSTONE_BRICK_STAIRS);
    Registry.register(BuiltInRegistries.BLOCK, new ResourceLocation(SomeMoreBlocks.ID, "mossy_dripstone_brick_wall"), MOSSY_DRIPSTONE_BRICK_WALL);
    Registry.register(BuiltInRegistries.BLOCK, new ResourceLocation(SomeMoreBlocks.ID, "dripstone_tiles"), DRIPSTONE_TILES);
    Registry.register(BuiltInRegistries.BLOCK, new ResourceLocation(SomeMoreBlocks.ID, "dripstone_tile_slab"), DRIPSTONE_TILE_SLAB);
    Registry.register(BuiltInRegistries.BLOCK, new ResourceLocation(SomeMoreBlocks.ID, "dripstone_tile_stairs"), DRIPSTONE_TILE_STAIRS);
    Registry.register(BuiltInRegistries.BLOCK, new ResourceLocation(SomeMoreBlocks.ID, "dripstone_tile_wall"), DRIPSTONE_TILE_WALL);
    Registry.register(BuiltInRegistries.BLOCK, new ResourceLocation(SomeMoreBlocks.ID, "cracked_dripstone_tiles"), CRACKED_DRIPSTONE_TILES);
    Registry.register(BuiltInRegistries.BLOCK, new ResourceLocation(SomeMoreBlocks.ID, "dripstone_pillar"), DRIPSTONE_PILLAR);
    Registry.register(BuiltInRegistries.BLOCK, new ResourceLocation(SomeMoreBlocks.ID, "polished_prismarine"), POLISHED_PRISMARINE);
    Registry.register(BuiltInRegistries.BLOCK, new ResourceLocation(SomeMoreBlocks.ID, "polished_prismarine_slab"), POLISHED_PRISMARINE_SLAB);
    Registry.register(BuiltInRegistries.BLOCK, new ResourceLocation(SomeMoreBlocks.ID, "polished_prismarine_stairs"), POLISHED_PRISMARINE_STAIRS);
    Registry.register(BuiltInRegistries.BLOCK, new ResourceLocation(SomeMoreBlocks.ID, "smooth_prismarine"), SMOOTH_PRISMARINE);
    Registry.register(BuiltInRegistries.BLOCK, new ResourceLocation(SomeMoreBlocks.ID, "smooth_prismarine_slab"), SMOOTH_PRISMARINE_SLAB);
    Registry.register(BuiltInRegistries.BLOCK, new ResourceLocation(SomeMoreBlocks.ID, "chiseled_prismarine_bricks"), CHISELED_PRISMARINE_BRICKS);
    Registry.register(BuiltInRegistries.BLOCK, new ResourceLocation(SomeMoreBlocks.ID, "cracked_prismarine_bricks"), CRACKED_PRISMARINE_BRICKS);
    Registry.register(BuiltInRegistries.BLOCK, new ResourceLocation(SomeMoreBlocks.ID, "mossy_prismarine_bricks"), MOSSY_PRISMARINE_BRICKS);
    Registry.register(BuiltInRegistries.BLOCK, new ResourceLocation(SomeMoreBlocks.ID, "mossy_prismarine_brick_slab"), MOSSY_PRISMARINE_BRICK_SLAB);
    Registry.register(BuiltInRegistries.BLOCK, new ResourceLocation(SomeMoreBlocks.ID, "mossy_prismarine_brick_stairs"), MOSSY_PRISMARINE_BRICK_STAIRS);
    Registry.register(BuiltInRegistries.BLOCK, new ResourceLocation(SomeMoreBlocks.ID, "mossy_prismarine_brick_wall"), MOSSY_PRISMARINE_BRICK_WALL);
    Registry.register(BuiltInRegistries.BLOCK, new ResourceLocation(SomeMoreBlocks.ID, "prismarine_tiles"), PRISMARINE_TILES);
    Registry.register(BuiltInRegistries.BLOCK, new ResourceLocation(SomeMoreBlocks.ID, "prismarine_tile_slab"), PRISMARINE_TILE_SLAB);
    Registry.register(BuiltInRegistries.BLOCK, new ResourceLocation(SomeMoreBlocks.ID, "prismarine_tile_stairs"), PRISMARINE_TILE_STAIRS);
    Registry.register(BuiltInRegistries.BLOCK, new ResourceLocation(SomeMoreBlocks.ID, "prismarine_tile_wall"), PRISMARINE_TILE_WALL);
    Registry.register(BuiltInRegistries.BLOCK, new ResourceLocation(SomeMoreBlocks.ID, "cracked_prismarine_tiles"), CRACKED_PRISMARINE_TILES);
    Registry.register(BuiltInRegistries.BLOCK, new ResourceLocation(SomeMoreBlocks.ID, "prismarine_pillar"), PRISMARINE_PILLAR);
    Registry.register(BuiltInRegistries.BLOCK, new ResourceLocation(SomeMoreBlocks.ID, "smooth_blackstone"), SMOOTH_BLACKSTONE);
    Registry.register(BuiltInRegistries.BLOCK, new ResourceLocation(SomeMoreBlocks.ID, "smooth_blackstone_slab"), SMOOTH_BLACKSTONE_SLAB);
    Registry.register(BuiltInRegistries.BLOCK, new ResourceLocation(SomeMoreBlocks.ID, "corrupted_polished_blackstone_bricks"), CORRUPTED_POLISHED_BLACKSTONE_BRICKS);
    Registry.register(BuiltInRegistries.BLOCK, new ResourceLocation(SomeMoreBlocks.ID, "corrupted_polished_blackstone_brick_slab"), CORRUPTED_POLISHED_BLACKSTONE_BRICK_SLAB);
    Registry.register(BuiltInRegistries.BLOCK, new ResourceLocation(SomeMoreBlocks.ID, "corrupted_polished_blackstone_brick_stairs"), CORRUPTED_POLISHED_BLACKSTONE_BRICK_STAIRS);
    Registry.register(BuiltInRegistries.BLOCK, new ResourceLocation(SomeMoreBlocks.ID, "corrupted_polished_blackstone_brick_wall"), CORRUPTED_POLISHED_BLACKSTONE_BRICK_WALL);
    Registry.register(BuiltInRegistries.BLOCK, new ResourceLocation(SomeMoreBlocks.ID, "polished_blackstone_tiles"), POLISHED_BLACKSTONE_TILES);
    Registry.register(BuiltInRegistries.BLOCK, new ResourceLocation(SomeMoreBlocks.ID, "polished_blackstone_tile_slab"), POLISHED_BLACKSTONE_TILE_SLAB);
    Registry.register(BuiltInRegistries.BLOCK, new ResourceLocation(SomeMoreBlocks.ID, "polished_blackstone_tile_stairs"), POLISHED_BLACKSTONE_TILE_STAIRS);
    Registry.register(BuiltInRegistries.BLOCK, new ResourceLocation(SomeMoreBlocks.ID, "polished_blackstone_tile_wall"), POLISHED_BLACKSTONE_TILE_WALL);
    Registry.register(BuiltInRegistries.BLOCK, new ResourceLocation(SomeMoreBlocks.ID, "cracked_polished_blackstone_tiles"), CRACKED_POLISHED_BLACKSTONE_TILES);
    Registry.register(BuiltInRegistries.BLOCK, new ResourceLocation(SomeMoreBlocks.ID, "polished_blackstone_pillar"), POLISHED_BLACKSTONE_PILLAR);
    Registry.register(BuiltInRegistries.BLOCK, new ResourceLocation(SomeMoreBlocks.ID, "cracked_quartz_bricks"), CRACKED_QUARTZ_BRICKS);
    Registry.register(BuiltInRegistries.BLOCK, new ResourceLocation(SomeMoreBlocks.ID, "cut_quartz"), CUT_QUARTZ);
    Registry.register(BuiltInRegistries.BLOCK, new ResourceLocation(SomeMoreBlocks.ID, "cracked_cut_quartz"), CRACKED_CUT_QUARTZ);
    Registry.register(BuiltInRegistries.BLOCK, new ResourceLocation(SomeMoreBlocks.ID, "polished_mud"), POLISHED_MUD);
    Registry.register(BuiltInRegistries.BLOCK, new ResourceLocation(SomeMoreBlocks.ID, "polished_mud_slab"), POLISHED_MUD_SLAB);
    Registry.register(BuiltInRegistries.BLOCK, new ResourceLocation(SomeMoreBlocks.ID, "polished_mud_stairs"), POLISHED_MUD_STAIRS);
    Registry.register(BuiltInRegistries.BLOCK, new ResourceLocation(SomeMoreBlocks.ID, "smooth_mud"), SMOOTH_MUD);
    Registry.register(BuiltInRegistries.BLOCK, new ResourceLocation(SomeMoreBlocks.ID, "smooth_mud_slab"), SMOOTH_MUD_SLAB);
    Registry.register(BuiltInRegistries.BLOCK, new ResourceLocation(SomeMoreBlocks.ID, "chiseled_mud_bricks"), CHISELED_MUD_BRICKS);
    Registry.register(BuiltInRegistries.BLOCK, new ResourceLocation(SomeMoreBlocks.ID, "cracked_mud_bricks"), CRACKED_MUD_BRICKS);
    Registry.register(BuiltInRegistries.BLOCK, new ResourceLocation(SomeMoreBlocks.ID, "mossy_mud_bricks"), MOSSY_MUD_BRICKS);
    Registry.register(BuiltInRegistries.BLOCK, new ResourceLocation(SomeMoreBlocks.ID, "mossy_mud_brick_slab"), MOSSY_MUD_BRICK_SLAB);
    Registry.register(BuiltInRegistries.BLOCK, new ResourceLocation(SomeMoreBlocks.ID, "mossy_mud_brick_stairs"), MOSSY_MUD_BRICK_STAIRS);
    Registry.register(BuiltInRegistries.BLOCK, new ResourceLocation(SomeMoreBlocks.ID, "mossy_mud_brick_wall"), MOSSY_MUD_BRICK_WALL);
    Registry.register(BuiltInRegistries.BLOCK, new ResourceLocation(SomeMoreBlocks.ID, "mud_tiles"), MUD_TILES);
    Registry.register(BuiltInRegistries.BLOCK, new ResourceLocation(SomeMoreBlocks.ID, "mud_tile_slab"), MUD_TILE_SLAB);
    Registry.register(BuiltInRegistries.BLOCK, new ResourceLocation(SomeMoreBlocks.ID, "mud_tile_stairs"), MUD_TILE_STAIRS);
    Registry.register(BuiltInRegistries.BLOCK, new ResourceLocation(SomeMoreBlocks.ID, "mud_tile_wall"), MUD_TILE_WALL);
    Registry.register(BuiltInRegistries.BLOCK, new ResourceLocation(SomeMoreBlocks.ID, "cracked_mud_tiles"), CRACKED_MUD_TILES);
    Registry.register(BuiltInRegistries.BLOCK, new ResourceLocation(SomeMoreBlocks.ID, "mud_pillar"), MUD_PILLAR);
    Registry.register(BuiltInRegistries.BLOCK, new ResourceLocation(SomeMoreBlocks.ID, "sandstone_bricks"), SANDSTONE_BRICKS);
    Registry.register(BuiltInRegistries.BLOCK, new ResourceLocation(SomeMoreBlocks.ID, "sandstone_brick_slab"), SANDSTONE_BRICK_SLAB);
    Registry.register(BuiltInRegistries.BLOCK, new ResourceLocation(SomeMoreBlocks.ID, "sandstone_brick_stairs"), SANDSTONE_BRICK_STAIRS);
    Registry.register(BuiltInRegistries.BLOCK, new ResourceLocation(SomeMoreBlocks.ID, "sandstone_brick_wall"), SANDSTONE_BRICK_WALL);
    Registry.register(BuiltInRegistries.BLOCK, new ResourceLocation(SomeMoreBlocks.ID, "cracked_sandstone_bricks"), CRACKED_SANDSTONE_BRICKS);
    Registry.register(BuiltInRegistries.BLOCK, new ResourceLocation(SomeMoreBlocks.ID, "mossy_sandstone_bricks"), MOSSY_SANDSTONE_BRICKS);
    Registry.register(BuiltInRegistries.BLOCK, new ResourceLocation(SomeMoreBlocks.ID, "mossy_sandstone_brick_slab"), MOSSY_SANDSTONE_BRICK_SLAB);
    Registry.register(BuiltInRegistries.BLOCK, new ResourceLocation(SomeMoreBlocks.ID, "mossy_sandstone_brick_stairs"), MOSSY_SANDSTONE_BRICK_STAIRS);
    Registry.register(BuiltInRegistries.BLOCK, new ResourceLocation(SomeMoreBlocks.ID, "mossy_sandstone_brick_wall"), MOSSY_SANDSTONE_BRICK_WALL);
    Registry.register(BuiltInRegistries.BLOCK, new ResourceLocation(SomeMoreBlocks.ID, "sandstone_tiles"), SANDSTONE_TILES);
    Registry.register(BuiltInRegistries.BLOCK, new ResourceLocation(SomeMoreBlocks.ID, "sandstone_tile_slab"), SANDSTONE_TILE_SLAB);
    Registry.register(BuiltInRegistries.BLOCK, new ResourceLocation(SomeMoreBlocks.ID, "sandstone_tile_stairs"), SANDSTONE_TILE_STAIRS);
    Registry.register(BuiltInRegistries.BLOCK, new ResourceLocation(SomeMoreBlocks.ID, "sandstone_tile_wall"), SANDSTONE_TILE_WALL);
    Registry.register(BuiltInRegistries.BLOCK, new ResourceLocation(SomeMoreBlocks.ID, "cracked_sandstone_tiles"), CRACKED_SANDSTONE_TILES);
    Registry.register(BuiltInRegistries.BLOCK, new ResourceLocation(SomeMoreBlocks.ID, "sandstone_pillar"), SANDSTONE_PILLAR);
    Registry.register(BuiltInRegistries.BLOCK, new ResourceLocation(SomeMoreBlocks.ID, "nether_bricks_pillar"), NETHER_BRICKS_PILLAR);
    Registry.register(BuiltInRegistries.BLOCK, new ResourceLocation(SomeMoreBlocks.ID, "chiseled_red_nether_bricks"), CHISELED_RED_NETHER_BRICKS);
    Registry.register(BuiltInRegistries.BLOCK, new ResourceLocation(SomeMoreBlocks.ID, "cracked_red_nether_bricks"), CRACKED_RED_NETHER_BRICKS);
    Registry.register(BuiltInRegistries.BLOCK, new ResourceLocation(SomeMoreBlocks.ID, "red_nether_bricks_pillar"), RED_NETHER_BRICKS_PILLAR);
    Registry.register(BuiltInRegistries.BLOCK, new ResourceLocation(SomeMoreBlocks.ID, "polished_ice"), POLISHED_ICE);
    Registry.register(BuiltInRegistries.BLOCK, new ResourceLocation(SomeMoreBlocks.ID, "polished_ice_slab"), POLISHED_ICE_SLAB);
    Registry.register(BuiltInRegistries.BLOCK, new ResourceLocation(SomeMoreBlocks.ID, "polished_ice_stairs"), POLISHED_ICE_STAIRS);
    Registry.register(BuiltInRegistries.BLOCK, new ResourceLocation(SomeMoreBlocks.ID, "ice_bricks"), ICE_BRICKS);
    Registry.register(BuiltInRegistries.BLOCK, new ResourceLocation(SomeMoreBlocks.ID, "ice_brick_slab"), ICE_BRICK_SLAB);
    Registry.register(BuiltInRegistries.BLOCK, new ResourceLocation(SomeMoreBlocks.ID, "ice_brick_stairs"), ICE_BRICK_STAIRS);
    Registry.register(BuiltInRegistries.BLOCK, new ResourceLocation(SomeMoreBlocks.ID, "ice_brick_wall"), ICE_BRICK_WALL);
    Registry.register(BuiltInRegistries.BLOCK, new ResourceLocation(SomeMoreBlocks.ID, "cracked_ice_bricks"), CRACKED_ICE_BRICKS);
    Registry.register(BuiltInRegistries.BLOCK, new ResourceLocation(SomeMoreBlocks.ID, "ice_tiles"), ICE_TILES);
    Registry.register(BuiltInRegistries.BLOCK, new ResourceLocation(SomeMoreBlocks.ID, "ice_tile_slab"), ICE_TILE_SLAB);
    Registry.register(BuiltInRegistries.BLOCK, new ResourceLocation(SomeMoreBlocks.ID, "ice_tile_stairs"), ICE_TILE_STAIRS);
    Registry.register(BuiltInRegistries.BLOCK, new ResourceLocation(SomeMoreBlocks.ID, "ice_tile_wall"), ICE_TILE_WALL);
    Registry.register(BuiltInRegistries.BLOCK, new ResourceLocation(SomeMoreBlocks.ID, "cracked_ice_tiles"), CRACKED_ICE_TILES);
    Registry.register(BuiltInRegistries.BLOCK, new ResourceLocation(SomeMoreBlocks.ID, "ice_pillar"), ICE_PILLAR);
    Registry.register(BuiltInRegistries.BLOCK, new ResourceLocation(SomeMoreBlocks.ID, "polished_purpur"), POLISHED_PURPUR);
    Registry.register(BuiltInRegistries.BLOCK, new ResourceLocation(SomeMoreBlocks.ID, "polished_purpur_slab"), POLISHED_PURPUR_SLAB);
    Registry.register(BuiltInRegistries.BLOCK, new ResourceLocation(SomeMoreBlocks.ID, "polished_purpur_stairs"), POLISHED_PURPUR_STAIRS);
    Registry.register(BuiltInRegistries.BLOCK, new ResourceLocation(SomeMoreBlocks.ID, "smooth_purpur"), SMOOTH_PURPUR);
    Registry.register(BuiltInRegistries.BLOCK, new ResourceLocation(SomeMoreBlocks.ID, "smooth_purpur_slab"), SMOOTH_PURPUR_SLAB);
    Registry.register(BuiltInRegistries.BLOCK, new ResourceLocation(SomeMoreBlocks.ID, "chiseled_purpur"), CHISELED_PURPUR);
    Registry.register(BuiltInRegistries.BLOCK, new ResourceLocation(SomeMoreBlocks.ID, "cracked_purpur_block"), CRACKED_PURPUR_BLOCK);
    Registry.register(BuiltInRegistries.BLOCK, new ResourceLocation(SomeMoreBlocks.ID, "mossy_purpur_block"), MOSSY_PURPUR_BLOCK);
    Registry.register(BuiltInRegistries.BLOCK, new ResourceLocation(SomeMoreBlocks.ID, "mossy_purpur_block_slab"), MOSSY_PURPUR_BLOCK_SLAB);
    Registry.register(BuiltInRegistries.BLOCK, new ResourceLocation(SomeMoreBlocks.ID, "mossy_purpur_block_stairs"), MOSSY_PURPUR_BLOCK_STAIRS);
    Registry.register(BuiltInRegistries.BLOCK, new ResourceLocation(SomeMoreBlocks.ID, "mossy_purpur_block_wall"), MOSSY_PURPUR_BLOCK_WALL);
    Registry.register(BuiltInRegistries.BLOCK, new ResourceLocation(SomeMoreBlocks.ID, "purpur_tiles"), PURPUR_TILES);
    Registry.register(BuiltInRegistries.BLOCK, new ResourceLocation(SomeMoreBlocks.ID, "purpur_tile_slab"), PURPUR_TILE_SLAB);
    Registry.register(BuiltInRegistries.BLOCK, new ResourceLocation(SomeMoreBlocks.ID, "purpur_tile_stairs"), PURPUR_TILE_STAIRS);
    Registry.register(BuiltInRegistries.BLOCK, new ResourceLocation(SomeMoreBlocks.ID, "purpur_tile_wall"), PURPUR_TILE_WALL);
    Registry.register(BuiltInRegistries.BLOCK, new ResourceLocation(SomeMoreBlocks.ID, "cracked_purpur_tiles"), CRACKED_PURPUR_TILES);
    Registry.register(BuiltInRegistries.BLOCK, new ResourceLocation(SomeMoreBlocks.ID, "white_concrete_bricks"), WHITE_CONCRETE_BRICKS);
    Registry.register(BuiltInRegistries.BLOCK, new ResourceLocation(SomeMoreBlocks.ID, "light_gray_concrete_bricks"), LIGHT_GRAY_CONCRETE_BRICKS);
    Registry.register(BuiltInRegistries.BLOCK, new ResourceLocation(SomeMoreBlocks.ID, "gray_concrete_bricks"), GRAY_CONCRETE_BRICKS);
    Registry.register(BuiltInRegistries.BLOCK, new ResourceLocation(SomeMoreBlocks.ID, "black_concrete_bricks"), BLACK_CONCRETE_BRICKS);
    Registry.register(BuiltInRegistries.BLOCK, new ResourceLocation(SomeMoreBlocks.ID, "brown_concrete_bricks"), BROWN_CONCRETE_BRICKS);
    Registry.register(BuiltInRegistries.BLOCK, new ResourceLocation(SomeMoreBlocks.ID, "red_concrete_bricks"), RED_CONCRETE_BRICKS);
    Registry.register(BuiltInRegistries.BLOCK, new ResourceLocation(SomeMoreBlocks.ID, "orange_concrete_bricks"), ORANGE_CONCRETE_BRICKS);
    Registry.register(BuiltInRegistries.BLOCK, new ResourceLocation(SomeMoreBlocks.ID, "yellow_concrete_bricks"), YELLOW_CONCRETE_BRICKS);
    Registry.register(BuiltInRegistries.BLOCK, new ResourceLocation(SomeMoreBlocks.ID, "lime_concrete_bricks"), LIME_CONCRETE_BRICKS);
    Registry.register(BuiltInRegistries.BLOCK, new ResourceLocation(SomeMoreBlocks.ID, "green_concrete_bricks"), GREEN_CONCRETE_BRICKS);
    Registry.register(BuiltInRegistries.BLOCK, new ResourceLocation(SomeMoreBlocks.ID, "cyan_concrete_bricks"), CYAN_CONCRETE_BRICKS);
    Registry.register(BuiltInRegistries.BLOCK, new ResourceLocation(SomeMoreBlocks.ID, "light_blue_concrete_bricks"), LIGHT_BLUE_CONCRETE_BRICKS);
    Registry.register(BuiltInRegistries.BLOCK, new ResourceLocation(SomeMoreBlocks.ID, "blue_concrete_bricks"), BLUE_CONCRETE_BRICKS);
    Registry.register(BuiltInRegistries.BLOCK, new ResourceLocation(SomeMoreBlocks.ID, "purple_concrete_bricks"), PURPLE_CONCRETE_BRICKS);
    Registry.register(BuiltInRegistries.BLOCK, new ResourceLocation(SomeMoreBlocks.ID, "magenta_concrete_bricks"), MAGENTA_CONCRETE_BRICKS);
    Registry.register(BuiltInRegistries.BLOCK, new ResourceLocation(SomeMoreBlocks.ID, "pink_concrete_bricks"), PINK_CONCRETE_BRICKS);
    Registry.register(BuiltInRegistries.BLOCK, new ResourceLocation(SomeMoreBlocks.ID, "white_concrete_tiles"), WHITE_CONCRETE_TILES);
    Registry.register(BuiltInRegistries.BLOCK, new ResourceLocation(SomeMoreBlocks.ID, "light_gray_concrete_tiles"), LIGHT_GRAY_CONCRETE_TILES);
    Registry.register(BuiltInRegistries.BLOCK, new ResourceLocation(SomeMoreBlocks.ID, "gray_concrete_tiles"), GRAY_CONCRETE_TILES);
    Registry.register(BuiltInRegistries.BLOCK, new ResourceLocation(SomeMoreBlocks.ID, "black_concrete_tiles"), BLACK_CONCRETE_TILES);
    Registry.register(BuiltInRegistries.BLOCK, new ResourceLocation(SomeMoreBlocks.ID, "brown_concrete_tiles"), BROWN_CONCRETE_TILES);
    Registry.register(BuiltInRegistries.BLOCK, new ResourceLocation(SomeMoreBlocks.ID, "red_concrete_tiles"), RED_CONCRETE_TILES);
    Registry.register(BuiltInRegistries.BLOCK, new ResourceLocation(SomeMoreBlocks.ID, "orange_concrete_tiles"), ORANGE_CONCRETE_TILES);
    Registry.register(BuiltInRegistries.BLOCK, new ResourceLocation(SomeMoreBlocks.ID, "yellow_concrete_tiles"), YELLOW_CONCRETE_TILES);
    Registry.register(BuiltInRegistries.BLOCK, new ResourceLocation(SomeMoreBlocks.ID, "lime_concrete_tiles"), LIME_CONCRETE_TILES);
    Registry.register(BuiltInRegistries.BLOCK, new ResourceLocation(SomeMoreBlocks.ID, "green_concrete_tiles"), GREEN_CONCRETE_TILES);
    Registry.register(BuiltInRegistries.BLOCK, new ResourceLocation(SomeMoreBlocks.ID, "cyan_concrete_tiles"), CYAN_CONCRETE_TILES);
    Registry.register(BuiltInRegistries.BLOCK, new ResourceLocation(SomeMoreBlocks.ID, "light_blue_concrete_tiles"), LIGHT_BLUE_CONCRETE_TILES);
    Registry.register(BuiltInRegistries.BLOCK, new ResourceLocation(SomeMoreBlocks.ID, "blue_concrete_tiles"), BLUE_CONCRETE_TILES);
    Registry.register(BuiltInRegistries.BLOCK, new ResourceLocation(SomeMoreBlocks.ID, "purple_concrete_tiles"), PURPLE_CONCRETE_TILES);
    Registry.register(BuiltInRegistries.BLOCK, new ResourceLocation(SomeMoreBlocks.ID, "magenta_concrete_tiles"), MAGENTA_CONCRETE_TILES);
    Registry.register(BuiltInRegistries.BLOCK, new ResourceLocation(SomeMoreBlocks.ID, "pink_concrete_tiles"), PINK_CONCRETE_TILES);
    Registry.register(BuiltInRegistries.BLOCK, new ResourceLocation(SomeMoreBlocks.ID, "terracotta_bricks"), TERRACOTTA_BRICKS);
    Registry.register(BuiltInRegistries.BLOCK, new ResourceLocation(SomeMoreBlocks.ID, "white_terracotta_bricks"), WHITE_TERRACOTTA_BRICKS);
    Registry.register(BuiltInRegistries.BLOCK, new ResourceLocation(SomeMoreBlocks.ID, "light_gray_terracotta_bricks"), LIGHT_GRAY_TERRACOTTA_BRICKS);
    Registry.register(BuiltInRegistries.BLOCK, new ResourceLocation(SomeMoreBlocks.ID, "gray_terracotta_bricks"), GRAY_TERRACOTTA_BRICKS);
    Registry.register(BuiltInRegistries.BLOCK, new ResourceLocation(SomeMoreBlocks.ID, "black_terracotta_bricks"), BLACK_TERRACOTTA_BRICKS);
    Registry.register(BuiltInRegistries.BLOCK, new ResourceLocation(SomeMoreBlocks.ID, "brown_terracotta_bricks"), BROWN_TERRACOTTA_BRICKS);
    Registry.register(BuiltInRegistries.BLOCK, new ResourceLocation(SomeMoreBlocks.ID, "red_terracotta_bricks"), RED_TERRACOTTA_BRICKS);
    Registry.register(BuiltInRegistries.BLOCK, new ResourceLocation(SomeMoreBlocks.ID, "orange_terracotta_bricks"), ORANGE_TERRACOTTA_BRICKS);
    Registry.register(BuiltInRegistries.BLOCK, new ResourceLocation(SomeMoreBlocks.ID, "yellow_terracotta_bricks"), YELLOW_TERRACOTTA_BRICKS);
    Registry.register(BuiltInRegistries.BLOCK, new ResourceLocation(SomeMoreBlocks.ID, "lime_terracotta_bricks"), LIME_TERRACOTTA_BRICKS);
    Registry.register(BuiltInRegistries.BLOCK, new ResourceLocation(SomeMoreBlocks.ID, "green_terracotta_bricks"), GREEN_TERRACOTTA_BRICKS);
    Registry.register(BuiltInRegistries.BLOCK, new ResourceLocation(SomeMoreBlocks.ID, "cyan_terracotta_bricks"), CYAN_TERRACOTTA_BRICKS);
    Registry.register(BuiltInRegistries.BLOCK, new ResourceLocation(SomeMoreBlocks.ID, "light_blue_terracotta_bricks"), LIGHT_BLUE_TERRACOTTA_BRICKS);
    Registry.register(BuiltInRegistries.BLOCK, new ResourceLocation(SomeMoreBlocks.ID, "blue_terracotta_bricks"), BLUE_TERRACOTTA_BRICKS);
    Registry.register(BuiltInRegistries.BLOCK, new ResourceLocation(SomeMoreBlocks.ID, "purple_terracotta_bricks"), PURPLE_TERRACOTTA_BRICKS);
    Registry.register(BuiltInRegistries.BLOCK, new ResourceLocation(SomeMoreBlocks.ID, "magenta_terracotta_bricks"), MAGENTA_TERRACOTTA_BRICKS);
    Registry.register(BuiltInRegistries.BLOCK, new ResourceLocation(SomeMoreBlocks.ID, "pink_terracotta_bricks"), PINK_TERRACOTTA_BRICKS);
    Registry.register(BuiltInRegistries.BLOCK, new ResourceLocation(SomeMoreBlocks.ID, "terracotta_tiles"), TERRACOTTA_TILES);
    Registry.register(BuiltInRegistries.BLOCK, new ResourceLocation(SomeMoreBlocks.ID, "white_terracotta_tiles"), WHITE_TERRACOTTA_TILES);
    Registry.register(BuiltInRegistries.BLOCK, new ResourceLocation(SomeMoreBlocks.ID, "light_gray_terracotta_tiles"), LIGHT_GRAY_TERRACOTTA_TILES);
    Registry.register(BuiltInRegistries.BLOCK, new ResourceLocation(SomeMoreBlocks.ID, "gray_terracotta_tiles"), GRAY_TERRACOTTA_TILES);
    Registry.register(BuiltInRegistries.BLOCK, new ResourceLocation(SomeMoreBlocks.ID, "black_terracotta_tiles"), BLACK_TERRACOTTA_TILES);
    Registry.register(BuiltInRegistries.BLOCK, new ResourceLocation(SomeMoreBlocks.ID, "brown_terracotta_tiles"), BROWN_TERRACOTTA_TILES);
    Registry.register(BuiltInRegistries.BLOCK, new ResourceLocation(SomeMoreBlocks.ID, "red_terracotta_tiles"), RED_TERRACOTTA_TILES);
    Registry.register(BuiltInRegistries.BLOCK, new ResourceLocation(SomeMoreBlocks.ID, "orange_terracotta_tiles"), ORANGE_TERRACOTTA_TILES);
    Registry.register(BuiltInRegistries.BLOCK, new ResourceLocation(SomeMoreBlocks.ID, "yellow_terracotta_tiles"), YELLOW_TERRACOTTA_TILES);
    Registry.register(BuiltInRegistries.BLOCK, new ResourceLocation(SomeMoreBlocks.ID, "lime_terracotta_tiles"), LIME_TERRACOTTA_TILES);
    Registry.register(BuiltInRegistries.BLOCK, new ResourceLocation(SomeMoreBlocks.ID, "green_terracotta_tiles"), GREEN_TERRACOTTA_TILES);
    Registry.register(BuiltInRegistries.BLOCK, new ResourceLocation(SomeMoreBlocks.ID, "cyan_terracotta_tiles"), CYAN_TERRACOTTA_TILES);
    Registry.register(BuiltInRegistries.BLOCK, new ResourceLocation(SomeMoreBlocks.ID, "light_blue_terracotta_tiles"), LIGHT_BLUE_TERRACOTTA_TILES);
    Registry.register(BuiltInRegistries.BLOCK, new ResourceLocation(SomeMoreBlocks.ID, "blue_terracotta_tiles"), BLUE_TERRACOTTA_TILES);
    Registry.register(BuiltInRegistries.BLOCK, new ResourceLocation(SomeMoreBlocks.ID, "purple_terracotta_tiles"), PURPLE_TERRACOTTA_TILES);
    Registry.register(BuiltInRegistries.BLOCK, new ResourceLocation(SomeMoreBlocks.ID, "magenta_terracotta_tiles"), MAGENTA_TERRACOTTA_TILES);
    Registry.register(BuiltInRegistries.BLOCK, new ResourceLocation(SomeMoreBlocks.ID, "pink_terracotta_tiles"), PINK_TERRACOTTA_TILES);
    Registry.register(BuiltInRegistries.BLOCK, new ResourceLocation(SomeMoreBlocks.ID, "soul_sandstone"), SOUL_SANDSTONE);
    Registry.register(BuiltInRegistries.BLOCK, new ResourceLocation(SomeMoreBlocks.ID, "soul_sandstone_slab"), SOUL_SANDSTONE_SLAB);
    Registry.register(BuiltInRegistries.BLOCK, new ResourceLocation(SomeMoreBlocks.ID, "soul_sandstone_stairs"), SOUL_SANDSTONE_STAIRS);
    Registry.register(BuiltInRegistries.BLOCK, new ResourceLocation(SomeMoreBlocks.ID, "soul_sandstone_wall"), SOUL_SANDSTONE_WALL);
    Registry.register(BuiltInRegistries.BLOCK, new ResourceLocation(SomeMoreBlocks.ID, "cut_soul_sandstone"), CUT_SOUL_SANDSTONE);
    Registry.register(BuiltInRegistries.BLOCK, new ResourceLocation(SomeMoreBlocks.ID, "cut_soul_sandstone_slab"), CUT_SOUL_SANDSTONE_SLAB);
    Registry.register(BuiltInRegistries.BLOCK, new ResourceLocation(SomeMoreBlocks.ID, "smooth_soul_sandstone"), SMOOTH_SOUL_SANDSTONE);
    Registry.register(BuiltInRegistries.BLOCK, new ResourceLocation(SomeMoreBlocks.ID, "smooth_soul_sandstone_slab"), SMOOTH_SOUL_SANDSTONE_SLAB);
    Registry.register(BuiltInRegistries.BLOCK, new ResourceLocation(SomeMoreBlocks.ID, "smooth_soul_sandstone_stairs"), SMOOTH_SOUL_SANDSTONE_STAIRS);
    Registry.register(BuiltInRegistries.BLOCK, new ResourceLocation(SomeMoreBlocks.ID, "chiseled_soul_sandstone"), CHISELED_SOUL_SANDSTONE);
    Registry.register(BuiltInRegistries.BLOCK, new ResourceLocation(SomeMoreBlocks.ID, "soul_sandstone_bricks"), SOUL_SANDSTONE_BRICKS);
    Registry.register(BuiltInRegistries.BLOCK, new ResourceLocation(SomeMoreBlocks.ID, "soul_sandstone_brick_slab"), SOUL_SANDSTONE_BRICK_SLAB);
    ...
    Registry.register(BuiltInRegistries.BLOCK, new ResourceLocation(SomeMoreBlocks.ID, "soul_sandstone_tile_wall"), SOUL_SANDSTONE_TILE_WALL);
    Registry.register(BuiltInRegistries.BLOCK, new ResourceLocation(SomeMoreBlocks.ID, "cracked_soul_sandstone_tiles"), CRACKED_SOUL_SANDSTONE_TILES);
    Registry.register(BuiltInRegistries.BLOCK, new ResourceLocation(SomeMoreBlocks.ID, "soul_sandstone_pillar"), SOUL_SANDSTONE_PILLAR);
    Registry.register(BuiltInRegistries.BLOCK, new ResourceLocation(SomeMoreBlocks.ID, "coal_bricks"), COAL_BRICKS);
    Registry.register(BuiltInRegistries.BLOCK, new ResourceLocation(SomeMoreBlocks.ID, "cracked_coal_bricks"), CRACKED_COAL_BRICKS);
    Registry.register(BuiltInRegistries.BLOCK, new ResourceLocation(SomeMoreBlocks.ID, "cut_coal"), CUT_COAL);
    Registry.register(BuiltInRegistries.BLOCK, new ResourceLocation(SomeMoreBlocks.ID, "cracked_cut_coal"), CRACKED_CUT_COAL);
    Registry.register(BuiltInRegistries.BLOCK, new ResourceLocation(SomeMoreBlocks.ID, "coal_pillar"), COAL_PILLAR);
    Registry.register(BuiltInRegistries.BLOCK, new ResourceLocation(SomeMoreBlocks.ID, "iron_bricks"), IRON_BRICKS);
    Registry.register(BuiltInRegistries.BLOCK, new ResourceLocation(SomeMoreBlocks.ID, "cracked_iron_bricks"), CRACKED_IRON_BRICKS);
    Registry.register(BuiltInRegistries.BLOCK, new ResourceLocation(SomeMoreBlocks.ID, "cut_iron"), CUT_IRON);
    Registry.register(BuiltInRegistries.BLOCK, new ResourceLocation(SomeMoreBlocks.ID, "cracked_cut_iron"), CRACKED_CUT_IRON);
    Registry.register(BuiltInRegistries.BLOCK, new ResourceLocation(SomeMoreBlocks.ID, "iron_pillar"), IRON_PILLAR);
    Registry.register(BuiltInRegistries.BLOCK, new ResourceLocation(SomeMoreBlocks.ID, "gold_bricks"), GOLD_BRICKS);
    Registry.register(BuiltInRegistries.BLOCK, new ResourceLocation(SomeMoreBlocks.ID, "cracked_gold_bricks"), CRACKED_GOLD_BRICKS);
    Registry.register(BuiltInRegistries.BLOCK, new ResourceLocation(SomeMoreBlocks.ID, "cut_gold"), CUT_GOLD);
    Registry.register(BuiltInRegistries.BLOCK, new ResourceLocation(SomeMoreBlocks.ID, "cracked_cut_gold"), CRACKED_CUT_GOLD);
    Registry.register(BuiltInRegistries.BLOCK, new ResourceLocation(SomeMoreBlocks.ID, "gold_pillar"), GOLD_PILLAR);
    Registry.register(BuiltInRegistries.BLOCK, new ResourceLocation(SomeMoreBlocks.ID, "redstone_bricks"), REDSTONE_BRICKS);
    Registry.register(BuiltInRegistries.BLOCK, new ResourceLocation(SomeMoreBlocks.ID, "cracked_redstone_bricks"), CRACKED_REDSTONE_BRICKS);
    Registry.register(BuiltInRegistries.BLOCK, new ResourceLocation(SomeMoreBlocks.ID, "cut_redstone"), CUT_REDSTONE);
    Registry.register(BuiltInRegistries.BLOCK, new ResourceLocation(SomeMoreBlocks.ID, "cracked_cut_redstone"), CRACKED_CUT_REDSTONE);
    Registry.register(BuiltInRegistries.BLOCK, new ResourceLocation(SomeMoreBlocks.ID, "redstone_pillar"), REDSTONE_PILLAR);
    Registry.register(BuiltInRegistries.BLOCK, new ResourceLocation(SomeMoreBlocks.ID, "emerald_bricks"), EMERALD_BRICKS);
    Registry.register(BuiltInRegistries.BLOCK, new ResourceLocation(SomeMoreBlocks.ID, "cracked_emerald_bricks"), CRACKED_EMERALD_BRICKS);
    Registry.register(BuiltInRegistries.BLOCK, new ResourceLocation(SomeMoreBlocks.ID, "cut_emerald"), CUT_EMERALD);
    Registry.register(BuiltInRegistries.BLOCK, new ResourceLocation(SomeMoreBlocks.ID, "cracked_cut_emerald"), CRACKED_CUT_EMERALD);
    Registry.register(BuiltInRegistries.BLOCK, new ResourceLocation(SomeMoreBlocks.ID, "emerald_pillar"), EMERALD_PILLAR);
    Registry.register(BuiltInRegistries.BLOCK, new ResourceLocation(SomeMoreBlocks.ID, "lapis_bricks"), LAPIS_BRICKS);
    Registry.register(BuiltInRegistries.BLOCK, new ResourceLocation(SomeMoreBlocks.ID, "cracked_lapis_bricks"), CRACKED_LAPIS_BRICKS);
    Registry.register(BuiltInRegistries.BLOCK, new ResourceLocation(SomeMoreBlocks.ID, "cut_lapis"), CUT_LAPIS);
    Registry.register(BuiltInRegistries.BLOCK, new ResourceLocation(SomeMoreBlocks.ID, "cracked_cut_lapis"), CRACKED_CUT_LAPIS);
    Registry.register(BuiltInRegistries.BLOCK, new ResourceLocation(SomeMoreBlocks.ID, "lapis_pillar"), LAPIS_PILLAR);
    Registry.register(BuiltInRegistries.BLOCK, new ResourceLocation(SomeMoreBlocks.ID, "diamond_bricks"), DIAMOND_BRICKS);
    Registry.register(BuiltInRegistries.BLOCK, new ResourceLocation(SomeMoreBlocks.ID, "cracked_diamond_bricks"), CRACKED_DIAMOND_BRICKS);
    Registry.register(BuiltInRegistries.BLOCK, new ResourceLocation(SomeMoreBlocks.ID, "cut_diamond"), CUT_DIAMOND);
    Registry.register(BuiltInRegistries.BLOCK, new ResourceLocation(SomeMoreBlocks.ID, "cracked_cut_diamond"), CRACKED_CUT_DIAMOND);
    Registry.register(BuiltInRegistries.BLOCK, new ResourceLocation(SomeMoreBlocks.ID, "diamond_pillar"), DIAMOND_PILLAR);
    Registry.register(BuiltInRegistries.BLOCK, new ResourceLocation(SomeMoreBlocks.ID, "netherite_bricks"), NETHERITE_BRICKS);
    Registry.register(BuiltInRegistries.BLOCK, new ResourceLocation(SomeMoreBlocks.ID, "cracked_netherite_bricks"), CRACKED_NETHERITE_BRICKS);
    Registry.register(BuiltInRegistries.BLOCK, new ResourceLocation(SomeMoreBlocks.ID, "cut_netherite"), CUT_NETHERITE);
    Registry.register(BuiltInRegistries.BLOCK, new ResourceLocation(SomeMoreBlocks.ID, "cracked_cut_netherite"), CRACKED_CUT_NETHERITE);
    Registry.register(BuiltInRegistries.BLOCK, new ResourceLocation(SomeMoreBlocks.ID, "netherite_pillar"), NETHERITE_PILLAR);
    Registry.register(BuiltInRegistries.BLOCK, new ResourceLocation(SomeMoreBlocks.ID, "amethyst_bricks"), AMETHYST_BRICKS);
    Registry.register(BuiltInRegistries.BLOCK, new ResourceLocation(SomeMoreBlocks.ID, "cracked_amethyst_bricks"), CRACKED_AMETHYST_BRICKS);
    Registry.register(BuiltInRegistries.BLOCK, new ResourceLocation(SomeMoreBlocks.ID, "cut_amethyst"), CUT_AMETHYST);
    Registry.register(BuiltInRegistries.BLOCK, new ResourceLocation(SomeMoreBlocks.ID, "cracked_cut_amethyst"), CRACKED_CUT_AMETHYST);
    Registry.register(BuiltInRegistries.BLOCK, new ResourceLocation(SomeMoreBlocks.ID, "amethyst_pillar"), AMETHYST_PILLAR);
    Registry.register(BuiltInRegistries.BLOCK, new ResourceLocation(SomeMoreBlocks.ID, "shingles"), SHINGLES);
    Registry.register(BuiltInRegistries.BLOCK, new ResourceLocation(SomeMoreBlocks.ID, "white_shingles"), WHITE_SHINGLES);
    Registry.register(BuiltInRegistries.BLOCK, new ResourceLocation(SomeMoreBlocks.ID, "light_gray_shingles"), LIGHT_GRAY_SHINGLES);
    Registry.register(BuiltInRegistries.BLOCK, new ResourceLocation(SomeMoreBlocks.ID, "gray_shingles"), GRAY_SHINGLES);
    Registry.register(BuiltInRegistries.BLOCK, new ResourceLocation(SomeMoreBlocks.ID, "black_shingles"), BLACK_SHINGLES);
    Registry.register(BuiltInRegistries.BLOCK, new ResourceLocation(SomeMoreBlocks.ID, "brown_shingles"), BROWN_SHINGLES);
    Registry.register(BuiltInRegistries.BLOCK, new ResourceLocation(SomeMoreBlocks.ID, "red_shingles"), RED_SHINGLES);
    Registry.register(BuiltInRegistries.BLOCK, new ResourceLocation(SomeMoreBlocks.ID, "orange_shingles"), ORANGE_SHINGLES);
    Registry.register(BuiltInRegistries.BLOCK, new ResourceLocation(SomeMoreBlocks.ID, "yellow_shingles"), YELLOW_SHINGLES);
    Registry.register(BuiltInRegistries.BLOCK, new ResourceLocation(SomeMoreBlocks.ID, "lime_shingles"), LIME_SHINGLES);
    Registry.register(BuiltInRegistries.BLOCK, new ResourceLocation(SomeMoreBlocks.ID, "green_shingles"), GREEN_SHINGLES);
    Registry.register(BuiltInRegistries.BLOCK, new ResourceLocation(SomeMoreBlocks.ID, "cyan_shingles"), CYAN_SHINGLES);
    Registry.register(BuiltInRegistries.BLOCK, new ResourceLocation(SomeMoreBlocks.ID, "light_blue_shingles"), LIGHT_BLUE_SHINGLES);
    Registry.register(BuiltInRegistries.BLOCK, new ResourceLocation(SomeMoreBlocks.ID, "blue_shingles"), BLUE_SHINGLES);
    Registry.register(BuiltInRegistries.BLOCK, new ResourceLocation(SomeMoreBlocks.ID, "purple_shingles"), PURPLE_SHINGLES);
    Registry.register(BuiltInRegistries.BLOCK, new ResourceLocation(SomeMoreBlocks.ID, "magenta_shingles"), MAGENTA_SHINGLES);
    Registry.register(BuiltInRegistries.BLOCK, new ResourceLocation(SomeMoreBlocks.ID, "pink_shingles"), PINK_SHINGLES);
    Registry.register(BuiltInRegistries.BLOCK, new ResourceLocation(SomeMoreBlocks.ID, "oak_mosaic"), OAK_MOSAIC);
    Registry.register(BuiltInRegistries.BLOCK, new ResourceLocation(SomeMoreBlocks.ID, "oak_mosaic_slab"), OAK_MOSAIC_SLAB);
    Registry.register(BuiltInRegistries.BLOCK, new ResourceLocation(SomeMoreBlocks.ID, "oak_mosaic_stairs"), OAK_MOSAIC_STAIRS);
    Registry.register(BuiltInRegistries.BLOCK, new ResourceLocation(SomeMoreBlocks.ID, "carved_oak_log"), CARVED_OAK_LOG);
    Registry.register(BuiltInRegistries.BLOCK, new ResourceLocation(SomeMoreBlocks.ID, "carved_oak_wood"), CARVED_OAK_WOOD);
    Registry.register(BuiltInRegistries.BLOCK, new ResourceLocation(SomeMoreBlocks.ID, "spruce_mosaic"), SPRUCE_MOSAIC);
    Registry.register(BuiltInRegistries.BLOCK, new ResourceLocation(SomeMoreBlocks.ID, "spruce_mosaic_slab"), SPRUCE_MOSAIC_SLAB);
    Registry.register(BuiltInRegistries.BLOCK, new ResourceLocation(SomeMoreBlocks.ID, "spruce_mosaic_stairs"), SPRUCE_MOSAIC_STAIRS);
    Registry.register(BuiltInRegistries.BLOCK, new ResourceLocation(SomeMoreBlocks.ID, "carved_spruce_log"), CARVED_SPRUCE_LOG);
    Registry.register(BuiltInRegistries.BLOCK, new ResourceLocation(SomeMoreBlocks.ID, "carved_spruce_wood"), CARVED_SPRUCE_WOOD);
    Registry.register(BuiltInRegistries.BLOCK, new ResourceLocation(SomeMoreBlocks.ID, "birch_mosaic"), BIRCH_MOSAIC);
    Registry.register(BuiltInRegistries.BLOCK, new ResourceLocation(SomeMoreBlocks.ID, "birch_mosaic_slab"), BIRCH_MOSAIC_SLAB);
    Registry.register(BuiltInRegistries.BLOCK, new ResourceLocation(SomeMoreBlocks.ID, "birch_mosaic_stairs"), BIRCH_MOSAIC_STAIRS);
    Registry.register(BuiltInRegistries.BLOCK, new ResourceLocation(SomeMoreBlocks.ID, "carved_birch_log"), CARVED_BIRCH_LOG);
    Registry.register(BuiltInRegistries.BLOCK, new ResourceLocation(SomeMoreBlocks.ID, "carved_birch_wood"), CARVED_BIRCH_WOOD);
    Registry.register(BuiltInRegistries.BLOCK, new ResourceLocation(SomeMoreBlocks.ID, "jungle_mosaic"), JUNGLE_MOSAIC);
    Registry.register(BuiltInRegistries.BLOCK, new ResourceLocation(SomeMoreBlocks.ID, "jungle_mosaic_slab"), JUNGLE_MOSAIC_SLAB);
    Registry.register(BuiltInRegistries.BLOCK, new ResourceLocation(SomeMoreBlocks.ID, "jungle_mosaic_stairs"), JUNGLE_MOSAIC_STAIRS);
    Registry.register(BuiltInRegistries.BLOCK, new ResourceLocation(SomeMoreBlocks.ID, "carved_jungle_log"), CARVED_JUNGLE_LOG);
    Registry.register(BuiltInRegistries.BLOCK, new ResourceLocation(SomeMoreBlocks.ID, "carved_jungle_wood"), CARVED_JUNGLE_WOOD);
    Registry.register(BuiltInRegistries.BLOCK, new ResourceLocation(SomeMoreBlocks.ID, "acacia_mosaic"), ACACIA_MOSAIC);
    Registry.register(BuiltInRegistries.BLOCK, new ResourceLocation(SomeMoreBlocks.ID, "acacia_mosaic_slab"), ACACIA_MOSAIC_SLAB);
    Registry.register(BuiltInRegistries.BLOCK, new ResourceLocation(SomeMoreBlocks.ID, "acacia_mosaic_stairs"), ACACIA_MOSAIC_STAIRS);
    Registry.register(BuiltInRegistries.BLOCK, new ResourceLocation(SomeMoreBlocks.ID, "carved_acacia_log"), CARVED_ACACIA_LOG);
    Registry.register(BuiltInRegistries.BLOCK, new ResourceLocation(SomeMoreBlocks.ID, "carved_acacia_wood"), CARVED_ACACIA_WOOD);
    Registry.register(BuiltInRegistries.BLOCK, new ResourceLocation(SomeMoreBlocks.ID, "dark_oak_mosaic"), DARK_OAK_MOSAIC);
    Registry.register(BuiltInRegistries.BLOCK, new ResourceLocation(SomeMoreBlocks.ID, "dark_oak_mosaic_slab"), DARK_OAK_MOSAIC_SLAB);
    Registry.register(BuiltInRegistries.BLOCK, new ResourceLocation(SomeMoreBlocks.ID, "dark_oak_mosaic_stairs"), DARK_OAK_MOSAIC_STAIRS);
    Registry.register(BuiltInRegistries.BLOCK, new ResourceLocation(SomeMoreBlocks.ID, "carved_dark_oak_log"), CARVED_DARK_OAK_LOG);
    Registry.register(BuiltInRegistries.BLOCK, new ResourceLocation(SomeMoreBlocks.ID, "carved_dark_oak_wood"), CARVED_DARK_OAK_WOOD);
    Registry.register(BuiltInRegistries.BLOCK, new ResourceLocation(SomeMoreBlocks.ID, "mangrove_mosaic"), MANGROVE_MOSAIC);
    Registry.register(BuiltInRegistries.BLOCK, new ResourceLocation(SomeMoreBlocks.ID, "mangrove_mosaic_slab"), MANGROVE_MOSAIC_SLAB);
    Registry.register(BuiltInRegistries.BLOCK, new ResourceLocation(SomeMoreBlocks.ID, "mangrove_mosaic_stairs"), MANGROVE_MOSAIC_STAIRS);
    Registry.register(BuiltInRegistries.BLOCK, new ResourceLocation(SomeMoreBlocks.ID, "carved_mangrove_log"), CARVED_MANGROVE_LOG);
    Registry.register(BuiltInRegistries.BLOCK, new ResourceLocation(SomeMoreBlocks.ID, "carved_mangrove_wood"), CARVED_MANGROVE_WOOD);
    Registry.register(BuiltInRegistries.BLOCK, new ResourceLocation(SomeMoreBlocks.ID, "crimson_mosaic"), CRIMSON_MOSAIC);
    Registry.register(BuiltInRegistries.BLOCK, new ResourceLocation(SomeMoreBlocks.ID, "crimson_mosaic_slab"), CRIMSON_MOSAIC_SLAB);
    Registry.register(BuiltInRegistries.BLOCK, new ResourceLocation(SomeMoreBlocks.ID, "crimson_mosaic_stairs"), CRIMSON_MOSAIC_STAIRS);
    Registry.register(BuiltInRegistries.BLOCK, new ResourceLocation(SomeMoreBlocks.ID, "carved_crimson_stem"), CARVED_CRIMSON_STEM);
    Registry.register(BuiltInRegistries.BLOCK, new ResourceLocation(SomeMoreBlocks.ID, "carved_crimson_hyphae"), CARVED_CRIMSON_HYPHAE);
    Registry.register(BuiltInRegistries.BLOCK, new ResourceLocation(SomeMoreBlocks.ID, "warped_mosaic"), WARPED_MOSAIC);
    Registry.register(BuiltInRegistries.BLOCK, new ResourceLocation(SomeMoreBlocks.ID, "warped_mosaic_slab"), WARPED_MOSAIC_SLAB);
    Registry.register(BuiltInRegistries.BLOCK, new ResourceLocation(SomeMoreBlocks.ID, "warped_mosaic_stairs"), WARPED_MOSAIC_STAIRS);
    Registry.register(BuiltInRegistries.BLOCK, new ResourceLocation(SomeMoreBlocks.ID, "carved_warped_stem"), CARVED_WARPED_STEM);
    Registry.register(BuiltInRegistries.BLOCK, new ResourceLocation(SomeMoreBlocks.ID, "carved_warped_hyphae"), CARVED_WARPED_HYPHAE);
    Registry.register(BuiltInRegistries.BLOCK, new ResourceLocation(SomeMoreBlocks.ID, "cherry_mosaic"), CHERRY_MOSAIC);
    Registry.register(BuiltInRegistries.BLOCK, new ResourceLocation(SomeMoreBlocks.ID, "cherry_mosaic_slab"), CHERRY_MOSAIC_SLAB);
    Registry.register(BuiltInRegistries.BLOCK, new ResourceLocation(SomeMoreBlocks.ID, "cherry_mosaic_stairs"), CHERRY_MOSAIC_STAIRS);
    Registry.register(BuiltInRegistries.BLOCK, new ResourceLocation(SomeMoreBlocks.ID, "carved_cherry_log"), CARVED_CHERRY_LOG);
    Registry.register(BuiltInRegistries.BLOCK, new ResourceLocation(SomeMoreBlocks.ID, "carved_cherry_wood"), CARVED_CHERRY_WOOD);
    Registry.register(BuiltInRegistries.BLOCK, new ResourceLocation(SomeMoreBlocks.ID, "carved_bamboo_block"), CARVED_BAMBOO_BLOCK);
    Registry.register(BuiltInRegistries.BLOCK, new ResourceLocation(SomeMoreBlocks.ID, "mossy_bricks"), MOSSY_BRICKS);
    Registry.register(BuiltInRegistries.BLOCK, new ResourceLocation(SomeMoreBlocks.ID, "mossy_brick_slab"), MOSSY_BRICK_SLAB);
    Registry.register(BuiltInRegistries.BLOCK, new ResourceLocation(SomeMoreBlocks.ID, "mossy_brick_stairs"), MOSSY_BRICK_STAIRS);
    Registry.register(BuiltInRegistries.BLOCK, new ResourceLocation(SomeMoreBlocks.ID, "mossy_brick_wall"), MOSSY_BRICK_WALL);
    Registry.register(BuiltInRegistries.BLOCK, new ResourceLocation(SomeMoreBlocks.ID, "cracked_bricks"), CRACKED_BRICKS);
    Registry.register(BuiltInRegistries.BLOCK, new ResourceLocation(SomeMoreBlocks.ID, "tiled_glass"), TILED_GLASS);
    Registry.register(BuiltInRegistries.BLOCK, new ResourceLocation(SomeMoreBlocks.ID, "tiled_tinted_glass"), TILED_TINTED_GLASS);
    Registry.register(BuiltInRegistries.BLOCK, new ResourceLocation(SomeMoreBlocks.ID, "white_stained_tiled_glass"), WHITE_STAINED_TILED_GLASS);
    Registry.register(BuiltInRegistries.BLOCK, new ResourceLocation(SomeMoreBlocks.ID, "light_gray_stained_tiled_glass"), LIGHT_GRAY_STAINED_TILED_GLASS);
    Registry.register(BuiltInRegistries.BLOCK, new ResourceLocation(SomeMoreBlocks.ID, "gray_stained_tiled_glass"), GRAY_STAINED_TILED_GLASS);
    Registry.register(BuiltInRegistries.BLOCK, new ResourceLocation(SomeMoreBlocks.ID, "black_stained_tiled_glass"), BLACK_STAINED_TILED_GLASS);
    Registry.register(BuiltInRegistries.BLOCK, new ResourceLocation(SomeMoreBlocks.ID, "brown_stained_tiled_glass"), BROWN_STAINED_TILED_GLASS);
    Registry.register(BuiltInRegistries.BLOCK, new ResourceLocation(SomeMoreBlocks.ID, "red_stained_tiled_glass"), RED_STAINED_TILED_GLASS);
    Registry.register(BuiltInRegistries.BLOCK, new ResourceLocation(SomeMoreBlocks.ID, "orange_stained_tiled_glass"), ORANGE_STAINED_TILED_GLASS);
    Registry.register(BuiltInRegistries.BLOCK, new ResourceLocation(SomeMoreBlocks.ID, "yellow_stained_tiled_glass"), YELLOW_STAINED_TILED_GLASS);
    Registry.register(BuiltInRegistries.BLOCK, new ResourceLocation(SomeMoreBlocks.ID, "lime_stained_tiled_glass"), LIME_STAINED_TILED_GLASS);
    Registry.register(BuiltInRegistries.BLOCK, new ResourceLocation(SomeMoreBlocks.ID, "green_stained_tiled_glass"), GREEN_STAINED_TILED_GLASS);
    Registry.register(BuiltInRegistries.BLOCK, new ResourceLocation(SomeMoreBlocks.ID, "cyan_stained_tiled_glass"), CYAN_STAINED_TILED_GLASS);
    Registry.register(BuiltInRegistries.BLOCK, new ResourceLocation(SomeMoreBlocks.ID, "light_blue_stained_tiled_glass"), LIGHT_BLUE_STAINED_TILED_GLASS);
    Registry.register(BuiltInRegistries.BLOCK, new ResourceLocation(SomeMoreBlocks.ID, "blue_stained_tiled_glass"), BLUE_STAINED_TILED_GLASS);
    ...
    Registry.register(BuiltInRegistries.BLOCK, new ResourceLocation(SomeMoreBlocks.ID, "gray_stained_tiled_glass_pane"), GRAY_STAINED_TILED_GLASS_PANE);
    Registry.register(BuiltInRegistries.BLOCK, new ResourceLocation(SomeMoreBlocks.ID, "black_stained_tiled_glass_pane"), BLACK_STAINED_TILED_GLASS_PANE);
    Registry.register(BuiltInRegistries.BLOCK, new ResourceLocation(SomeMoreBlocks.ID, "brown_stained_tiled_glass_pane"), BROWN_STAINED_TILED_GLASS_PANE);
    Registry.register(BuiltInRegistries.BLOCK, new ResourceLocation(SomeMoreBlocks.ID, "red_stained_tiled_glass_pane"), RED_STAINED_TILED_GLASS_PANE);
    Registry.register(BuiltInRegistries.BLOCK, new ResourceLocation(SomeMoreBlocks.ID, "orange_stained_tiled_glass_pane"), ORANGE_STAINED_TILED_GLASS_PANE);
    Registry.register(BuiltInRegistries.BLOCK, new ResourceLocation(SomeMoreBlocks.ID, "yellow_stained_tiled_glass_pane"), YELLOW_STAINED_TILED_GLASS_PANE);
    Registry.register(BuiltInRegistries.BLOCK, new ResourceLocation(SomeMoreBlocks.ID, "lime_stained_tiled_glass_pane"), LIME_STAINED_TILED_GLASS_PANE);
    Registry.register(BuiltInRegistries.BLOCK, new ResourceLocation(SomeMoreBlocks.ID, "green_stained_tiled_glass_pane"), GREEN_STAINED_TILED_GLASS_PANE);
    Registry.register(BuiltInRegistries.BLOCK, new ResourceLocation(SomeMoreBlocks.ID, "cyan_stained_tiled_glass_pane"), CYAN_STAINED_TILED_GLASS_PANE);
    Registry.register(BuiltInRegistries.BLOCK, new ResourceLocation(SomeMoreBlocks.ID, "light_blue_stained_tiled_glass_pane"), LIGHT_BLUE_STAINED_TILED_GLASS_PANE);
    Registry.register(BuiltInRegistries.BLOCK, new ResourceLocation(SomeMoreBlocks.ID, "blue_stained_tiled_glass_pane"), BLUE_STAINED_TILED_GLASS_PANE);
    ...
    Registry.register(BuiltInRegistries.BLOCK, new ResourceLocation(SomeMoreBlocks.ID, "bone_brick_wall"), BONE_BRICK_WALL);
    Registry.register(BuiltInRegistries.BLOCK, new ResourceLocation(SomeMoreBlocks.ID, "cracked_bone_bricks"), CRACKED_BONE_BRICKS);
    Registry.register(BuiltInRegistries.BLOCK, new ResourceLocation(SomeMoreBlocks.ID, "bone_tiles"), BONE_TILES);
    Registry.register(BuiltInRegistries.BLOCK, new ResourceLocation(SomeMoreBlocks.ID, "bone_tile_slab"), BONE_TILE_SLAB);
    Registry.register(BuiltInRegistries.BLOCK, new ResourceLocation(SomeMoreBlocks.ID, "bone_tile_stairs"), BONE_TILE_STAIRS);
    Registry.register(BuiltInRegistries.BLOCK, new ResourceLocation(SomeMoreBlocks.ID, "bone_tile_wall"), BONE_TILE_WALL);
