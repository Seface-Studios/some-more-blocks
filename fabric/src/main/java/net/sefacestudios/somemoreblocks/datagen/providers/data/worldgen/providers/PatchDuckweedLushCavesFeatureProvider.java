...
public class PatchDuckweedLushCavesFeatureProvider extends FeatureProvider<SimpleBlockConfiguration> {

  public PatchDuckweedLushCavesFeatureProvider() {
  ...
  protected void placed(List<PlacementModifier> modifier) {
    ...
    RandomPatchPlacementUtils.add(modifier, 120, 5, 2);
  ...
  public static <T extends FeatureProvider<?>> T create() {
    return new PatchDuckweedLushCavesFeatureProvider()
      .setPlacedFeatureKey(SMBPlacedFeature.PATCH_DUCKWEED_LUSH_CAVES)
      .setConfiguredFeatureKey(SMBConfiguredFeature.PATCH_DUCKWEED_LUSH_CAVES);
  }
}
