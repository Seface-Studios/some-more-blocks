...
- Tuff Brick Stairs not able to be collected when placed. Now a pickaxe of any tier is required.
- Tuff Brick Slabs not able to be collected when placed. Now a pickaxe of any tier is required.
- Chiseled Tuff Bricks not able to be collected when placed. Now a pickaxe of any tier is required.
- Polished Tuff not able to be collected when placed. Now a pickaxe of any tier is required.
- Polished Tuff Stairs not able to be collected when placed. Now a pickaxe of any tier is required.
- Polished Tuff Slabs not able to be collected when placed. Now a pickaxe of any tier is required.
- Netherite Pillar not able to be collected when placed. Now a diamond pickaxe or better is required.
- Polished Ice Slab was collectable without silk touch tools. Now a tool (preferred pickaxe) with silk touch is required.
- Ice Tile Slab was collectable without silk touch tools. Now a tool (preferred pickaxe) with silk touch is required.
- Ice Brick Slab was collectable without silk touch tools. Now a tool (preferred pickaxe) with silk touch is required.
- Iron Bricks not able to be collected when placed. Now a stone pickaxe or better is required.
