package net.sefacestudios.somemoreblocks.datagen.providers.assets;
...
import net.sefacestudios.somemoreblocks.datagen.providers.assets.providers.CarvedWoodProvider;
import net.sefacestudios.somemoreblocks.datagen.providers.assets.providers.TiledGlassBlockProvider;
...
import net.sefacestudios.somemoreblocks.registries.*;
...
public class SMBModelProvider extends FabricModelProvider {
  ...
  public void generateBlockStateModels(BlockModelGenerators gen) {
    ...
    gen.createTrivialCube(SMBBlocks.OAK_BOARDS.get());
    gen.createRotatedPillarWithHorizontalVariant(SMBBlocks.OAK_SLATS.get(), TexturedModel.COLUMN_ALT, TexturedModel.COLUMN_HORIZONTAL_ALT);
    this.carvedWoodProvider(SMBBlocks.CARVED_OAK_LOG.get()).log(SMBBlocks.CARVED_OAK_LOG.get()).wood(SMBBlocks.CARVED_OAK_WOOD.get());
    gen.createTrivialCube(SMBBlocks.SPRUCE_BOARDS.get());
    gen.createRotatedPillarWithHorizontalVariant(SMBBlocks.SPRUCE_SLATS.get(), TexturedModel.COLUMN_ALT, TexturedModel.COLUMN_HORIZONTAL_ALT);
    this.carvedWoodProvider(SMBBlocks.CARVED_SPRUCE_LOG.get()).log(SMBBlocks.CARVED_SPRUCE_LOG.get()).wood(SMBBlocks.CARVED_SPRUCE_WOOD.get());
    gen.createTrivialCube(SMBBlocks.BIRCH_BOARDS.get());
    gen.createRotatedPillarWithHorizontalVariant(SMBBlocks.BIRCH_SLATS.get(), TexturedModel.COLUMN_ALT, TexturedModel.COLUMN_HORIZONTAL_ALT);
    this.carvedWoodProvider(SMBBlocks.CARVED_BIRCH_LOG.get()).log(SMBBlocks.CARVED_BIRCH_LOG.get()).wood(SMBBlocks.CARVED_BIRCH_WOOD.get());
    gen.createTrivialCube(SMBBlocks.JUNGLE_BOARDS.get());
    gen.createRotatedPillarWithHorizontalVariant(SMBBlocks.JUNGLE_SLATS.get(), TexturedModel.COLUMN_ALT, TexturedModel.COLUMN_HORIZONTAL_ALT);
    this.carvedWoodProvider(SMBBlocks.CARVED_JUNGLE_LOG.get()).log(SMBBlocks.CARVED_JUNGLE_LOG.get()).wood(SMBBlocks.CARVED_JUNGLE_WOOD.get());
    gen.createTrivialCube(SMBBlocks.ACACIA_BOARDS.get());
    gen.createRotatedPillarWithHorizontalVariant(SMBBlocks.ACACIA_SLATS.get(), TexturedModel.COLUMN_ALT, TexturedModel.COLUMN_HORIZONTAL_ALT);
    this.carvedWoodProvider(SMBBlocks.CARVED_ACACIA_LOG.get()).log(SMBBlocks.CARVED_ACACIA_LOG.get()).wood(SMBBlocks.CARVED_ACACIA_WOOD.get());
    gen.createTrivialCube(SMBBlocks.DARK_OAK_BOARDS.get());
    gen.createRotatedPillarWithHorizontalVariant(SMBBlocks.DARK_OAK_SLATS.get(), TexturedModel.COLUMN_ALT, TexturedModel.COLUMN_HORIZONTAL_ALT);
    this.carvedWoodProvider(SMBBlocks.CARVED_DARK_OAK_LOG.get()).log(SMBBlocks.CARVED_DARK_OAK_LOG.get()).wood(SMBBlocks.CARVED_DARK_OAK_WOOD.get());
    gen.createTrivialCube(SMBBlocks.MANGROVE_BOARDS.get());
    gen.createRotatedPillarWithHorizontalVariant(SMBBlocks.MANGROVE_SLATS.get(), TexturedModel.COLUMN_ALT, TexturedModel.COLUMN_HORIZONTAL_ALT);
    this.carvedWoodProvider(SMBBlocks.CARVED_MANGROVE_LOG.get()).log(SMBBlocks.CARVED_MANGROVE_LOG.get()).wood(SMBBlocks.CARVED_MANGROVE_WOOD.get());
    gen.createTrivialCube(SMBBlocks.CRIMSON_BOARDS.get());
    gen.createRotatedPillarWithHorizontalVariant(SMBBlocks.CRIMSON_SLATS.get(), TexturedModel.COLUMN_ALT, TexturedModel.COLUMN_HORIZONTAL_ALT);
    this.carvedWoodProvider(SMBBlocks.CARVED_CRIMSON_STEM.get()).log(SMBBlocks.CARVED_CRIMSON_STEM.get()).wood(SMBBlocks.CARVED_CRIMSON_HYPHAE.get());
    gen.createTrivialCube(SMBBlocks.WARPED_BOARDS.get());
    gen.createRotatedPillarWithHorizontalVariant(SMBBlocks.WARPED_SLATS.get(), TexturedModel.COLUMN_ALT, TexturedModel.COLUMN_HORIZONTAL_ALT);
    this.carvedWoodProvider(SMBBlocks.CARVED_WARPED_STEM.get()).log(SMBBlocks.CARVED_WARPED_STEM.get()).wood(SMBBlocks.CARVED_WARPED_HYPHAE.get());
    gen.createTrivialCube(SMBBlocks.CHERRY_BOARDS.get());
    gen.createRotatedPillarWithHorizontalVariant(SMBBlocks.CHERRY_SLATS.get(), TexturedModel.COLUMN_ALT, TexturedModel.COLUMN_HORIZONTAL_ALT);
    this.carvedWoodProvider(SMBBlocks.CARVED_CHERRY_LOG.get()).log(SMBBlocks.CARVED_CHERRY_LOG.get()).wood(SMBBlocks.CARVED_CHERRY_WOOD.get());
    gen.createTrivialCube(SMBBlocks.BAMBOO_BOARDS.get());
    gen.createRotatedPillarWithHorizontalVariant(SMBBlocks.BAMBOO_SLATS.get(), TexturedModel.COLUMN_ALT, TexturedModel.COLUMN_HORIZONTAL_ALT);
    this.carvedWoodProvider(SMBBlocks.CARVED_BAMBOO_BLOCK.get()).log(SMBBlocks.CARVED_BAMBOO_BLOCK.get());
    gen.createTrivialCube(SMBBlocks.PALE_OAK_BOARDS.get());
    gen.createRotatedPillarWithHorizontalVariant(SMBBlocks.PALE_OAK_SLATS.get(), TexturedModel.COLUMN_ALT, TexturedModel.COLUMN_HORIZONTAL_ALT);
    this.carvedWoodProvider(SMBBlocks.CARVED_PALE_OAK_LOG.get()).logWithMoonPhase(SMBBlocks.CARVED_PALE_OAK_LOG.get()).woodWithMoonPhase(SMBBlocks.CARVED_PALE_OAK_WOOD.get());
    ...
    /* More Natural Blocks */
    this.createTinyCactusWithFlowerPot(SMBBlocks.TINY_CACTUS.get(), SMBBlocks.POTTED_TINY_CACTUS.get(), BlockModelGenerators.PlantType.NOT_TINTED);
    ...
    gen.createDoublePlantWithDefaultItem(SMBBlocks.GALAHAD_LARKSPUR.get(), BlockModelGenerators.PlantType.NOT_TINTED);
    gen.createPlantWithDefaultItem(SMBBlocks.SHORT_GALAHAD_LARKSPUR.get(), SMBBlocks.POTTED_SHORT_GALAHAD_LARKSPUR.get(), BlockModelGenerators.PlantType.NOT_TINTED);
    gen.createDoublePlantWithDefaultItem(SMBBlocks.ASTOLAT_LARKSPUR.get(), BlockModelGenerators.PlantType.NOT_TINTED);
    gen.createPlantWithDefaultItem(SMBBlocks.SHORT_ASTOLAT_LARKSPUR.get(), SMBBlocks.POTTED_SHORT_ASTOLAT_LARKSPUR.get(), BlockModelGenerators.PlantType.NOT_TINTED);
    gen.createDoublePlantWithDefaultItem(SMBBlocks.SUMMER_SKIES_LARKSPUR.get(), BlockModelGenerators.PlantType.NOT_TINTED);
    gen.createPlantWithDefaultItem(SMBBlocks.SHORT_SUMMER_SKIES_LARKSPUR.get(), SMBBlocks.POTTED_SHORT_SUMMER_SKIES_LARKSPUR.get(), BlockModelGenerators.PlantType.NOT_TINTED);
    gen.createDoublePlantWithDefaultItem(SMBBlocks.PURPLE_LARKSPUR.get(), BlockModelGenerators.PlantType.NOT_TINTED);
    gen.createPlantWithDefaultItem(SMBBlocks.SHORT_PURPLE_LARKSPUR.get(), SMBBlocks.POTTED_SHORT_PURPLE_LARKSPUR.get(), BlockModelGenerators.PlantType.NOT_TINTED);
  ...
  private void createDuckweed() {
    ...
    for (int i = 0; i <= 2; i++) {
      ...
      Identifier model = SMBModelTemplates.DUCKWEED.createWithSuffix(block, suffix, textureMapping, this.modelOutput);
  ...
  /**
   * Create a Redstone Lamp block models.
  ...
  public final CarvedWoodProvider carvedWoodProvider(Block block) {
    return new CarvedWoodProvider(this.blockModelGenerators, TextureMapping.logColumn(block));
  }
