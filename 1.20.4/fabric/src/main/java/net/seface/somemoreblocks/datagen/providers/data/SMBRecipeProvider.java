...
public class SMBRecipeProvider extends FabricRecipeProvider {
  ...
  public void buildRecipes(RecipeOutput output) {
    ...
    smeltingResultFromBase(this.output, SMBBlocks.SMOOTH_GRANITE.get(), Blocks.GRANITE);
    ...
    smeltingResultFromBase(this.output, SMBBlocks.SMOOTH_DIORITE.get(), Blocks.DIORITE);
    ...
    smeltingResultFromBase(this.output, SMBBlocks.SMOOTH_ANDESITE.get(), Blocks.ANDESITE);
    ...
    smeltingResultFromBase(this.output, SMBBlocks.SMOOTH_DEEPSLATE.get(), Blocks.DEEPSLATE);
    ...
    smeltingResultFromBase(this.output, SMBBlocks.SMOOTH_CALCITE.get(), Blocks.CALCITE);
    this.oneByTwo(RecipeCategory.BUILDING_BLOCKS, SMBBlocks.TUFF_PILLAR.get(), SMBBlocks.TUFF_BRICKS.get(), 2);
    this.twoByTwo(RecipeCategory.BUILDING_BLOCKS, SMBBlocks.TUFF_TILES.get(), SMBBlocks.TUFF_BRICKS.get(), 4);
    this.mossyBlockFromVineAndMossBlock(RecipeCategory.BUILDING_BLOCKS, SMBBlocks.MOSSY_TUFF_BRICKS.get(), SMBBlocks.TUFF_BRICKS.get());
    smeltingResultFromBase(this.output, SMBBlocks.SMOOTH_TUFF.get(), Blocks.TUFF);
    ...
    smeltingResultFromBase(this.output, SMBBlocks.SMOOTH_DRIPSTONE.get(), Blocks.DRIPSTONE_BLOCK);
    smeltingResultFromBase(this.output, SMBBlocks.CRACKED_BRICKS.get(), Blocks.BRICKS);
    this.mossyBlockFromVineAndMossBlock(RecipeCategory.BUILDING_BLOCKS, SMBBlocks.MOSSY_BRICKS.get(), Blocks.BRICKS);
    smeltingResultFromBase(this.output, SMBBlocks.CRACKED_MUD_BRICKS.get(), Blocks.MUD_BRICKS);
    ...
    smeltingResultFromBase(this.output, SMBBlocks.SMOOTH_MUD.get(), Blocks.PACKED_MUD);
    ...
    smeltingResultFromBase(this.output, SMBBlocks.CRACKED_PRISMARINE_BRICKS.get(), Blocks.PRISMARINE_BRICKS);
    ...
    smeltingResultFromBase(this.output, SMBBlocks.SMOOTH_PRISMARINE.get(), Blocks.PRISMARINE);
    ...
    smeltingResultFromBase(this.output, SMBBlocks.CRACKED_RED_NETHER_BRICKS.get(), Blocks.RED_NETHER_BRICKS);
    ...
    smeltingResultFromBase(this.output, SMBBlocks.SMOOTH_BLACKSTONE.get(), Blocks.BLACKSTONE);
    this.oneByTwo(RecipeCategory.BUILDING_BLOCKS, SMBBlocks.CHISELED_END_STONE_BRICKS.get(), Blocks.END_STONE_BRICK_SLAB, 1);
    smeltingResultFromBase(this.output, SMBBlocks.CRACKED_END_STONE_BRICKS.get(), Blocks.END_STONE_BRICKS);
    ...
    smeltingResultFromBase(this.output, SMBBlocks.SMOOTH_END_STONE.get(), Blocks.END_STONE);
    this.oneByTwo(RecipeCategory.BUILDING_BLOCKS, SMBBlocks.CHISELED_PURPUR.get(), Blocks.PURPUR_SLAB, 1);
    smeltingResultFromBase(this.output, SMBBlocks.CRACKED_PURPUR_BLOCK.get(), Blocks.PURPUR_BLOCK);
    ...
    smeltingResultFromBase(this.output, SMBBlocks.SMOOTH_PURPUR.get(), SMBBlocks.POLISHED_PURPUR.get());
    ...
    smeltingResultFromBase(this.output, SMBBlocks.CRACKED_CUT_COPPER.get(), Blocks.CUT_COPPER);
    ...
    smeltingResultFromBase(this.output, SMBBlocks.EXPOSED_CRACKED_CUT_COPPER.get(), Blocks.EXPOSED_CUT_COPPER);
    ...
    smeltingResultFromBase(this.output, SMBBlocks.WEATHERED_CRACKED_CUT_COPPER.get(), Blocks.WEATHERED_CUT_COPPER);
    ...
    smeltingResultFromBase(this.output, SMBBlocks.OXIDIZED_CRACKED_CUT_COPPER.get(), Blocks.OXIDIZED_CUT_COPPER);
    ...
    smeltingResultFromBase(this.output, SMBBlocks.WAXED_CRACKED_CUT_COPPER.get(), Blocks.WAXED_CUT_COPPER);
    ...
    smeltingResultFromBase(this.output, SMBBlocks.WAXED_EXPOSED_CRACKED_CUT_COPPER.get(), Blocks.WAXED_EXPOSED_CUT_COPPER);
    ...
    smeltingResultFromBase(this.output, SMBBlocks.WAXED_WEATHERED_CRACKED_CUT_COPPER.get(), Blocks.WAXED_WEATHERED_CUT_COPPER);
    ...
    smeltingResultFromBase(this.output, SMBBlocks.WAXED_OXIDIZED_CRACKED_CUT_COPPER.get(), Blocks.WAXED_OXIDIZED_CUT_COPPER);
    ...
    smeltingResultFromBase(this.output, SMBBlocks.SMOOTH_SOUL_SANDSTONE.get(), SMBBlocks.SOUL_SANDSTONE.get());
  ...
  private void stonecutterFrom(RecipeCategory category, ItemLike result, List<ItemLike> items, int amount) {
    for (ItemLike input : items) {
      this.stonecutterResultFromBase(this.output, category, result, input, amount);
    }
  }
  ...
  private void mossyBlockFromVineAndMossBlock(RecipeCategory category, ItemLike output, ItemLike input) {
    ...
    for (Block block : blocks) {
      ShapelessRecipeBuilder.shapeless(category, output, 1)
        .requires(input)
        .requires(block)
  ...
  private void carvedWoodFromLogs(ItemLike carvedWood, ItemLike carvedLog) {
    ShapedRecipeBuilder.shaped(RecipeCategory.BUILDING_BLOCKS, carvedWood, 3)
      .define('#', carvedLog)
      .pattern("##")
      .pattern("##")
      .group("carved_wood")
  ...
  private void mossyPrismarineBricks() {
    ShapelessRecipeBuilder.shapeless(RecipeCategory.BUILDING_BLOCKS, SMBBlocks.MOSSY_PRISMARINE_BRICKS.get(), 1)
  ...
  private void oneItemToOther(RecipeCategory category, ItemLike output, ItemLike input, int amount) {
    ShapelessRecipeBuilder.shapeless(category, output, amount)
      .requires(input)
      .unlockedBy(RecipeProvider.getHasName(input), this.has(input))
  ...
  private void shingles() {
    ...
    for (DyeColor dyeColor : dyeColors) {
      ...
      Block terracotta = BuiltInRegistries.BLOCK.get(SomeMoreBlocks.minecraftId(dyeColor + "_terracotta"));
  ...
  private void checkeredTiles() {
    ...
    for (DyeColor dyeColor : dyeColors) {
      ...
      Block concrete = BuiltInRegistries.BLOCK.get(SomeMoreBlocks.minecraftId(dyeColor + "_concrete"));

      ShapedRecipeBuilder.shaped(RecipeCategory.BUILDING_BLOCKS, checkeredTiles, 4)
  ...
  private void tiledGlassAndTiledGlassPane() {
    ...
    for (DyeColor dyeColor : dyeColors) {
      Block stainedGlass = BuiltInRegistries.BLOCK.get(SomeMoreBlocks.minecraftId(dyeColor + "_stained_glass"));
  ...
  private void waxedBlocksFromHoneycomb() {
    for (Block block : SMBRegistries.WAXED_COPPER_BLOCKS.getKeySet()) {
      ...
      ShapelessRecipeBuilder.shapeless(RecipeCategory.BUILDING_BLOCKS, waxedBlock, 1)
  ...
  private void tiledGlassPaneFromTiledGlass(RecipeCategory category, ItemLike tiledGlass, ItemLike tiledGlassPane) {
    ShapedRecipeBuilder.shaped(category, tiledGlassPane, 16)
      .define('#', tiledGlass)
      .pattern("###")
      .pattern("###")
  ...
  private ShapedRecipeBuilder oneByTwoBuilder(RecipeCategory category, ItemLike output, ItemLike input, int amount) {
    return ShapedRecipeBuilder.shaped(category, output, amount)
      .define('#', input)
      .pattern("#")
      .pattern("#")
      .unlockedBy(RecipeProvider.getHasName(input), this.has(input));
  ...
  private void snowyPlant(Block inputItem) {
    ...
    ShapelessRecipeBuilder.shapeless(RecipeCategory.MISC, snowyPlant)
      .requires(inputItem)
