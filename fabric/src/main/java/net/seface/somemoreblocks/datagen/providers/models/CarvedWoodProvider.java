...
public class CarvedWoodProvider {
  ...
  public CarvedWoodProvider(Block block, BiConsumer<ResourceLocation, ModelInstance> modelOutput, ItemModelOutput itemModelOutput, Consumer<BlockStateGenerator> blockStateOutput) {
    this.block = block;
  ...
  public CarvedWoodProvider log(Block block, Block topBottomBlock) {
  ...
  public CarvedWoodProvider logByMoonPhase(Block block, Block topBottomBlock) {
  ...
  public CarvedWoodProvider wood(Block block) {
  ...
  public CarvedWoodProvider woodByMoonPhase(Block block) {
    for (int i = 0; i < RotatedCarvedPaleOakBlock.MAX_MOON_PHASE; i++) {
      String suffix = "_" + i;
