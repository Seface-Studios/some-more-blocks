...
public class CommonRegistries {
  ...
  public static void init() {
    CommonRegistries.registerCarvedBlocks();
    CommonRegistries.registerCompostableItems();
    CommonRegistries.registerSnowyBlocks();
    CommonRegistries.registerWaxableCopperBlocks();
    CommonRegistries.registerWeatheringCopperBlocks();
