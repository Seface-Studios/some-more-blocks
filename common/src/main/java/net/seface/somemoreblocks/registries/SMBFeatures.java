...
import net.seface.somemoreblocks.worldgen.feature.CeilingVeinFeature;
...
public class SMBFeatures {
  ...
  public static final PlatformRegistryObject<Feature<CeilingVeinConfiguration>> CEILING_VEIN_FEATURE = PlatformServices.REGISTRY.registerFeature("ceiling_vein_feature", () -> new CeilingVeinFeature(CeilingVeinConfiguration.CODEC));
