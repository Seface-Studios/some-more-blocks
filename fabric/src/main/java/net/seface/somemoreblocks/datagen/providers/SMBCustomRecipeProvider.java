...
public class SMBCustomRecipeProvider extends FabricRecipeProvider {


  public SMBCustomRecipeProvider(FabricDataOutput output, CompletableFuture<HolderLookup.Provider> future) {
    super(output, future);
  }
