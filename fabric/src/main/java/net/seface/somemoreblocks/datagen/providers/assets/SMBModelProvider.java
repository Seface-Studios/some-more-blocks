...
public class SMBModelProvider extends FabricModelProvider {
  ...
  public void generateBlockStateModels(BlockModelGenerators gen) {
    ...
    this.createFlowerBedWithItem(SMBBlocks.CLOVER.get(), SMBItems.CLOVER.get());
  ...
  public final void createFlowerBedWithItem(Block block, Item item) {
    this.blockModelGenerators.registerSimpleFlatItemModel(item);
    ResourceLocation resourceLocation = TexturedModel.createDefault(TextureMapping::flowerbed, SMBModelTemplates.TINTED_FLOWERBED_1).create(block, this.modelOutput);
    ResourceLocation resourceLocation2 = TexturedModel.createDefault(TextureMapping::flowerbed, SMBModelTemplates.TINTED_FLOWERBED_2).create(block, this.modelOutput);
    ResourceLocation resourceLocation3 = TexturedModel.createDefault(TextureMapping::flowerbed, SMBModelTemplates.TINTED_FLOWERBED_3).create(block, this.modelOutput);
    ResourceLocation resourceLocation4 = TexturedModel.createDefault(TextureMapping::flowerbed, SMBModelTemplates.TINTED_FLOWERBED_4).create(block, this.modelOutput);
