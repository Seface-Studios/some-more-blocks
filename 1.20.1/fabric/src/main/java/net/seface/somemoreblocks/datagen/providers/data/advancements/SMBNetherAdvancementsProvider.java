...
public class SMBNetherAdvancementsProvider extends FabricAdvancementProvider {
  ...
  private void verySeriousDedication() {
    ...
    Advancement.Builder.advancement()
      ...
      .display(SMBBlocks.CUT_NETHERITE.get(), Component.translatable("advancements.somemoreblocks.nether.obtain_cut_netherite.title"), Component.translatable("advancements.somemoreblocks.nether.obtain_cut_netherite.description"), null, FrameType.CHALLENGE, true, true, false)
