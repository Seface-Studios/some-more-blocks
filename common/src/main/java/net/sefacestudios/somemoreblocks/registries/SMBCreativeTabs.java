  ...
  public static final PlatformRegistryObject<CreativeModeTab> MORE_COLORED_BLOCKS = PlatformServices.REGISTRY.registerCreativeModeTab("more_colored_blocks", CreativeModeTab.Row.TOP, 1,
    (builder) -> builder
      ...
      .displayItems((ctx, entry) -> {
        ...
        entry.accept(SMBBlocks.SHINGLES_STAIRS.get());
        entry.accept(SMBBlocks.WHITE_SHINGLES_STAIRS.get());
        entry.accept(SMBBlocks.LIGHT_GRAY_SHINGLES_STAIRS.get());
        entry.accept(SMBBlocks.GRAY_SHINGLES_STAIRS.get());
        entry.accept(SMBBlocks.BLACK_SHINGLES_STAIRS.get());
        entry.accept(SMBBlocks.BROWN_SHINGLES_STAIRS.get());
        entry.accept(SMBBlocks.RED_SHINGLES_STAIRS.get());
        entry.accept(SMBBlocks.ORANGE_SHINGLES_STAIRS.get());
        entry.accept(SMBBlocks.YELLOW_SHINGLES_STAIRS.get());
        entry.accept(SMBBlocks.LIME_SHINGLES_STAIRS.get());
        entry.accept(SMBBlocks.GREEN_SHINGLES_STAIRS.get());
        entry.accept(SMBBlocks.CYAN_SHINGLES_STAIRS.get());
        entry.accept(SMBBlocks.LIGHT_BLUE_SHINGLES_STAIRS.get());
        entry.accept(SMBBlocks.BLUE_SHINGLES_STAIRS.get());
  ...
  public static final PlatformRegistryObject<CreativeModeTab> MORE_NATURAL_BLOCKS = PlatformServices.REGISTRY.registerCreativeModeTab("more_natural_blocks", CreativeModeTab.Row.TOP, 2,
    (builder) -> builder
      ...
      .displayItems((ctx, entry) -> {
        ...
        entry.accept(SMBItems.PEBBLES.get());
        ...
        entry.accept(SMBBlocks.SHORT_PURPLE_LARKSPUR.get());
        entry.accept(SMBBlocks.SHORT_RED_LARK_LARKSPUR.get());
        entry.accept(SMBBlocks.GALAHAD_LARKSPUR.get());
        entry.accept(SMBBlocks.ASTOLAT_LARKSPUR.get());
        entry.accept(SMBBlocks.SUMMER_SKIES_LARKSPUR.get());
        entry.accept(SMBBlocks.PURPLE_LARKSPUR.get());
        entry.accept(SMBBlocks.RED_LARK_LARKSPUR.get());
        ...
        entry.accept(SMBItems.PALE_MUSHROOM.get());
        entry.accept(SMBItems.PALE_MUSHROOM_COLONY.get());
        entry.accept(SMBItems.TALL_PALE_MUSHROOM_COLONY.get());
