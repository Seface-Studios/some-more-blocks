...
public final class SMBBiomeTags {
  ...
  public static final TagKey<Biome> GENERATES_PALE_MUSHROOM = SomeMoreBlocks.tagKey(Registries.BIOME, "generates/pale_mushroom");
  public static final TagKey<Biome> GENERATES_PALE_MUSHROOM_COLONY = SomeMoreBlocks.tagKey(Registries.BIOME, "generates/pale_mushroom_colony");
  ...
  public static final TagKey<Biome> GENERATES_SNOW_BUSH = SomeMoreBlocks.tagKey(Registries.BIOME, "generates/snow_bush");
