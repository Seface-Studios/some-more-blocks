...
public class MoreBlocksFabricClient implements ClientModInitializer {
    ...
    private void registerBlockRenders() {
        ...
        BlockRenderLayerMap.INSTANCE.putBlock(MBBlocks.BROWN_SMALL_MUSHROOM_COLONY, RenderType.cutout());
        ...
        BlockRenderLayerMap.INSTANCE.putBlock(MBBlocks.RED_SMALL_MUSHROOM_COLONY, RenderType.cutout());
        ...
        BlockRenderLayerMap.INSTANCE.putBlock(MBBlocks.WARPED_SMALL_FUNGUS_COLONY, RenderType.cutout());
        ...
        BlockRenderLayerMap.INSTANCE.putBlock(MBBlocks.CRIMSON_SMALL_FUNGUS_COLONY, RenderType.cutout());
