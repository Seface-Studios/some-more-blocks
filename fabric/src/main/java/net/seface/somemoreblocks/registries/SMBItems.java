...
public class SMBItems {
  ...
  public static final Item AZALEA_LEAVES_BUCKET = registerItem("azalea_leaves_bucket", (properties) -> new LeavesBucketItem(SMBBlocks.AZALEA_LEAF_LITTER, SoundEvents.AZALEA_LEAVES_PLACE, properties), new Item.Properties().component(SMBDataComponentTypes.BUCKET_VOLUME, LeavesBucketItem.MAX_VOLUME).stacksTo(1));
  ...
  public static final Item FLOWERING_AZALEA_LEAVES_BUCKET = registerItem("flowering_azalea_leaves_bucket", (properties) -> new LeavesBucketItem(SMBBlocks.FLOWERING_AZALEA_LEAF_LITTER, SoundEvents.AZALEA_LEAVES_PLACE, properties), new Item.Properties().component(SMBDataComponentTypes.BUCKET_VOLUME, LeavesBucketItem.MAX_VOLUME).stacksTo(1));
  public static final Item SPRUCE_LEAVES_BUCKET = registerItem("spruce_leaves_bucket", (properties) -> new LeavesBucketItem(SMBBlocks.SPRUCE_LEAF_LITTER, SoundEvents.GRASS_PLACE, properties), new Item.Properties().component(SMBDataComponentTypes.BUCKET_VOLUME, LeavesBucketItem.MAX_VOLUME).stacksTo(1));
  public static final Item BIRCH_LEAVES_BUCKET = registerItem("birch_leaves_bucket", (properties) -> new LeavesBucketItem(SMBBlocks.BIRCH_LEAF_LITTER, SoundEvents.GRASS_PLACE, properties), new Item.Properties().component(SMBDataComponentTypes.BUCKET_VOLUME, LeavesBucketItem.MAX_VOLUME).stacksTo(1));
  public static final Item LEAVES_BUCKET = registerItem("leaves_bucket", (properties) -> new LeavesBucketItem(SMBBlocks.LEAF_LITTER, SoundEvents.GRASS_PLACE, properties), new Item.Properties().component(SMBDataComponentTypes.BUCKET_VOLUME, LeavesBucketItem.MAX_VOLUME).stacksTo(1));
  ...
  /* 1.21.4 */
  public static final Item PALE_OAK_LEAVES_BUCKET = registerItem("pale_oak_leaves_bucket", (properties) -> new LeavesBucketItem(SMBBlocks.PALE_OAK_LEAF_LITTER, SoundEvents.GRASS_PLACE, properties), new Item.Properties().component(SMBDataComponentTypes.BUCKET_VOLUME, LeavesBucketItem.MAX_VOLUME).stacksTo(1));
